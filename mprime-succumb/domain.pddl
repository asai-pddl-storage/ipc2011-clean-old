...
(define (domain mystery-prime-strips)
 ...
 (:predicates (fears ?c ?v) (craves ?v ?n) (locale ?n ?a) (harmony ?v ?s)
  (pleasure ?x) (food ?x) (province ?x) (planet ?x) (pain ?x) (orbits ?i ?j)
  (eats ?n1 ?n2) (attacks ?i ?j))
 (:action
  ugly11095ugly11097ugly11096ugly11098ugly11095ugly11097ugly2ugly3ugly2ugly3feast
  ...
  (and (not (craves ?v ?n1)) (craves ?v ?n2) (not (locale ?n1 ?l2))
       (locale ?n1 ?l1)))
 (:action
  ugly11096ugly11098ugly11095ugly11097ugly11096ugly11098ugly1ugly1ugly1ugly1overcome
  ...
  (and (not (craves ?c ?n)) (fears ?c ?v) (not (harmony ?v ?s2))
       (harmony ?v ?s1)))
 (:action
  ugly11097ugly11096ugly11098ugly11095ugly11097ugly11096ugly4ugly4ugly4ugly4drink
  ...
  (and (not (locale ?n1 ?l11)) (locale ?n1 ?l12) (not (locale ?n2 ?l21))
       (locale ?n2 ?l22)))
 (:action
  ugly11098ugly11095ugly11097ugly11096ugly11098ugly11095ugly3ugly2ugly3ugly2succumb
  :parameters (?c ?v ?n ?s1 ?s2) :precondition
