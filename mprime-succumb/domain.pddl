...
(define (domain mystery-prime-strips)
 ...
 (:predicates (orbits ?i ?j) (fears ?c ?v) (locale ?n ?a) (attacks ?i ?j)
  (pleasure ?x) (food ?x) (province ?x) (planet ?x) (craves ?v ?n) (pain ?x)
  (eats ?n1 ?n2) (harmony ?v ?s))
 (:action ugly11095ugly11097ugly11096ugly4ugly4ugly4ugly4drink :parameters
  ...
  (and (not (locale ?n1 ?l11)) (locale ?n1 ?l12) (not (locale ?n2 ?l21))
       (locale ?n2 ?l22)))
 (:action ugly11096ugly11098ugly11095ugly3ugly2ugly3ugly2succumb :parameters
 ...
 (:action ugly11097ugly11096ugly11098ugly1ugly1ugly1ugly1overcome :parameters
  (?c ?v ?n ?s1 ?s2) :precondition
  ...
  (and (not (craves ?c ?n)) (fears ?c ?v) (not (harmony ?v ?s2))
       (harmony ?v ?s1)))
 (:action ugly11098ugly11095ugly11097ugly2ugly3ugly2ugly3feast :parameters
