...
(define (domain elevators-sequencedstrips)
 ...
 (:predicates (lift-at ?lift - elevator ?floor - count)
 ...
 (:action ugly5ugly9ugly10ugly8ugly6ugly3ugly6ugly1ugly3leave :parameters
 ...
 (:action ugly6ugly7ugly5ugly9ugly10ugly4ugly2ugly5ugly4move-down-slow
 ...
 (:action ugly7ugly5ugly9ugly10ugly8ugly2ugly5ugly4ugly2board :parameters
  (?p - passenger ?lift - elevator ?f - count ?n1 - count ?n2 - count)
  :precondition
