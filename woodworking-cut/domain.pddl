...
(define (domain woodworking) (:requirements :typing :action-costs)
 (:predicates (unused ?obj - part) (colour ?obj - part ?colour - acolour)
  ...
  (wood ?obj - woodobj ?wood - awood) (empty ?m - highspeed-saw)
 ...
 (:action
  ugly3501ugly3506ugly3511ugly3512ugly3507ugly3505ugly10ugly8ugly4ugly6unload-highspeed-saw
 ...
 (:action
  ugly3502ugly3503ugly3509ugly3501ugly3506ugly3511ugly12ugly3ugly10ugly8do-grind
  :parameters
  ...
  (and (not (surface-condition ?x ?oldsurface))
       ...
       (colour ?x natural)))
 (:action
  ugly3503ugly3509ugly3501ugly3506ugly3511ugly3512ugly7ugly11ugly12ugly3cut-board-large
  :parameters
 ...
 (:action
  ugly3504ugly3502ugly3503ugly3509ugly3501ugly3506ugly11ugly12ugly3ugly10cut-board-small
  :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3505ugly3510ugly3508ugly3504ugly3502ugly3503ugly9ugly1ugly2ugly5do-saw-large
  :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3506ugly3511ugly3512ugly3507ugly3505ugly3510ugly8ugly4ugly6ugly7do-saw-small
  :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3507ugly3505ugly3510ugly3508ugly3504ugly3502ugly3ugly10ugly8ugly4load-highspeed-saw
  :parameters (?b - board ?m - highspeed-saw) :precondition
  (and (empty ?m) (available ?b)) :effect
  (and (not (available ?b)) (not (empty ?m)) (in-highspeed-saw ?b ?m)))
 (:action
  ugly3508ugly3504ugly3502ugly3503ugly3509ugly3501ugly6ugly7ugly11ugly12do-glaze
 ...
 (:action
  ugly3509ugly3501ugly3506ugly3511ugly3512ugly3507ugly5ugly13ugly9ugly1do-spray-varnish
  :parameters
  ...
  (and (not (treatment ?x untreated)) (treatment ?x varnished)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action
  ugly3510ugly3508ugly3504ugly3502ugly3503ugly3509ugly1ugly2ugly5ugly13cut-board-medium
  :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3511ugly3512ugly3507ugly3505ugly3510ugly3508ugly4ugly6ugly7ugly11do-saw-medium
  :parameters
  (?b - board ?p - part ?m - saw ?w - awood ?surface - surface ?size_before ?s1
   ?size_after - aboardsize)
  :precondition
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3512ugly3507ugly3505ugly3510ugly3508ugly3504ugly2ugly5ugly13ugly9do-immersion-varnish
  :parameters
  ...
  (and (not (treatment ?x untreated)) (treatment ?x varnished)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action
  ugly3513ugly3513ugly3513ugly3513ugly3513ugly3513ugly13ugly9ugly1ugly2do-plane
  :parameters
