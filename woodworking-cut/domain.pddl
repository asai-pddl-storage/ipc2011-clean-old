...
(define (domain woodworking) (:requirements :typing :action-costs)
 (:predicates (treatment ?obj - part ?treatment - treatmentstatus)
  ...
  (contains-part ?b - board ?p - part) (unused ?obj - part)
  (available ?obj - woodobj) (in-highspeed-saw ?b - board ?m - highspeed-saw)
 ...
 (:action ugly1ugly2ugly5ugly13cut-board-medium :parameters
 ...
 (:action ugly2ugly5ugly13ugly9do-immersion-varnish :parameters
 ...
 (:action ugly4ugly6ugly7ugly11do-saw-medium :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly5ugly13ugly9ugly1do-spray-varnish :parameters
  ...
  (and (not (treatment ?x untreated)) (treatment ?x varnished)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action ugly6ugly7ugly11ugly12do-glaze :parameters
  ...
  (and (not (treatment ?x untreated)) (treatment ?x glazed)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action ugly7ugly11ugly12ugly3cut-board-large :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly8ugly4ugly6ugly7do-saw-small :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly9ugly1ugly2ugly5do-saw-large :parameters
  (?b - board ?p - part ?m - saw ?w - awood ?surface - surface ?size_before ?s1
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly10ugly8ugly4ugly6unload-highspeed-saw :parameters
  (?b - board ?m - highspeed-saw) :precondition (in-highspeed-saw ?b ?m)
  :effect (and (available ?b) (not (in-highspeed-saw ?b ?m)) (empty ?m)))
 (:action ugly11ugly12ugly3ugly10cut-board-small :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly12ugly3ugly10ugly8do-grind :parameters
  ...
  (and (not (surface-condition ?x ?oldsurface))
       ...
       (colour ?x natural)))
 (:action ugly13ugly9ugly1ugly2do-plane :parameters
