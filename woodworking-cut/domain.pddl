...
(define (domain woodworking) (:requirements :typing :action-costs)
 (:predicates (has-colour ?machine - machine ?colour - acolour)
  (in-highspeed-saw ?b - board ?m - highspeed-saw)
  (is-smooth ?surface - surface) (empty ?m - highspeed-saw)
  (contains-part ?b - board ?p - part)
  (grind-treatment-change ?old ?new - treatmentstatus)
  (boardsize-successor ?size1 ?size2 - aboardsize)
  (colour ?obj - part ?colour - acolour) (wood ?obj - woodobj ?wood - awood)
  (boardsize ?board - board ?size - aboardsize) (available ?obj - woodobj)
  (treatment ?obj - part ?treatment - treatmentstatus)
  (goalsize ?part - part ?size - apartsize)
  (surface-condition ?obj - woodobj ?surface - surface) (unused ?obj - part))
 ...
 (:action
  ugly3501ugly3506ugly3511ugly3512ugly3507ugly5ugly13ugly9ugly1do-spray-varnish
  :parameters
 ...
 (:action
  ugly3502ugly3503ugly3509ugly3501ugly3506ugly11ugly12ugly3ugly10cut-board-small
  :parameters
 ...
 (:action
  ugly3503ugly3509ugly3501ugly3506ugly3511ugly12ugly3ugly10ugly8do-grind
  :parameters
  ...
  (and (not (surface-condition ?x ?oldsurface))
       ...
       (colour ?x natural)))
 (:action
  ugly3504ugly3502ugly3503ugly3509ugly3501ugly6ugly7ugly11ugly12do-glaze
  ...
  (and (not (treatment ?x untreated)) (treatment ?x glazed)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action
  ugly3505ugly3510ugly3508ugly3504ugly3502ugly3ugly10ugly8ugly4load-highspeed-saw
 ...
 (:action
  ugly3506ugly3511ugly3512ugly3507ugly3505ugly10ugly8ugly4ugly6unload-highspeed-saw
  :parameters (?b - board ?m - highspeed-saw) :precondition
  (in-highspeed-saw ?b ?m) :effect
  (and (available ?b) (not (in-highspeed-saw ?b ?m)) (empty ?m)))
 (:action
  ugly3507ugly3505ugly3510ugly3508ugly3504ugly2ugly5ugly13ugly9do-immersion-varnish
  :parameters
  ...
  (and (not (treatment ?x untreated)) (treatment ?x varnished)
       (not (colour ?x natural)) (colour ?x ?newcolour)))
 (:action
  ugly3508ugly3504ugly3502ugly3503ugly3509ugly1ugly2ugly5ugly13cut-board-medium
  :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3509ugly3501ugly3506ugly3511ugly3512ugly7ugly11ugly12ugly3cut-board-large
  :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3510ugly3508ugly3504ugly3502ugly3503ugly9ugly1ugly2ugly5do-saw-large
  :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3511ugly3512ugly3507ugly3505ugly3510ugly8ugly4ugly6ugly7do-saw-small
  :parameters
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       ...
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action
  ugly3512ugly3507ugly3505ugly3510ugly3508ugly4ugly6ugly7ugly11do-saw-medium
  :parameters
  (?b - board ?p - part ?m - saw ?w - awood ?surface - surface ?size_before ?s1
   ?size_after - aboardsize)
  :precondition
  ...
  (and (increase (total-cost) 1) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly3513ugly3513ugly3513ugly3513ugly3513ugly13ugly9ugly1ugly2do-plane
  :parameters
