...
(define (domain hiking) (:requirements :strips :equality :typing)
 (:predicates (at_car ?x1 - car ?x2 - place) (down ?x1 - tent)
  (at_person ?x1 - person ?x2 - place) (next ?x1 - place ?x2 - place)
  (partners ?x1 - couple ?x2 - person ?x3 - person)
  (at_tent ?x1 - tent ?x2 - place) (up ?x1 - tent)
  (walked ?x1 - couple ?x2 - place))
 (:types car tent person couple place) (:functions (total-cost) - number)
 (:action ugly1ugly3drive_tent_passenger :parameters
 ...
 (:action ugly2ugly5drive :parameters
 ...
 (:action ugly3ugly6put_down :parameters (?x1 - person ?x2 - place ?x3 - tent)
  :precondition (and (at_person ?x1 ?x2) (at_tent ?x3 ?x2) (up ?x3)) :effect
  (and (down ?x3) (not (up ?x3))))
 (:action ugly4ugly2drive_tent :parameters
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       (not (at_car ?x4 ?x2)) (at_tent ?x5 ?x3) (not (at_tent ?x5 ?x2))
       (increase (total-cost) 1)))
 (:action ugly5ugly4put_up :parameters (?x1 - person ?x2 - place ?x3 - tent)
  :precondition (and (at_person ?x1 ?x2) (at_tent ?x3 ?x2) (down ?x3)) :effect
  (and (up ?x3) (not (down ?x3))))
 (:action ugly6ugly1drive_passenger :parameters
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       ...
       (increase (total-cost) 1)))
 (:action ugly7ugly7walk_together :parameters
