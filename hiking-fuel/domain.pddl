...
(define (domain hiking) (:requirements :strips :equality :typing)
 (:predicates (next ?x1 - place ?x2 - place)
  (at_person ?x1 - person ?x2 - place)
  (partners ?x1 - couple ?x2 - person ?x3 - person)
  (at_car ?x1 - car ?x2 - place) (walked ?x1 - couple ?x2 - place)
  (at_tent ?x1 - tent ?x2 - place) (down ?x1 - tent) (up ?x1 - tent))
 (:types car tent person couple place) (:functions (total-cost) - number)
 (:action ugly11078ugly5ugly4ugly2ugly5drive :parameters
 ...
 (:action ugly11079ugly1ugly3ugly6ugly1drive_passenger :parameters
 ...
 (:action ugly11080ugly7ugly7ugly7ugly7walk_together :parameters
 ...
 (:action ugly11083ugly2ugly5ugly4ugly2drive_tent :parameters
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       ...
       (increase (total-cost) 1)))
 (:action ugly11084ugly3ugly6ugly1ugly3drive_tent_passenger :parameters
