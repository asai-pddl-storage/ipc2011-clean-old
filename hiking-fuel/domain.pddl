...
(define (domain hiking) (:requirements :strips :equality :typing)
 (:predicates (next ?x1 - place ?x2 - place)
  (at_person ?x1 - person ?x2 - place) (down ?x1 - tent)
 ...
 (:action
  ugly11078ugly11082ugly11081ugly11083ugly11079ugly11078ugly5ugly4ugly2ugly5drive
 ...
 (:action
  ugly11079ugly11078ugly11082ugly11081ugly11083ugly11079ugly1ugly3ugly6ugly1drive_passenger
 ...
 (:action
  ugly11080ugly11084ugly11080ugly11084ugly11080ugly11084ugly3ugly6ugly1ugly3drive_tent_passenger
  :parameters
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       ...
       (increase (total-cost) 1)))
 (:action
  ugly11081ugly11083ugly11079ugly11078ugly11082ugly11081ugly6ugly1ugly3ugly6put_down
  :parameters (?x1 - person ?x2 - place ?x3 - tent) :precondition
  (and (at_person ?x1 ?x2) (at_tent ?x3 ?x2) (up ?x3)) :effect
  (and (down ?x3) (not (up ?x3))))
 (:action
  ugly11082ugly11081ugly11083ugly11079ugly11078ugly11082ugly4ugly2ugly5ugly4put_up
  :parameters (?x1 - person ?x2 - place ?x3 - tent) :precondition
  (and (at_person ?x1 ?x2) (at_tent ?x3 ?x2) (down ?x3)) :effect
  (and (up ?x3) (not (down ?x3))))
 (:action
  ugly11083ugly11079ugly11078ugly11082ugly11081ugly11083ugly2ugly5ugly4ugly2drive_tent
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       ...
       (increase (total-cost) 1)))
 (:action
  ugly11084ugly11080ugly11084ugly11080ugly11084ugly11080ugly7ugly7ugly7ugly7walk_together
  :parameters
