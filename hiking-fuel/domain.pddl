...
(define (domain hiking) (:requirements :strips :equality :typing)
 (:predicates (at_person ?x1 - person ?x2 - place)
  (at_tent ?x1 - tent ?x2 - place) (down ?x1 - tent)
 ...
 (:action ugly1ugly3ugly6ugly1drive_passenger :parameters
 ...
 (:action ugly2ugly5ugly4ugly2drive_tent :parameters
  ...
  (and (at_person ?x1 ?x3) (not (at_person ?x1 ?x2)) (at_car ?x4 ?x3)
       ...
       (increase (total-cost) 1)))
 (:action ugly3ugly6ugly1ugly3drive_tent_passenger :parameters
 ...
 (:action ugly6ugly1ugly3ugly6put_down :parameters
  (?x1 - person ?x2 - place ?x3 - tent) :precondition
  (and (at_person ?x1 ?x2) (at_tent ?x3 ?x2) (up ?x3)) :effect
  (and (down ?x3) (not (up ?x3))))
 (:action ugly7ugly7ugly7ugly7walk_together :parameters
