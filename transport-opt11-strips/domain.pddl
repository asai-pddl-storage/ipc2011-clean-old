...
(define (domain transport) (:requirements :typing :action-costs)
 (:predicates (capacity ?v - vehicle ?s1 - capacity-number)
  (road ?l1 ?l2 - location) (at ?x - locatable ?v - location)
  (capacity-predecessor ?s1 ?s2 - capacity-number)
  (in ?x - package ?v - vehicle))
 (:types location target locatable - object vehicle package - locatable
  capacity-number - object)
 (:functions (total-cost) - number)
 (:action ugly1ugly1ugly1drive :parameters (?v - vehicle ?l1 ?l2 - location)
  :precondition (and (at ?v ?l1) (road ?l1 ?l2)) :effect
  (and (not (at ?v ?l1)) (at ?v ?l2)
       (increase (total-cost) (road-length ?l1 ?l2))))
 (:action ugly2ugly3ugly2drop :parameters
 ...
 (:action ugly3ugly2ugly3pick-up :parameters
  (?v - vehicle ?l - location ?p - package ?s1 ?s2 - capacity-number)
  :precondition
