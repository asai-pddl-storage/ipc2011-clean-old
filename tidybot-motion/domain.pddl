...
(define (domain tidybot)
 ...
 (:predicates (leftof-rel ?x1 - xrel ?x2 - xrel)
  (gripper-obstacle ?x - xc ?y - yc) (zerox-rel ?x - xrel)
  (base-obstacle ?x - xc ?y - yc) (leftof ?x1 - xc ?x2 - xc)
  (surface ?x - xc ?y - yc) (sum-y ?y - yc ?yr - yrel ?ysum - yc)
  (pushing ?r - robot ?c - cart) (object-pos ?o - object ?x - xc ?y - yc)
  (zeroy-rel ?y - yrel) (parked ?r - robot) (not-pushed ?c - cart)
  (above-rel ?y1 - yrel ?y2 - yrel) (above ?y1 - yc ?y2 - yc)
  (cart-pos ?c - cart ?x - xc ?y - yc) (holding ?r - robot ?o - object)
  (gripper-empty ?r - robot) (object-goal ?o - object ?x - xc ?y - yc)
  (sum-x ?x - xc ?xr - xrel ?xsum - xc) (not-pushing ?r - robot)
  (base-pos ?r - robot ?x - xc ?y - yc) (object-done ?o - object)
  (on-cart ?o - object ?c - cart) (gripper-rel ?r - robot ?x - xrel ?y - yrel))
 (:types robot cart object xc yc xrel yrel) (:functions (total-cost) - number)
 (:action ugly11874ugly6ugly13ugly6ugly13base-down :parameters
 ...
 (:action ugly11875ugly3ugly20ugly22ugly26put-down :parameters
 ...
 (:action ugly11876ugly8ugly21ugly17ugly11get-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
 ...
 (:action ugly11877ugly29ugly10ugly18ugly7grasp-cart-right :parameters
 ...
 (:action ugly11878ugly1ugly29ugly10ugly18base-cart-left :parameters
  ...
  (and (not (base-pos ?r ?x1 ?y)) (base-pos ?r ?x2 ?y)
       ...
       (increase (total-cost) 1)))
 (:action ugly11879ugly13ugly6ugly13ugly6gripper-up :parameters
 ...
 (:action ugly11880ugly25ugly24ugly8ugly21grasp-cart-above :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cy - yc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?x ?cy) (above ?cy ?y) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly11881ugly28ugly14ugly5ugly19put-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
 ...
 (:action ugly11882ugly2ugly15ugly12ugly27park :parameters (?r - robot)
  :precondition (and (not (parked ?r)) (not-pushing ?r)) :effect
  (and (parked ?r) (increase (total-cost) 1)))
 (:action ugly11883ugly27ugly2ugly15ugly12put-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?gxabs ?oy)
       (gripper-obstacle ?gxabs ?oy) (gripper-empty ?r)))
 (:action ugly11884ugly5ugly19ugly25ugly24base-cart-right :parameters
  (?r - robot ?c - cart ?x1 - xc ?x2 - xc ?y - yc ?cx1 - xc ?cx2 - xc ?cy - yc)
  :precondition
  ...
  (and (not (base-pos ?r ?x1 ?y)) (base-pos ?r ?x2 ?y)
       ...
       (not (base-obstacle ?cx1 ?cy)) (base-obstacle ?cx2 ?cy)
       (increase (total-cost) 1)))
 (:action ugly11885ugly18ugly7ugly16ugly1put-on-cart :parameters
 ...
 (:action ugly11886ugly23ugly9ugly3ugly20get-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?gxabs ?oy)) (not (gripper-obstacle ?gxabs ?oy))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly11887ugly11ugly23ugly9ugly3get-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?ox ?gyabs)) (not (gripper-obstacle ?ox ?gyabs))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly11888ugly20ugly22ugly26ugly28gripper-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?cgyrel - yrel
   ?dgyrel - yrel ?cgyabs - yc ?dgyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?cgyrel)
  ...
  (and (not (gripper-rel ?r ?gxrel ?cgyrel)) (gripper-rel ?r ?gxrel ?dgyrel)
       (not (gripper-obstacle ?gxabs ?cgyabs))
       (gripper-obstacle ?gxabs ?dgyabs)))
 (:action ugly11889ugly30ugly4ugly30ugly4finish-object :parameters
  (?o - object ?x - xc ?y - yc) :precondition
  (and (not (object-done ?o)) (object-pos ?o ?x ?y) (object-goal ?o ?x ?y))
  :effect (and (object-done ?o)))
 (:action ugly11890ugly4ugly30ugly4ugly30base-right :parameters
  ...
  (and (not (base-pos ?r ?cx ?y)) (base-pos ?r ?dx ?y)
       ...
       (increase (total-cost) 1)))
 (:action ugly11891ugly17ugly11ugly23ugly9base-left :parameters
  (?r - robot ?cx - xc ?dx - xc ?y - yc) :precondition
  ...
  (and (not (base-pos ?r ?cx ?y)) (base-pos ?r ?dx ?y)
       (not (base-obstacle ?cx ?y)) (base-obstacle ?dx ?y)
       (increase (total-cost) 1)))
 (:action ugly11892ugly12ugly27ugly2ugly15gripper-right :parameters
 ...
 (:action ugly11893ugly7ugly16ugly1ugly29base-cart-down :parameters
  ...
  (and (not (base-pos ?r ?x ?y1)) (base-pos ?r ?x ?y2)
       ...
       (increase (total-cost) 1)))
 (:action ugly11894ugly22ugly26ugly28ugly14base-up :parameters
  (?r - robot ?x - xc ?cy - yc ?dy - yc) :precondition
  ...
  (and (not (base-pos ?r ?x ?cy)) (base-pos ?r ?x ?dy)
       (not (base-obstacle ?x ?cy)) (base-obstacle ?x ?dy)
       (increase (total-cost) 1)))
 (:action ugly11895ugly24ugly8ugly21ugly17gripper-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?cgxrel - xrel ?dgxrel - xrel ?cgxabs -
   xc ?dgxabs - xc ?gyrel - yrel ?gyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?cgxrel ?gyrel)
  ...
  (and (not (gripper-rel ?r ?cgxrel ?gyrel)) (gripper-rel ?r ?dgxrel ?gyrel)
       (not (gripper-obstacle ?cgxabs ?gyabs))
       (gripper-obstacle ?dgxabs ?gyabs)))
 (:action ugly11896ugly14ugly5ugly19ugly25get-from-cart :parameters
  (?r - robot ?x - xc ?y - yc ?gxrel - xrel ?gyrel - yrel ?o - object ?c - cart
   ?cx - xc ?cy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?x ?y) (gripper-rel ?r ?gxrel ?gyrel)
 ...
 (:action ugly11897ugly19ugly25ugly24ugly8get-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?ox ?gyabs)) (not (gripper-obstacle ?ox ?gyabs))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly11898ugly10ugly18ugly7ugly16unpark :parameters
 ...
 (:action ugly11899ugly16ugly1ugly29ugly10grasp-cart-below :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cy - yc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?x ?cy) (above ?y ?cy) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly11900ugly26ugly28ugly14ugly5ungrasp-cart :parameters
  (?r - robot ?c - cart) :precondition (and (pushing ?r ?c)) :effect
  (and (not (pushing ?r ?c)) (not-pushing ?r) (not-pushed ?c)))
 (:action ugly11901ugly15ugly12ugly27ugly2grasp-cart-left :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cx - xc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?cx ?y) (leftof ?cx ?x) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly11902ugly9ugly3ugly20ugly22put-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?ox ?gyabs)
       (gripper-obstacle ?ox ?gyabs) (gripper-empty ?r)))
 (:action ugly11903ugly21ugly17ugly11ugly23base-cart-up :parameters
  (?r - robot ?c - cart ?x - xc ?y1 - yc ?y2 - yc ?cx - xc ?cy1 - yc ?cy2 - yc)
  :precondition
