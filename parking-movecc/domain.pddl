...
(define (domain parking) (:requirements :strips :typing :action-costs)
 ...
 (:action
  ugly27ugly27ugly27ugly27ugly27ugly27ugly1ugly1ugly1ugly1move-curb-to-curb
 ...
 (:action
  ugly28ugly28ugly28ugly28ugly28ugly28ugly2ugly3ugly4ugly2move-car-to-curb
  ...
  (and (not (curb-clear ?curbdest)) (car-clear ?carsrc)
       ...
       (at-curb ?car)))
 (:action
  ugly29ugly29ugly29ugly29ugly29ugly29ugly3ugly4ugly2ugly3move-car-to-car
 ...
 (:action
  ugly30ugly30ugly30ugly30ugly30ugly30ugly4ugly2ugly3ugly4move-curb-to-car
