...
(define (domain parking) (:requirements :strips :typing :action-costs)
 (:predicates (at-curb-num ?car - car ?curb - curb) (car-clear ?car - car)
  (at-curb ?car - car) (curb-clear ?curb - curb)
  (behind-car ?car ?front-car - car))
 (:types car curb) (:functions (total-cost) - number)
 (:action ugly27ugly27ugly27ugly1ugly1ugly1ugly1move-curb-to-curb :parameters
 ...
 (:action ugly28ugly28ugly28ugly2ugly3ugly4ugly2move-car-to-curb :parameters
  ...
  (and (not (curb-clear ?curbdest)) (car-clear ?carsrc)
       ...
       (at-curb ?car)))
 (:action ugly29ugly29ugly29ugly3ugly4ugly2ugly3move-car-to-car :parameters
 ...
 (:action ugly30ugly30ugly30ugly4ugly2ugly3ugly4move-curb-to-car :parameters
