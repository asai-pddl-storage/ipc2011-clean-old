...
(define (domain driverlog) (:requirements :strips :action-costs)
 (:predicates (driver ?d) (link ?x ?y) (location ?loc) (driving ?d ?v)
  (at ?obj ?loc) (path ?x ?y) (truck ?truck) (in ?obj1 ?obj) (obj ?obj)
  (empty ?v))
 (:functions (total-cost) - number)
 (:action ugly11039ugly11044ugly1ugly1ugly1ugly1load-truck :parameters
  (?obj ?truck ?loc) :precondition
  (and (obj ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (at ?obj ?loc))
  :effect (and (not (at ?obj ?loc)) (in ?obj ?truck)))
 (:action ugly11040ugly11042ugly2ugly6ugly5ugly3disembark-truck :parameters
 ...
 (:action ugly11041ugly11043ugly3ugly4ugly2ugly6drive-truck :parameters
 ...
 (:action ugly11042ugly11040ugly4ugly2ugly6ugly5board-truck :parameters
  (?driver ?truck ?loc) :precondition
  (and (driver ?driver) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (at ?driver ?loc) (empty ?truck))
  :effect
  (and (not (at ?driver ?loc)) (driving ?driver ?truck) (not (empty ?truck))))
 (:action ugly11043ugly11041ugly5ugly3ugly4ugly2walk :parameters
 ...
 (:action ugly11044ugly11039ugly6ugly5ugly3ugly4unload-truck :parameters
  (?obj ?truck ?loc) :precondition
  (and (obj ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (in ?obj ?truck))
