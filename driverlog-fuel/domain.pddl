...
(define (domain driverlog) (:requirements :strips :action-costs)
 (:predicates (path ?x ?y) (empty ?v) (location ?loc) (obj ?obj) (truck ?truck)
  (driving ?d ?v) (in ?obj1 ?obj) (driver ?d) (at ?obj ?loc) (link ?x ?y))
 (:functions (total-cost) - number)
 (:action ugly11039ugly11044ugly11039ugly6ugly5ugly3ugly4unload-truck
 ...
 (:action ugly11040ugly11042ugly11040ugly4ugly2ugly6ugly5board-truck
 ...
 (:action ugly11041ugly11043ugly11041ugly5ugly3ugly4ugly2walk :parameters
 ...
 (:action ugly11042ugly11040ugly11042ugly2ugly6ugly5ugly3disembark-truck
  :parameters (?driver ?truck ?loc) :precondition
  (and (driver ?driver) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (driving ?driver ?truck))
  :effect
  (and (not (driving ?driver ?truck)) (at ?driver ?loc) (empty ?truck)))
 (:action ugly11043ugly11041ugly11043ugly3ugly4ugly2ugly6drive-truck
 ...
 (:action ugly11044ugly11039ugly11044ugly1ugly1ugly1ugly1load-truck :parameters
