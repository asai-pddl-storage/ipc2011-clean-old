...
(define (domain driverlog) (:requirements :strips :action-costs)
 (:predicates (obj ?obj) (empty ?v) (location ?loc) (truck ?truck) (driver ?d)
  (at ?obj ?loc) (path ?x ?y) (driving ?d ?v) (in ?obj1 ?obj) (link ?x ?y))
 (:functions (total-cost) - number)
 (:action
  ugly11039ugly11044ugly11039ugly11044ugly11039ugly6ugly5ugly3ugly4unload-truck
 ...
 (:action
  ugly11040ugly11042ugly11040ugly11042ugly11040ugly4ugly2ugly6ugly5board-truck
 ...
 (:action ugly11041ugly11043ugly11041ugly11043ugly11041ugly5ugly3ugly4ugly2walk
 ...
 (:action
  ugly11042ugly11040ugly11042ugly11040ugly11042ugly2ugly6ugly5ugly3disembark-truck
  :parameters (?driver ?truck ?loc) :precondition
  (and (driver ?driver) (truck ?truck) (location ?loc) (at ?truck ?loc)
 ...
 (:action
  ugly11043ugly11041ugly11043ugly11041ugly11043ugly3ugly4ugly2ugly6drive-truck
 ...
 (:action
  ugly11044ugly11039ugly11044ugly11039ugly11044ugly1ugly1ugly1ugly1load-truck
  :parameters (?obj ?truck ?loc) :precondition
  (and (obj ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (at ?obj ?loc))
