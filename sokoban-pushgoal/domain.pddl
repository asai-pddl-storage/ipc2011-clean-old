...
(define (domain sokoban-sequential) (:requirements :typing :action-costs)
 (:predicates (at-goal ?s - stone)
  ...
  (at ?t - thing ?l - location) (is-goal ?l - location) (clear ?l - location)
  (is-nongoal ?l - location))
 (:types thing location direction - object player stone - thing)
 (:functions (total-cost) - number)
 (:action ugly3493ugly3494ugly3ugly2ugly1ugly3push-to-nongoal :parameters
 ...
 (:action ugly3494ugly3495ugly1ugly3ugly2ugly1push-to-goal :parameters
  (?p - player ?s - stone ?ppos ?from ?to - location ?dir - direction)
  :precondition
  (and (at ?p ?ppos) (at ?s ?from) (clear ?to) (move-dir ?ppos ?from ?dir)
 ...
 (:action ugly3495ugly3493ugly2ugly1ugly3ugly2move :parameters
