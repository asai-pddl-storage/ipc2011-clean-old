...
(define (domain sokoban-sequential) (:requirements :typing :action-costs)
 ...
 (:action ugly3493ugly2ugly1ugly3ugly2move :parameters
 ...
 (:action ugly3494ugly3ugly2ugly1ugly3push-to-nongoal :parameters
 ...
 (:action ugly3495ugly1ugly3ugly2ugly1push-to-goal :parameters
  (?p - player ?s - stone ?ppos ?from ?to - location ?dir - direction)
  :precondition
  (and (at ?p ?ppos) (at ?s ?from) (clear ?to) (move-dir ?ppos ?from ?dir)
