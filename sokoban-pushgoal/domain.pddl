...
(define (domain sokoban-sequential) (:requirements :typing :action-costs)
 (:predicates (move-dir ?from ?to - location ?dir - direction)
  (clear ?l - location) (is-nongoal ?l - location) (is-goal ?l - location)
  (at ?t - thing ?l - location) (at-goal ?s - stone))
 (:types thing location direction - object player stone - thing)
 (:functions (total-cost) - number)
 (:action
  ugly3493ugly3494ugly3495ugly3493ugly3494ugly3495ugly1ugly3ugly2ugly1push-to-goal
  :parameters
 ...
 (:action
  ugly3494ugly3495ugly3493ugly3494ugly3495ugly3493ugly2ugly1ugly3ugly2move
 ...
 (:action
  ugly3495ugly3493ugly3494ugly3495ugly3493ugly3494ugly3ugly2ugly1ugly3push-to-nongoal
  :parameters
  (?p - player ?s - stone ?ppos ?from ?to - location ?dir - direction)
  :precondition
  (and (at ?p ?ppos) (at ?s ?from) (clear ?to) (move-dir ?ppos ?from ?dir)
