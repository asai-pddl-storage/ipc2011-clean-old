...
(define (domain upp) (:requirements :typing :action-costs)
 (:predicates (notprintedwith ?sheet - sheet_t ?side - side_t ?color - color_t)
  ...
  (oppositeside ?side1 - side_t ?side2 - side_t) (uninitialized)
 ...
 (:action ugly1434197ugly3ugly7ugly20ugly8endcap-move-letter :parameters
 ...
 (:action ugly1434198ugly12ugly23ugly12ugly23down-movedown-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434199ugly19ugly18ugly13ugly21colorprinter-simplex-letter
 ...
 (:action ugly1434200ugly20ugly8ugly2ugly9up-moveup-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434201ugly16ugly15ugly11ugly3colorprinter-simplexmono-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly1434202ugly13ugly21ugly6ugly16blackcontainer-fromime-letter
 ...
 (:action ugly1434203ugly15ugly11ugly3ugly7finisher1-passthrough-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434204ugly17ugly4ugly5ugly22down-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
 ...
 (:action ugly1434205ugly8ugly2ugly9ugly19up-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434206ugly1ugly17ugly4ugly5finisher2-passthrough-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434207ugly5ugly22ugly10ugly1blackprinter-simplexandinvert-letter
  :parameters
 ...
 (:action ugly1434208ugly18ugly13ugly21ugly6blackprinter-simplex-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available blackprinter-rsrc) (sheetsize ?sheet letter)
       (sideup ?sheet ?face) (imagecolor ?image black)
       (location ?sheet blackcontainer_exittoime-blackprinter_entry)
 ...
 (:action ugly1434209ugly23ugly12ugly23ugly12finisher2-stack-letter :parameters
  ...
  (and (not (available finisher2-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher2_entry-finisher1_exit))
       (available finisher2-rsrc) (increase (total-cost) 8000)))
 (:action ugly1434210ugly2ugly9ugly19ugly18htmovercolor-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434211ugly10ugly1ugly17ugly4colorcontainer-fromime-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434212ugly22ugly10ugly1ugly17colorcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_entry-down_bottomexit))
  :effect
  (and (not (available colorcontainer-rsrc))
       ...
       (available colorcontainer-rsrc) (increase (total-cost) 8000)))
 (:action ugly1434213ugly21ugly6ugly16ugly15down-movebottom-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly1434214ugly14ugly14ugly14ugly14blackcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly1434215ugly9ugly19ugly18ugly13finisher1-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
  ...
  (and (not (available finisher1-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher1_entry-up_topexit))
       (available finisher1-rsrc) (increase (total-cost) 8000)))
 (:action ugly1434216ugly7ugly20ugly8ugly2blackfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434217ugly11ugly3ugly7ugly20colorfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434218ugly4ugly5ugly22ugly10initialize :parameters ()
 ...
 (:action ugly1434219ugly6ugly16ugly15ugly11htmoverblack-move-letter
  :parameters (?sheet - sheet_t) :precondition
