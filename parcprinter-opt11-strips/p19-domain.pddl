...
(define (domain etipp) (:requirements :typing :action-costs)
 ...
 (:action ugly1434315ugly3ugly28ugly15ugly11im1-movelower-letter :parameters
 ...
 (:action ugly1434316ugly12ugly6ugly29ugly9om-lowerout-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434317ugly16ugly12ugly6ugly29uc1-divert-letter :parameters
 ...
 (:action ugly1434318ugly20ugly10ugly35ugly2rh1-returnmove-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434319ugly15ugly11ugly5ugly24lre-simplexmono-letter :parameters
 ...
 (:action ugly1434320ugly23ugly20ugly10ugly35fe1-feedmsi-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434321ugly13ugly27ugly16ugly12im1-loopupper-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434322ugly31ugly7ugly17ugly3lc2-mergeinvert-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434323ugly28ugly15ugly11ugly5ure-simplexmono-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  ...
  (and (not (available ure-rsrc)) (location ?sheet ure_exit-uc2_onramp)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434324ugly2ugly18ugly8ugly26initialize :parameters ()
 ...
 (:action ugly1434325ugly21ugly14ugly4ugly21lc1-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  ...
  (and (not (available lc1-rsrc)) (location ?sheet lbe_entry-lc1_offramp)
       ...
       (increase (total-cost) 11805)))
 (:action ugly1434326ugly30ugly22ugly13ugly27lc1-mergeinvert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434327ugly25ugly36ugly25ugly36lc2-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434328ugly26ugly1ugly32ugly19rh2-returnmove-letter :parameters
  (?sheet - sheet_t) :precondition
  ...
  (and (not (available rh2-rsrc)) (location ?sheet rh1_entry-rh2_exit)
       ...
       (increase (total-cost) 10869)))
 (:action ugly1434329ugly4ugly21ugly14ugly4uc2-merge-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (increase (total-cost) 78919)))
 (:action ugly1434330ugly6ugly29ugly9ugly33ure-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available ure-rsrc) (sheetsize ?sheet letter) (sideup ?sheet ?face)
  ...
  (and (not (available ure-rsrc)) (location ?sheet ure_exit-uc2_onramp)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434331ugly29ugly9ugly33ugly23uc2-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434332ugly34ugly34ugly34ugly34om-upperreturn-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434333ugly18ugly8ugly26ugly1om-upperout-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
       (location ?sheet uc2_exit-om_topentry))
  :effect
 ...
 (:action ugly1434334ugly17ugly3ugly28ugly15uc1-mergeinvert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc1-rsrc)) (location ?sheet uc2_entry-uc1_exit)
       ...
       (not (sideup ?sheet ?face)) (available uc1-rsrc)
       (increase (total-cost) 28119)))
 (:action ugly1434335ugly36ugly25ugly36ugly25sys-stack-letter :parameters
 ...
 (:action ugly1434336ugly11ugly5ugly24ugly30uc2-mergeinvert-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (increase (total-cost) 78919)))
 (:action ugly1434337ugly32ugly19ugly31ugly7lbe-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly1434338ugly9ugly33ugly23ugly20uc1-merge-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434339ugly10ugly35ugly2ugly18uc1-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434340ugly5ugly24ugly30ugly22lc1-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available lc1-rsrc)) (location ?sheet lc1_exit-lc2_entry)
       ...
       (increase (total-cost) 10890)))
 (:action ugly1434341ugly22ugly13ugly27ugly16ube-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  ...
  (and (not (available ube-rsrc)) (location ?sheet uc1_onramp-ube_exit)
       ...
       (increase (total-cost) 123749)))
 (:action ugly1434342ugly33ugly23ugly20ugly10om-lowerreturn-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
       (location ?sheet om_bottomentry-lc2_exit))
  :effect
 ...
 (:action ugly1434343ugly14ugly4ugly21ugly14im1-moveupper-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet fe1_exit-im1_feedentry))
  :effect
 ...
 (:action ugly1434344ugly1ugly32ugly19ugly31im1-looplower-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet rh1_exit-im1_returnentry))
  :effect
 ...
 (:action ugly1434345ugly19ugly31ugly7ugly17fe1-feed-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available fe1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet some_feeder_tray))
  :effect
 ...
 (:action ugly1434346ugly24ugly30ugly22ugly13lc2-merge-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available lc2-rsrc)) (location ?sheet om_bottomentry-lc2_exit)
       ...
       (increase (total-cost) 78919)))
 (:action ugly1434347ugly27ugly16ugly12ugly6lre-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available lre-rsrc) (sheetsize ?sheet letter) (sideup ?sheet ?face)
  ...
  (and (not (available lre-rsrc)) (location ?sheet lc2_onramp-lre_exit)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434348ugly35ugly2ugly18ugly8lc2-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available lc2-rsrc)) (location ?sheet lre_entry-lc2_offramp)
       ...
       (not (sideup ?sheet ?face)) (available lc2-rsrc)
       (increase (total-cost) 17452)))
 (:action ugly1434349ugly8ugly26ugly1ugly32uc2-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (increase (total-cost) 11207)))
 (:action ugly1434350ugly7ugly17ugly3ugly28lc1-merge-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
