...
(define (domain upp) (:requirements :typing :action-costs)
 ...
 (:action ugly1blackprinter-simplexandinvert-letter :parameters
 ...
 (:action ugly2blackfeeder-feed-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly3colorprinter-simplexmono-letter :parameters
 ...
 (:action ugly4colorcontainer-fromime-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly5finisher2-passthrough-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly6blackprinter-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available blackprinter-rsrc) (sheetsize ?sheet letter)
       (sideup ?sheet ?face) (imagecolor ?image black)
       (location ?sheet blackcontainer_exittoime-blackprinter_entry)
 ...
 (:action ugly7finisher1-passthrough-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly8endcap-move-letter :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly9up-moveup-letter :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly10initialize :parameters () :precondition (and (uninitialized))
  :effect
 ...
 (:action ugly11htmoverblack-move-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly12finisher2-stack-letter :parameters
  ...
  (and (not (available finisher2-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher2_entry-finisher1_exit))
       (available finisher2-rsrc) (increase (total-cost) 8000)))
 (:action ugly13finisher1-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
  ...
  (and (not (available finisher1-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher1_entry-up_topexit))
       (available finisher1-rsrc) (increase (total-cost) 8000)))
 (:action ugly14blackcontainer-toime-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly15down-movebottom-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly16blackcontainer-fromime-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet blackprinter_exit-blackcontainer_entryfromime))
  :effect
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly17colorcontainer-toime-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_entry-down_bottomexit))
  :effect
  (and (not (available colorcontainer-rsrc))
       ...
       (available colorcontainer-rsrc) (increase (total-cost) 8000)))
 (:action ugly18htmovercolor-move-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly19up-movetop-letter :parameters (?sheet - sheet_t) :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmovercolor_exit-up_topentry))
  :effect
  (and (not (available up-rsrc)) (location ?sheet finisher1_entry-up_topexit)
 ...
 (:action ugly20colorfeeder-feed-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly21colorprinter-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly22down-movetop-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly23down-movedown-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
