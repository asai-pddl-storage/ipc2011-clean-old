...
(define (domain upp) (:requirements :typing :action-costs)
 (:predicates (sideup ?sheet - sheet_t ?side - side_t)
 ...
 (:action ugly1433918ugly1ugly17ugly4ugly5finisher2-passthrough-letter
 ...
 (:action ugly1433919ugly21ugly6ugly16ugly15down-movebottom-letter :parameters
 ...
 (:action ugly1433920ugly4ugly5ugly22ugly10initialize :parameters ()
 ...
 (:action ugly1433921ugly6ugly16ugly15ugly11htmoverblack-move-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433922ugly17ugly4ugly5ugly22down-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly1433923ugly3ugly7ugly20ugly8endcap-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433924ugly11ugly3ugly7ugly20colorfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433925ugly8ugly2ugly9ugly19up-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433926ugly5ugly22ugly10ugly1blackprinter-simplexandinvert-letter
  :parameters
 ...
 (:action ugly1433927ugly12ugly23ugly12ugly23down-movedown-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
 ...
 (:action ugly1433928ugly18ugly13ugly21ugly6blackprinter-simplex-letter
 ...
 (:action ugly1433929ugly7ugly20ugly8ugly2blackfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433930ugly20ugly8ugly2ugly9up-moveup-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1433931ugly14ugly14ugly14ugly14blackcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433932ugly10ugly1ugly17ugly4colorcontainer-fromime-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433933ugly2ugly9ugly19ugly18htmovercolor-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433934ugly23ugly12ugly23ugly12finisher2-stack-letter :parameters
  ...
  (and (not (available finisher2-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher2_entry-finisher1_exit))
       (available finisher2-rsrc) (increase (total-cost) 8000)))
 (:action ugly1433935ugly16ugly15ugly11ugly3colorprinter-simplexmono-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly1433936ugly19ugly18ugly13ugly21colorprinter-simplex-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly1433937ugly13ugly21ugly6ugly16blackcontainer-fromime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet blackprinter_exit-blackcontainer_entryfromime))
  :effect
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly1433938ugly15ugly11ugly3ugly7finisher1-passthrough-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433939ugly22ugly10ugly1ugly17colorcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_entry-down_bottomexit))
  :effect
  (and (not (available colorcontainer-rsrc))
       ...
       (available colorcontainer-rsrc) (increase (total-cost) 8000)))
 (:action ugly1433940ugly9ugly19ugly18ugly13finisher1-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
