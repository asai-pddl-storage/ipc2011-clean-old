...
(define (domain upp) (:requirements :typing :action-costs)
 ...
 (:action ugly1ugly17ugly4ugly5finisher2-passthrough-letter :parameters
 ...
 (:action ugly2ugly9ugly19ugly18htmovercolor-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly3ugly7ugly20ugly8endcap-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly4ugly5ugly22ugly10initialize :parameters () :precondition
 ...
 (:action ugly5ugly22ugly10ugly1blackprinter-simplexandinvert-letter
  :parameters
 ...
 (:action ugly6ugly16ugly15ugly11htmoverblack-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly7ugly20ugly8ugly2blackfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly8ugly2ugly9ugly19up-movetop-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly9ugly19ugly18ugly13finisher1-stack-letter :parameters
 ...
 (:action ugly10ugly1ugly17ugly4colorcontainer-fromime-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly11ugly3ugly7ugly20colorfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly12ugly23ugly12ugly23down-movedown-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly13ugly21ugly6ugly16blackcontainer-fromime-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly14ugly14ugly14ugly14blackcontainer-toime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet blackcontainer_entry-blackfeeder_exit))
  :effect
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly15ugly11ugly3ugly7finisher1-passthrough-letter :parameters
  (?sheet - sheet_t) :precondition
  ...
  (and (not (available finisher1-rsrc))
       ...
       (not (location ?sheet finisher1_entry-up_topexit))
       (available finisher1-rsrc) (increase (total-cost) 8000)))
 (:action ugly16ugly15ugly11ugly3colorprinter-simplexmono-letter :parameters
 ...
 (:action ugly17ugly4ugly5ugly22down-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
 ...
 (:action ugly18ugly13ugly21ugly6blackprinter-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available blackprinter-rsrc) (sheetsize ?sheet letter)
       (sideup ?sheet ?face) (imagecolor ?image black)
       (location ?sheet blackcontainer_exittoime-blackprinter_entry)
 ...
 (:action ugly19ugly18ugly13ugly21colorprinter-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly20ugly8ugly2ugly9up-moveup-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_exit-up_bottomentry))
  :effect
 ...
 (:action ugly21ugly6ugly16ugly15down-movebottom-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet down_bottomentry-colorfeeder_exit))
  :effect
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly22ugly10ugly1ugly17colorcontainer-toime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_entry-down_bottomexit))
  :effect
  (and (not (available colorcontainer-rsrc))
       ...
       (available colorcontainer-rsrc) (increase (total-cost) 8000)))
 (:action ugly23ugly12ugly23ugly12finisher2-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
