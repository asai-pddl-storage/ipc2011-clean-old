...
(define (domain etipp) (:requirements :typing :action-costs)
 (:predicates (oppositeside ?side1 - side_t ?side2 - side_t)
  ...
  (sheetsize ?sheet - sheet_t ?size - size_t) (uninitialized)
 ...
 (:action ugly1434033ugly30ugly22ugly13ugly27lc1-mergeinvert-letter :parameters
 ...
 (:action ugly1434034ugly18ugly8ugly26ugly1om-upperout-letter :parameters
 ...
 (:action ugly1434035ugly19ugly31ugly7ugly17fe1-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434036ugly5ugly24ugly30ugly22lc1-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434037ugly9ugly33ugly23ugly20uc1-merge-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434038ugly24ugly30ugly22ugly13lc2-merge-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
 ...
 (:action ugly1434039ugly26ugly1ugly32ugly19rh2-returnmove-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434040ugly13ugly27ugly16ugly12im1-loopupper-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1434041ugly25ugly36ugly25ugly36lc2-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434042ugly3ugly28ugly15ugly11im1-movelower-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434043ugly35ugly2ugly18ugly8lc2-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434044ugly29ugly9ugly33ugly23uc2-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  ...
  (and (not (available uc2-rsrc)) (location ?sheet ure_entry-uc2_offramp)
       ...
       (increase (total-cost) 17452)))
 (:action ugly1434045ugly28ugly15ugly11ugly5ure-simplexmono-letter :parameters
 ...
 (:action ugly1434046ugly33ugly23ugly20ugly10om-lowerreturn-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434047ugly15ugly11ugly5ugly24lre-simplexmono-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  ...
  (and (not (available lre-rsrc)) (location ?sheet lc2_onramp-lre_exit)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434048ugly32ugly19ugly31ugly7lbe-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly1434049ugly21ugly14ugly4ugly21lc1-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434050ugly27ugly16ugly12ugly6lre-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available lre-rsrc) (sheetsize ?sheet letter) (sideup ?sheet ?face)
  ...
  (and (not (available lre-rsrc)) (location ?sheet lc2_onramp-lre_exit)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434051ugly31ugly7ugly17ugly3lc2-mergeinvert-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available lc2-rsrc)) (location ?sheet om_bottomentry-lc2_exit)
       ...
       (increase (total-cost) 78919)))
 (:action ugly1434052ugly22ugly13ugly27ugly16ube-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  ...
  (and (not (available ube-rsrc)) (location ?sheet uc1_onramp-ube_exit)
       ...
       (increase (total-cost) 123749)))
 (:action ugly1434053ugly6ugly29ugly9ugly33ure-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available ure-rsrc) (sheetsize ?sheet letter) (sideup ?sheet ?face)
  ...
  (and (not (available ure-rsrc)) (location ?sheet ure_exit-uc2_onramp)
       ...
       (increase (total-cost) 211849)))
 (:action ugly1434054ugly1ugly32ugly19ugly31im1-looplower-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet rh1_exit-im1_returnentry))
  :effect
 ...
 (:action ugly1434055ugly23ugly20ugly10ugly35fe1-feedmsi-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available fe1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet some_feeder_tray))
  :effect
 ...
 (:action ugly1434056ugly17ugly3ugly28ugly15uc1-mergeinvert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc1-rsrc)) (location ?sheet uc2_entry-uc1_exit)
       ...
       (increase (total-cost) 28119)))
 (:action ugly1434057ugly11ugly5ugly24ugly30uc2-mergeinvert-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (increase (total-cost) 78919)))
 (:action ugly1434058ugly2ugly18ugly8ugly26initialize :parameters ()
 ...
 (:action ugly1434059ugly7ugly17ugly3ugly28lc1-merge-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available lc1-rsrc)) (location ?sheet lc1_exit-lc2_entry)
       ...
       (increase (total-cost) 27709)))
 (:action ugly1434060ugly10ugly35ugly2ugly18uc1-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc1-rsrc)) (location ?sheet uc2_entry-uc1_exit)
       ...
       (increase (total-cost) 10890)))
 (:action ugly1434061ugly4ugly21ugly14ugly4uc2-merge-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (not (sideup ?sheet ?face)) (available uc2-rsrc)
       (increase (total-cost) 78919)))
 (:action ugly1434062ugly12ugly6ugly29ugly9om-lowerout-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
       (location ?sheet om_bottomentry-lc2_exit))
  :effect
 ...
 (:action ugly1434063ugly16ugly12ugly6ugly29uc1-divert-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc1-rsrc)) (location ?sheet ube_entry-uc1_offramp)
       ...
       (not (sideup ?sheet ?face)) (available uc1-rsrc)
       (increase (total-cost) 11805)))
 (:action ugly1434064ugly36ugly25ugly36ugly25sys-stack-letter :parameters
 ...
 (:action ugly1434065ugly20ugly10ugly35ugly2rh1-returnmove-letter :parameters
  (?sheet - sheet_t) :precondition
  ...
  (and (not (available rh1-rsrc)) (location ?sheet rh1_exit-im1_returnentry)
       ...
       (increase (total-cost) 10869)))
 (:action ugly1434066ugly14ugly4ugly21ugly14im1-moveupper-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available im1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet fe1_exit-im1_feedentry))
  :effect
 ...
 (:action ugly1434067ugly8ugly26ugly1ugly32uc2-fmove-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc2-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc2-rsrc)) (location ?sheet uc2_exit-om_topentry)
       ...
       (increase (total-cost) 11207)))
 (:action ugly1434068ugly34ugly34ugly34ugly34om-upperreturn-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available om-rsrc) (sheetsize ?sheet letter)
       (location ?sheet uc2_exit-om_topentry))
  :effect
