...
(define (domain upp) (:requirements :typing :action-costs)
 ...
 (:action ugly1ugly17ugly4colorcontainer-fromime-letter :parameters
 ...
 (:action ugly2ugly9ugly19up-movetop-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly3ugly7ugly20colorfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly4ugly5ugly22down-movetop-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly6ugly16ugly15down-movebottom-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet down_bottomentry-colorfeeder_exit))
  :effect
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly7ugly20ugly8endcap-move-letter :parameters (?sheet - sheet_t)
  :precondition
 ...
 (:action ugly8ugly2ugly9up-moveup-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_exit-up_bottomentry))
  :effect
 ...
 (:action ugly9ugly19ugly18htmovercolor-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly10ugly1ugly17colorcontainer-toime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorcontainer_entry-down_bottomexit))
  :effect
  (and (not (available colorcontainer-rsrc))
       ...
       (available colorcontainer-rsrc) (increase (total-cost) 8000)))
 (:action ugly11ugly3ugly7finisher1-passthrough-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly12ugly23ugly12finisher2-stack-letter :parameters
 ...
 (:action ugly13ugly21ugly6blackprinter-simplex-letter :parameters
 ...
 (:action ugly14ugly14ugly14blackcontainer-toime-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly15ugly11ugly3colorprinter-simplexmono-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly16ugly15ugly11htmoverblack-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly17ugly4ugly5finisher2-passthrough-letter :parameters
  (?sheet - sheet_t) :precondition
  ...
  (and (not (available finisher2-rsrc)) (location ?sheet finisher2_exit)
       (not (location ?sheet finisher2_entry-finisher1_exit))
       (available finisher2-rsrc) (increase (total-cost) 8000)))
 (:action ugly18ugly13ugly21colorprinter-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly19ugly18ugly13finisher1-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
  ...
  (and (not (available finisher1-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher1_entry-up_topexit))
       (available finisher1-rsrc) (increase (total-cost) 8000)))
 (:action ugly20ugly8ugly2blackfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly21ugly6ugly16blackcontainer-fromime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet blackprinter_exit-blackcontainer_entryfromime))
  :effect
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly22ugly10ugly1blackprinter-simplexandinvert-letter :parameters
 ...
 (:action ugly23ugly12ugly23down-movedown-letter :parameters (?sheet - sheet_t)
  :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
