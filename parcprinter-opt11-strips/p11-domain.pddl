...
(define (domain etipp) (:requirements :typing :action-costs)
 (:predicates (available ?resource - resource_t) (uninitialized)
 ...
 (:action ugly1434092ugly5ugly22ugly10ugly1lc1-toime-letter :parameters
 ...
 (:action ugly1434093ugly9ugly19ugly18ugly13lime-simplex-letter :parameters
 ...
 (:action ugly1434094ugly3ugly7ugly20ugly8fe1-feedmsi-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action
  ugly1434095ugly19ugly18ugly13ugly21hw1-toprightentrytotopleftexit-letter
 ...
 (:action ugly1434096ugly12ugly23ugly12ugly23uc1-toime-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action
  ugly1434097ugly21ugly6ugly16ugly15hw1-bottomrightentrytorightexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action
  ugly1434098ugly11ugly3ugly7ugly20hw1-bottomrightentrytotopleftexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet lc1_exit-hw1_bottomrightentry))
  :effect
 ...
 (:action ugly1434099ugly4ugly5ugly22ugly10initialize :parameters ()
 ...
 (:action
  ugly1434100ugly7ugly20ugly8ugly2hw1-bottomrightentrytobottomleftexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet lc1_exit-hw1_bottomrightentry))
  :effect
  (and (not (available hw1-rsrc))
       ...
       (not (location ?sheet lc1_exit-hw1_bottomrightentry))
       (available hw1-rsrc) (increase (total-cost) 8999)))
 (:action ugly1434101ugly23ugly12ugly23ugly12sys-stack-letter :parameters
 ...
 (:action ugly1434102ugly8ugly2ugly9ugly19lc1-inverttoime-letter :parameters
 ...
 (:action ugly1434103ugly10ugly1ugly17ugly4hw1-leftentrytobottomleftexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available hw1-rsrc))
       ...
       (increase (total-cost) 1499)))
 (:action ugly1434104ugly1ugly17ugly4ugly5lime-simplexmono-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available lime-rsrc) (sheetsize ?sheet letter) (sideup ?sheet ?face)
  ...
  (and (not (available lime-rsrc)) (location ?sheet lc1_entryfromime-lime_exit)
       ...
       (increase (total-cost) 212790)))
 (:action ugly1434105ugly20ugly8ugly2ugly9lc1-fromime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1434106ugly2ugly9ugly19ugly18uc1-inverttoime-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
       (oppositeside ?face ?otherface)
 ...
 (:action ugly1434107ugly14ugly14ugly14ugly14uc1-fromime-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available uc1-rsrc) (sheetsize ?sheet letter)
  ...
  (and (not (available uc1-rsrc)) (location ?sheet hw1_toprightentry-uc1_exit)
       ...
       (increase (total-cost) 2999)))
 (:action
  ugly1434108ugly16ugly15ugly11ugly3hw1-toprightentrytobottomleftexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet hw1_toprightentry-uc1_exit))
  :effect
  (and (not (available hw1-rsrc))
       ...
       (not (location ?sheet hw1_toprightentry-uc1_exit)) (available hw1-rsrc)
       (increase (total-cost) 8999)))
 (:action ugly1434109ugly15ugly11ugly3ugly7lc1-invertfromime-letter :parameters
  (?sheet - sheet_t ?face - side_t ?otherface - side_t) :precondition
  (and (available lc1-rsrc) (sheetsize ?sheet letter)
       (oppositeside ?face ?otherface)
  ...
  (and (not (available lc1-rsrc))
       ...
       (not (sideup ?sheet ?face)) (available lc1-rsrc)
       (increase (total-cost) 9999)))
 (:action ugly1434110ugly17ugly4ugly5ugly22hw1-toprightentrytorightexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet hw1_toprightentry-uc1_exit))
  :effect
  (and (not (available hw1-rsrc)) (location ?sheet hw1_rightexit-sys_entry)
       (not (location ?sheet hw1_toprightentry-uc1_exit)) (available hw1-rsrc)
       (increase (total-cost) 1499)))
 (:action ugly1434111ugly6ugly16ugly15ugly11fe1-feed-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available fe1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet some_feeder_tray))
  :effect
 ...
 (:action ugly1434112ugly18ugly13ugly21ugly6uime-simplex-letter :parameters
  (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly1434113ugly13ugly21ugly6ugly16uc1-invertfromime-letter
  ...
  (and (not (available uc1-rsrc)) (location ?sheet hw1_toprightentry-uc1_exit)
       ...
       (not (sideup ?sheet ?face)) (available uc1-rsrc)
       (increase (total-cost) 8000)))
 (:action ugly1434114ugly22ugly10ugly1ugly17hw1-leftentrytotopleftexit-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available hw1-rsrc) (sheetsize ?sheet letter)
       (location ?sheet fe1_exit-hw1_leftentry))
  :effect
