...
(define (domain upp) (:requirements :typing :action-costs)
 (:predicates (location ?sheet - sheet_t ?location - location_t)
  ...
  (uninitialized) (imagecolor ?image - image_t ?color - color_t))
 ...
 (:action ugly1433964ugly1ugly17ugly4ugly5finisher2-passthrough-letter
 ...
 (:action ugly1433965ugly11ugly3ugly7ugly20colorfeeder-feed-letter :parameters
 ...
 (:action ugly1433966ugly20ugly8ugly2ugly9up-moveup-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433967ugly18ugly13ugly21ugly6blackprinter-simplex-letter
 ...
 (:action ugly1433968ugly17ugly4ugly5ugly22down-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433969ugly14ugly14ugly14ugly14blackcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433970ugly6ugly16ugly15ugly11htmoverblack-move-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433971ugly4ugly5ugly22ugly10initialize :parameters ()
 ...
 (:action ugly1433972ugly22ugly10ugly1ugly17colorcontainer-toime-letter
  :parameters (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433973ugly8ugly2ugly9ugly19up-movetop-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available up-rsrc) (sheetsize ?sheet letter)
 ...
 (:action ugly1433974ugly7ugly20ugly8ugly2blackfeeder-feed-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433975ugly5ugly22ugly10ugly1blackprinter-simplexandinvert-letter
  :parameters
 ...
 (:action ugly1433976ugly3ugly7ugly20ugly8endcap-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433977ugly12ugly23ugly12ugly23down-movedown-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet htmoverblack_exit-down_topentry))
  :effect
 ...
 (:action ugly1433978ugly13ugly21ugly6ugly16blackcontainer-fromime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available blackcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet blackprinter_exit-blackcontainer_entryfromime))
  :effect
  (and (not (available blackcontainer-rsrc))
       ...
       (available blackcontainer-rsrc) (increase (total-cost) 2000)))
 (:action ugly1433979ugly23ugly12ugly23ugly12finisher2-stack-letter :parameters
  ...
  (and (not (available finisher2-rsrc)) (location ?sheet some_finisher_tray)
       ...
       (not (location ?sheet finisher2_entry-finisher1_exit))
       (available finisher2-rsrc) (increase (total-cost) 8000)))
 (:action ugly1433980ugly19ugly18ugly13ugly21colorprinter-simplex-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
 ...
 (:action ugly1433981ugly2ugly9ugly19ugly18htmovercolor-move-letter :parameters
  (?sheet - sheet_t) :precondition
 ...
 (:action ugly1433982ugly9ugly19ugly18ugly13finisher1-stack-letter :parameters
  (?sheet - sheet_t ?prevsheet - sheet_t) :precondition
 ...
 (:action ugly1433983ugly21ugly6ugly16ugly15down-movebottom-letter :parameters
  (?sheet - sheet_t) :precondition
  (and (available down-rsrc) (sheetsize ?sheet letter)
       (location ?sheet down_bottomentry-colorfeeder_exit))
  :effect
  (and (not (available down-rsrc))
       ...
       (available down-rsrc) (increase (total-cost) 2999)))
 (:action ugly1433984ugly16ugly15ugly11ugly3colorprinter-simplexmono-letter
  :parameters (?sheet - sheet_t ?face - side_t ?image - image_t) :precondition
  (and (available colorprinter-rsrc) (sheetsize ?sheet letter)
       (sideup ?sheet ?face) (imagecolor ?image black)
       (location ?sheet colorcontainer_exittoime-colorprinter_entry)
  ...
  (and (not (available colorprinter-rsrc))
       ...
       (increase (total-cost) 224040)))
 (:action ugly1433985ugly15ugly11ugly3ugly7finisher1-passthrough-letter
  :parameters (?sheet - sheet_t) :precondition
  ...
  (and (not (available finisher1-rsrc))
       ...
       (not (location ?sheet finisher1_entry-up_topexit))
       (available finisher1-rsrc) (increase (total-cost) 8000)))
 (:action ugly1433986ugly10ugly1ugly17ugly4colorcontainer-fromime-letter
  :parameters (?sheet - sheet_t) :precondition
  (and (available colorcontainer-rsrc) (sheetsize ?sheet letter)
       (location ?sheet colorprinter_exit-colorcontainer_entryfromime))
  :effect
