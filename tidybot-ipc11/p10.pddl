(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (thing-goal thing0 x3 y5)
   (thing-goal thing0 x5 y2)
   (thing-goal thing1 x3 y6)
   (thing-goal thing1 x1 y2)
   (thing-goal thing2 x4 y5)
   (thing-goal thing3 x4 y6)
   (thing-goal thing3 x4 y2)
   ...
   (thing-pos thing1 x7 y6)
   (thing-pos thing2 x4 y2)
   (thing-pos thing3 x5 y1)
