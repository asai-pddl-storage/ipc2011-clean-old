...
(define (domain transport-strips) (:requirements :typing :action-costs)
 ...
 (:action
  ugly11099ugly11100ugly11101ugly11099ugly11100ugly11101ugly1ugly3ugly2ugly1drive
  :parameters
 ...
 (:action
  ugly11100ugly11101ugly11099ugly11100ugly11101ugly11099ugly2ugly1ugly3ugly2load
  :parameters (?p - package ?t - truck ?l - location) :precondition
  (and (at ?t ?l) (at ?p ?l)) :effect (and (not (at ?p ?l)) (in ?p ?t)))
 (:action
  ugly11101ugly11099ugly11100ugly11101ugly11099ugly11100ugly3ugly2ugly1ugly3unload
  :parameters (?p - package ?t - truck ?l - location) :precondition
