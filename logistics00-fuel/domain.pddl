...
(define (domain logistics) (:requirements :strips :action-costs)
 (:predicates (package ?obj) (airport ?airport) (city ?city) (truck ?truck)
  (in-city ?obj ?city) (at ?obj ?loc) (airplane ?airplane) (location ?loc)
  (in ?obj ?obj))
 (:functions (total-cost) - number)
 (:action ugly11085ugly4ugly4ugly4ugly4unload-airplane :parameters
 ...
 (:action ugly11090ugly6ugly5ugly1ugly3fly-airplane :parameters
