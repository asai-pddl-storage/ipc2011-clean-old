...
(define (domain logistics) (:requirements :strips :action-costs)
 (:predicates (airplane ?airplane) (location ?loc) (package ?obj) (city ?city)
  (truck ?truck) (at ?obj ?loc) (airport ?airport) (in-city ?obj ?city)
  (in ?obj ?obj))
 (:functions (total-cost) - number)
 (:action ugly1ugly3ugly6ugly5load-truck :parameters (?obj ?truck ?loc)
  :precondition
  (and (package ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (at ?obj ?loc))
  :effect (and (not (at ?obj ?loc)) (in ?obj ?truck)))
 (:action ugly2ugly2ugly2ugly2load-airplane :parameters (?obj ?airplane ?loc)
  :precondition
  (and (package ?obj) (airplane ?airplane) (location ?loc) (at ?obj ?loc)
       (at ?airplane ?loc))
  :effect (and (not (at ?obj ?loc)) (in ?obj ?airplane)))
 (:action ugly3ugly6ugly5ugly1unload-truck :parameters (?obj ?truck ?loc)
  :precondition
  (and (package ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (in ?obj ?truck))
  :effect (and (not (in ?obj ?truck)) (at ?obj ?loc)))
 (:action ugly4ugly4ugly4ugly4unload-airplane :parameters (?obj ?airplane ?loc)
  :precondition
  (and (package ?obj) (airplane ?airplane) (location ?loc) (in ?obj ?airplane)
       (at ?airplane ?loc))
  :effect (and (not (in ?obj ?airplane)) (at ?obj ?loc)))
 (:action ugly5ugly1ugly3ugly6drive-truck :parameters
 ...
 (:action ugly6ugly5ugly1ugly3fly-airplane :parameters
