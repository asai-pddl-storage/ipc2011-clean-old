...
(define (domain logistics) (:requirements :strips :action-costs)
 (:predicates (truck ?truck) (package ?obj) (in-city ?obj ?city)
  (location ?loc) (airport ?airport) (at ?obj ?loc) (city ?city)
  (airplane ?airplane) (in ?obj ?obj))
 (:functions (total-cost) - number)
 (:action ugly11085ugly11088ugly11086ugly1ugly3ugly6ugly5load-truck :parameters
  (?obj ?truck ?loc) :precondition
  (and (package ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (at ?obj ?loc))
  :effect (and (not (at ?obj ?loc)) (in ?obj ?truck)))
 (:action ugly11086ugly11085ugly11088ugly2ugly2ugly2ugly2load-airplane
 ...
 (:action ugly11087ugly11087ugly11087ugly3ugly6ugly5ugly1unload-truck
  :parameters (?obj ?truck ?loc) :precondition
  (and (package ?obj) (truck ?truck) (location ?loc) (at ?truck ?loc)
       (in ?obj ?truck))
  :effect (and (not (in ?obj ?truck)) (at ?obj ?loc)))
 (:action ugly11088ugly11086ugly11085ugly4ugly4ugly4ugly4unload-airplane
  :parameters (?obj ?airplane ?loc) :precondition
  (and (package ?obj) (airplane ?airplane) (location ?loc) (in ?obj ?airplane)
       (at ?airplane ?loc))
  :effect (and (not (in ?obj ?airplane)) (at ?obj ?loc)))
 (:action ugly11089ugly11089ugly11089ugly5ugly1ugly3ugly6drive-truck
 ...
 (:action ugly11090ugly11090ugly11090ugly6ugly5ugly1ugly3fly-airplane
