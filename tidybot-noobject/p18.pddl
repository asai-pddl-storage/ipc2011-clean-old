(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x6 y4)
   (object-goal thing0 x1 y2)
   (object-goal thing1 x6 y5)
   (object-goal thing2 x7 y4)
   (object-goal thing2 x2 y6)
   (object-goal thing3 x7 y5)
   ...
   (object-pos thing0 x1 y2)
   (object-pos thing1 x3 y6)
   (object-pos thing2 x2 y2)
