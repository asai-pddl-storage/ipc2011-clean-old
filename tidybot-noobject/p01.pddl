(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x4 y4)
   (object-goal thing1 x4 y5)
   (object-goal thing1 x1 y3)
   (object-goal thing2 x5 y4)
   (object-goal thing2 x1 y5)
   (object-goal thing3 x5 y5)
   ...
   (object-pos thing0 x5 y5)
   (object-pos thing1 x5 y1)
   (object-pos thing2 x3 y1)
   (object-pos thing3 x1 y3)
