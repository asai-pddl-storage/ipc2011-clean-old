(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x2 y3)
   (object-goal thing1 x2 y4)
   (object-goal thing1 x7 y4)
   (object-goal thing2 x3 y3)
   (object-goal thing3 x3 y4)
   ...
   (object-pos thing0 x3 y7)
   (object-pos thing1 x3 y4)
   (object-pos thing2 x2 y4)
