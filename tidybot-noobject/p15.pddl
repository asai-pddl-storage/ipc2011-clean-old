(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x2 y2)
   (object-goal thing1 x2 y3)
   (object-goal thing1 x4 y6)
   (object-goal thing2 x3 y2)
   (object-goal thing2 x4 y7)
   (object-goal thing3 x3 y3)
   (object-goal thing3 x5 y7)
   ...
   (object-pos thing0 x4 y6)
   (object-pos thing1 x2 y2)
   (object-pos thing2 x2 y3)
   (object-pos thing3 x1 y6)
