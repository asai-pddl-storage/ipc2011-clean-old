(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x3 y5)
   (object-goal thing0 x5 y2)
   (object-goal thing1 x3 y6)
   (object-goal thing1 x1 y2)
   (object-goal thing2 x4 y5)
   (object-goal thing3 x4 y6)
   (object-goal thing3 x4 y2)
   ...
   (object-pos thing0 x3 y6)
   (object-pos thing1 x7 y6)
   (object-pos thing2 x4 y2)
   (object-pos thing3 x5 y1)
