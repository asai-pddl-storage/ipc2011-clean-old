(define 
  ...
  (:init 
   ...
   (object-goal thing0 x2 y6)
   (object-goal thing1 x5 y3)
   (object-goal thing1 x2 y3)
   (object-goal thing2 x6 y2)
   (object-goal thing2 x1 y8)
   (object-goal thing3 x6 y3)
   (object-goal thing3 x2 y6)
   ...
   (object-pos thing0 x1 y8)
   (object-pos thing1 x6 y3)
   (object-pos thing2 x1 y4)
   (object-pos thing3 x2 y6)
