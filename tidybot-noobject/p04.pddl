(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x2 y4)
   (object-goal thing0 x4 y1)
   (object-goal thing1 x2 y5)
   (object-goal thing2 x3 y4)
   (object-goal thing3 x3 y5)
   (object-goal thing3 x3 y1)
   ...
   (object-pos thing0 x2 y4)
   (object-pos thing1 x6 y6)
   (object-pos thing2 x3 y4)
   (object-pos thing3 x3 y5)
