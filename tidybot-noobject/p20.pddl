(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x5 y2)
   (object-goal thing0 x9 y3)
   (object-goal thing1 x5 y3)
   (object-goal thing2 x6 y2)
   (object-goal thing3 x6 y3)
   (object-goal thing4 x6 y7)
   (object-goal thing5 x6 y8)
   (object-goal thing5 x1 y5)
   (object-goal thing6 x7 y7)
   (object-goal thing6 x3 y9)
   (object-goal thing7 x7 y8)
   ...
   (object-pos thing0 x7 y8)
   (object-pos thing1 x6 y8)
   (object-pos thing2 x6 y2)
   (object-pos thing3 x9 y3)
   (object-pos thing4 x1 y6)
   (object-pos thing5 x7 y7)
   (object-pos thing6 x9 y4)
   (object-pos thing7 x3 y9)
