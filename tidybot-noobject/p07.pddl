(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x4 y3)
   (object-goal thing0 x1 y5)
   (object-goal thing1 x4 y4)
   (object-goal thing1 x1 y5)
   (object-goal thing2 x5 y3)
   (object-goal thing2 x1 y5)
   (object-goal thing3 x5 y4)
   (object-goal thing3 x1 y5)
   ...
   (object-pos thing0 x5 y3)
   (object-pos thing1 x5 y4)
   (object-pos thing2 x1 y6)
   (object-pos thing3 x4 y4)
