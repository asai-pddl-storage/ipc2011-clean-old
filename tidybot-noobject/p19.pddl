(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal thing0 x6 y2)
   (object-goal thing0 x1 y3)
   (object-goal thing1 x6 y3)
   (object-goal thing1 x1 y3)
   (object-goal thing2 x7 y2)
   (object-goal thing3 x7 y3)
   (object-goal thing4 x7 y7)
   (object-goal thing5 x7 y8)
   (object-goal thing6 x8 y7)
   (object-goal thing7 x8 y8)
   (object-goal thing7 x3 y3)
   (object-goal thing8 x2 y7)
   (object-goal thing9 x2 y8)
   (object-goal thing10 x3 y7)
   (object-goal thing11 x3 y8)
   ...
   (object-pos thing0 x8 y7)
   (object-pos thing1 x7 y2)
   (object-pos thing2 x2 y1)
   (object-pos thing3 x7 y3)
   (object-pos thing4 x2 y7)
   (object-pos thing5 x8 y8)
   (object-pos thing6 x7 y8)
   (object-pos thing7 x6 y3)
   (object-pos thing8 x7 y7)
   (object-pos thing9 x3 y7)
   (object-pos thing10 x1 y4)
   (object-pos thing11 x1 y3)
