...
(define (domain woodworking) (:requirements :typing :action-costs)
 (:predicates (wood ?obj - woodobj ?wood - awood)
  (surface-condition ?obj - woodobj ?surface - surface)
  (contains-part ?b - board ?p - part) (is-smooth ?surface - surface)
  (boardsize-successor ?size1 ?size2 - aboardsize) (empty ?m - highspeed-saw)
  (unused ?obj - part) (has-colour ?machine - machine ?colour - acolour)
  (grind-treatment-change ?old ?new - treatmentstatus)
  (in-highspeed-saw ?b - board ?m - highspeed-saw) (available ?obj - woodobj)
 ...
 (:action ugly1ugly2ugly5do-saw-large :parameters
 ...
 (:action ugly2ugly5ugly13cut-board-medium :parameters
  ...
  (and (increase (total-cost) 10) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly3ugly10ugly8do-grind :parameters
  ...
  (and (increase (total-cost) (grind-cost ?x))
       ...
       (colour ?x natural)))
 (:action ugly4ugly6ugly7do-saw-small :parameters
  ...
  (and (increase (total-cost) 30) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly5ugly13ugly9do-immersion-varnish :parameters
  ...
  (and (increase (total-cost) 10) (not (treatment ?x untreated))
       ...
       (colour ?x ?newcolour)))
 (:action ugly6ugly7ugly11do-saw-medium :parameters
  (?b - board ?p - part ?m - saw ?w - awood ?surface - surface ?size_before ?s1
   ?size_after - aboardsize)
  :precondition
  ...
  (and (increase (total-cost) 30) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly7ugly11ugly12do-glaze :parameters
 ...
 (:action ugly10ugly8ugly4load-highspeed-saw :parameters
 ...
 (:action ugly11ugly12ugly3cut-board-large :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 10) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly12ugly3ugly10cut-board-small :parameters
  (?b - board ?p - part ?m - highspeed-saw ?w - awood ?surface - surface
  ...
  (and (increase (total-cost) 10) (not (unused ?p)) (available ?p) (wood ?p ?w)
       (surface-condition ?p ?surface) (colour ?p natural)
       (treatment ?p untreated) (boardsize ?b ?size_after)))
 (:action ugly13ugly9ugly1do-spray-varnish :parameters
