...
(define (domain rover) (:requirements :typing :action-costs)
 (:predicates (channel_free ?l - lander) (visible ?w - waypoint ?p - waypoint)
  (have_image ?r - rover ?o - objective ?m - mode)
  (communicated_image_data ?o - objective ?m - mode)
  (visible_from ?o - objective ?w - waypoint) (empty ?s - store)
  (have_soil_analysis ?r - rover ?w - waypoint)
  (communicated_rock_data ?w - waypoint) (on_board ?i - camera ?r - rover)
  (equipped_for_soil_analysis ?r - rover) (at_lander ?x - lander ?y - waypoint)
  (store_of ?s - store ?r - rover) (at_soil_sample ?w - waypoint)
  (equipped_for_rock_analysis ?r - rover) (full ?s - store)
  (at ?x - rover ?y - waypoint) (supports ?c - camera ?m - mode)
  (equipped_for_imaging ?r - rover) (calibrated ?c - camera ?r - rover)
  (communicated_soil_data ?w - waypoint)
  (have_rock_analysis ?r - rover ?w - waypoint)
  (calibration_target ?i - camera ?o - objective)
  (can_traverse ?r - rover ?x - waypoint ?y - waypoint)
  (at_rock_sample ?w - waypoint) (available ?r - rover))
 (:types rover waypoint store camera mode lander objective)
 (:functions (total-cost) - number)
 (:action
  ugly11865ugly11865ugly11865ugly11865ugly1ugly2ugly4ugly5communicate_rock_data
  :parameters
 ...
 (:action ugly11866ugly11870ugly11871ugly11869ugly4ugly5ugly8ugly1sample_soil
 ...
 (:action ugly11867ugly11872ugly11873ugly11867ugly8ugly1ugly2ugly4calibrate
  :parameters (?r - rover ?i - camera ?t - objective ?w - waypoint)
  :precondition
  (and (equipped_for_imaging ?r) (calibration_target ?i ?t) (at ?r ?w)
       (visible_from ?t ?w) (on_board ?i ?r))
  :effect (calibrated ?i ?r))
 (:action ugly11868ugly11866ugly11870ugly11871ugly5ugly8ugly1ugly2drop
  :parameters (?x - rover ?y - store) :precondition
  (and (store_of ?y ?x) (full ?y)) :effect (and (not (full ?y)) (empty ?y)))
 (:action
  ugly11869ugly11868ugly11866ugly11870ugly7ugly7ugly7ugly7communicate_soil_data
  :parameters
  (?r - rover ?l - lander ?p - waypoint ?x - waypoint ?y - waypoint)
  :precondition
 ...
 (:action ugly11870ugly11871ugly11869ugly11868ugly2ugly4ugly5ugly8navigate
 ...
 (:action ugly11871ugly11869ugly11868ugly11866ugly6ugly6ugly6ugly6take_image
 ...
 (:action
  ugly11872ugly11873ugly11867ugly11872ugly9ugly3ugly9ugly3communicate_image_data
  :parameters
 ...
 (:action ugly11873ugly11867ugly11872ugly11873ugly3ugly9ugly3ugly9sample_rock
  :parameters (?x - rover ?s - store ?p - waypoint) :precondition
