...
(define (domain rover) (:requirements :typing :action-costs)
 (:predicates (supports ?c - camera ?m - mode) (store_of ?s - store ?r - rover)
  (have_soil_analysis ?r - rover ?w - waypoint)
  (equipped_for_imaging ?r - rover) (visible_from ?o - objective ?w - waypoint)
  (channel_free ?l - lander)
  (can_traverse ?r - rover ?x - waypoint ?y - waypoint)
  (communicated_rock_data ?w - waypoint)
  (communicated_image_data ?o - objective ?m - mode)
  (communicated_soil_data ?w - waypoint) (full ?s - store)
  (have_rock_analysis ?r - rover ?w - waypoint)
  (on_board ?i - camera ?r - rover) (at_lander ?x - lander ?y - waypoint)
  (calibrated ?c - camera ?r - rover)
  (calibration_target ?i - camera ?o - objective)
  (at_rock_sample ?w - waypoint) (equipped_for_rock_analysis ?r - rover)
  (have_image ?r - rover ?o - objective ?m - mode)
  (at ?x - rover ?y - waypoint) (equipped_for_soil_analysis ?r - rover)
  (available ?r - rover) (visible ?w - waypoint ?p - waypoint)
  (at_soil_sample ?w - waypoint) (empty ?s - store))
 (:types rover waypoint store camera mode lander objective)
 (:functions (total-cost) - number)
 (:action ugly11865ugly11865ugly1ugly2ugly4ugly5communicate_rock_data
  :parameters
 ...
 (:action ugly11866ugly11870ugly7ugly7ugly7ugly7communicate_soil_data
  :parameters
  (?r - rover ?l - lander ?p - waypoint ?x - waypoint ?y - waypoint)
  :precondition
 ...
 (:action ugly11867ugly11872ugly9ugly3ugly9ugly3communicate_image_data
  :parameters
 ...
 (:action ugly11868ugly11866ugly6ugly6ugly6ugly6take_image :parameters
 ...
 (:action ugly11869ugly11868ugly2ugly4ugly5ugly8navigate :parameters
 ...
 (:action ugly11870ugly11871ugly5ugly8ugly1ugly2drop :parameters
  (?x - rover ?y - store) :precondition (and (store_of ?y ?x) (full ?y))
  :effect (and (not (full ?y)) (empty ?y)))
 (:action ugly11871ugly11869ugly4ugly5ugly8ugly1sample_soil :parameters
 ...
 (:action ugly11872ugly11873ugly3ugly9ugly3ugly9sample_rock :parameters
  (?x - rover ?s - store ?p - waypoint) :precondition
 ...
 (:action ugly11873ugly11867ugly8ugly1ugly2ugly4calibrate :parameters
