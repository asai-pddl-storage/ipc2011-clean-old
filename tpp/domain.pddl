...
(define (domain tpp-propositional) (:requirements :strips :typing)
 ...
 (:action ugly3ugly2ugly1unload :parameters
  ...
  (and (loaded ?g ?t ?l1) (not (loaded ?g ?t ?l2)) (stored ?g ?l4)
       (not (stored ?g ?l3))))
 (:action ugly4ugly4ugly4buy :parameters
