...
(define (domain tpp-propositional)
 ...
 (:predicates (loaded ?g - goods ?t - truck ?l - level)
  (on-sale ?g - goods ?m - market ?l - level) (next ?l1 ?l2 - level)
  (stored ?g - goods ?l - level) (connected ?p1 ?p2 - place)
  (at ?t - truck ?p - place) (ready-to-load ?g - goods ?m - market ?l - level))
 (:types place locatable level - object depot market - place truck goods -
  locatable)
 (:functions (total-cost) - number)
 (:action
  ugly11904ugly11905ugly11904ugly11905ugly11904ugly2ugly1ugly3ugly2drive
  :parameters (?t - truck ?from ?to - place) :precondition
  (and (at ?t ?from) (connected ?from ?to)) :effect
  (and (not (at ?t ?from)) (at ?t ?to) (increase (total-cost) 1)))
 (:action
  ugly11905ugly11904ugly11905ugly11904ugly11905ugly1ugly3ugly2ugly1unload
  ...
  (and (loaded ?g ?t ?l1) (not (loaded ?g ?t ?l2)) (stored ?g ?l4)
       (not (stored ?g ?l3))))
 (:action ugly11906ugly11906ugly11906ugly11906ugly11906ugly3ugly2ugly1ugly3load
 ...
 (:action ugly11907ugly11907ugly11907ugly11907ugly11907ugly4ugly4ugly4ugly4buy
