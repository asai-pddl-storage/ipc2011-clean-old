...
(define (domain tpp-propositional)
 ...
 (:predicates (at ?t - truck ?p - place) (stored ?g - goods ?l - level)
  (loaded ?g - goods ?t - truck ?l - level) (next ?l1 ?l2 - level)
 ...
 (:action
  ugly11904ugly11905ugly11904ugly11905ugly11904ugly11905ugly1ugly3ugly2ugly1unload
  ...
  (and (loaded ?g ?t ?l1) (not (loaded ?g ?t ?l2)) (stored ?g ?l4)
       (not (stored ?g ?l3))))
 (:action
  ugly11905ugly11904ugly11905ugly11904ugly11905ugly11904ugly2ugly1ugly3ugly2drive
 ...
 (:action
  ugly11906ugly11906ugly11906ugly11906ugly11906ugly11906ugly3ugly2ugly1ugly3load
 ...
 (:action
  ugly11907ugly11907ugly11907ugly11907ugly11907ugly11907ugly4ugly4ugly4ugly4buy
