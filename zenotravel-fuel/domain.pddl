...
(define (domain zeno-travel) (:requirements)
 (:predicates (at ?x ?c) (aircraft ?p) (fuel-level ?a ?l) (person ?x)
  (flevel ?x) (city ?x) (next ?l1 ?l2) (in ?p ?a))
 (:functions (total-cost) - number)
 (:action ugly11908ugly11909ugly5ugly2ugly5ugly2refuel :parameters
 ...
 (:action ugly11909ugly11912ugly1ugly3ugly4ugly1fly :parameters
 ...
 (:action ugly11910ugly11910ugly3ugly4ugly1ugly3zoom :parameters
 ...
 (:action ugly11911ugly11911ugly4ugly1ugly3ugly4board :parameters (?p ?a ?c)
  :precondition (and (person ?p) (aircraft ?a) (city ?c) (at ?p ?c) (at ?a ?c))
  :effect (and (in ?p ?a) (not (at ?p ?c))))
 (:action ugly11912ugly11908ugly2ugly5ugly2ugly5debark :parameters (?p ?a ?c)
