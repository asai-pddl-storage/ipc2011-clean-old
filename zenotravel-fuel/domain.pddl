...
(define (domain zeno-travel) (:requirements)
 (:predicates (fuel-level ?a ?l) (city ?x) (at ?x ?c) (in ?p ?a) (flevel ?x)
  (aircraft ?p) (next ?l1 ?l2) (person ?x))
 (:functions (total-cost) - number)
 (:action
  ugly11908ugly11909ugly11912ugly11908ugly11909ugly5ugly2ugly5ugly2refuel
 ...
 (:action ugly11909ugly11912ugly11908ugly11909ugly11912ugly1ugly3ugly4ugly1fly
 ...
 (:action ugly11910ugly11910ugly11910ugly11910ugly11910ugly3ugly4ugly1ugly3zoom
 ...
 (:action
  ugly11911ugly11911ugly11911ugly11911ugly11911ugly4ugly1ugly3ugly4board
  :parameters (?p ?a ?c) :precondition
  (and (person ?p) (aircraft ?a) (city ?c) (at ?p ?c) (at ?a ?c)) :effect
  (and (in ?p ?a) (not (at ?p ?c))))
 (:action
  ugly11912ugly11908ugly11909ugly11912ugly11908ugly2ugly5ugly2ugly5debark
  :parameters (?p ?a ?c) :precondition
