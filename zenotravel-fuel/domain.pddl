...
(define (domain zeno-travel) (:requirements)
 (:predicates (person ?x) (fuel-level ?a ?l) (in ?p ?a) (aircraft ?p)
  (flevel ?x) (at ?x ?c) (next ?l1 ?l2) (city ?x))
 (:functions (total-cost) - number)
 (:action ugly11908ugly11909ugly11912ugly1ugly3ugly4ugly1fly :parameters
  (?a ?c1 ?c2 ?l1 ?l2) :precondition
 ...
 (:action ugly11909ugly11912ugly11908ugly2ugly5ugly2ugly5debark :parameters
  (?p ?a ?c) :precondition
  (and (person ?p) (aircraft ?a) (city ?c) (in ?p ?a) (at ?a ?c)) :effect
  (and (at ?p ?c) (not (in ?p ?a))))
 (:action ugly11910ugly11910ugly11910ugly3ugly4ugly1ugly3zoom :parameters
  (?a ?c1 ?c2 ?l1 ?l2 ?l3) :precondition
  (and (aircraft ?a) (city ?c1) (city ?c2) (flevel ?l1) (flevel ?l2)
 ...
 (:action ugly11911ugly11911ugly11911ugly4ugly1ugly3ugly4board :parameters
  (?p ?a ?c) :precondition
  (and (person ?p) (aircraft ?a) (city ?c) (at ?p ?c) (at ?a ?c)) :effect
  (and (in ?p ?a) (not (at ?p ?c))))
 (:action ugly11912ugly11908ugly11909ugly5ugly2ugly5ugly2refuel :parameters
  (?a ?c ?l ?l1) :precondition
