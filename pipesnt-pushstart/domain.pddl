...
(define (domain pipesworld_strips)
 ...
 (:predicates (first ?batch-atom - batch-atom ?pipe - pipe)
  (on ?batch-atom - batch-atom ?area - area) (not-unitary ?pipe - pipe)
  (pop-updating ?pipe - pipe) (normal ?pipe - pipe)
  (push-updating ?pipe - pipe) (connect ?from ?to - area ?pipe - pipe)
 ...
 (:action ugly31ugly31ugly31ugly1ugly5ugly6ugly4push-end :parameters
 ...
 (:action ugly32ugly32ugly32ugly2ugly3ugly1ugly5pop-unitarypipe :parameters
 ...
 (:action ugly33ugly34ugly35ugly3ugly1ugly5ugly6pop-end :parameters
 ...
 (:action ugly34ugly35ugly33ugly4ugly2ugly3ugly1push-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly35ugly33ugly34ugly5ugly6ugly4ugly2pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?last-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-last-batch - product)
  :precondition
 ...
 (:action ugly36ugly36ugly36ugly6ugly4ugly2ugly3push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product)
  :precondition
