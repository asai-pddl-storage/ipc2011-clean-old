...
(define (domain freecell) (:requirements :strips :action-costs)
 (:predicates (colspace ?n) (bottomcol ?c) (suit ?c ?s) (value ?c ?v)
  (on ?c1 ?c2) (clear ?c) (incell ?c) (canstack ?c1 ?c2) (successor ?n1 ?n0)
  (cellspace ?n) (home ?c))
 (:functions (total-cost) - number)
 (:action
  ugly11ugly18ugly14ugly16ugly12ugly20ugly9ugly2ugly9ugly2colfromfreecell
  :parameters (?card ?newcard ?cells ?ncells) :precondition
 ...
 (:action ugly12ugly20ugly19ugly13ugly17ugly11ugly8ugly10ugly6ugly4sendtonewcol
  :parameters (?card ?oldcard ?cols ?ncols) :precondition
 ...
 (:action ugly13ugly17ugly11ugly18ugly14ugly16ugly2ugly9ugly2ugly9move-b
  :parameters (?card ?newcard ?cols ?ncols) :precondition
 ...
 (:action ugly14ugly16ugly12ugly20ugly19ugly13ugly7ugly8ugly10ugly6sendtofree-b
  :parameters (?card ?cells ?ncells ?cols ?ncols) :precondition
  ...
  (and (incell ?card) (colspace ?ncols) (cellspace ?ncells)
       ...
       (not (cellspace ?cells))))
 (:action
  ugly15ugly15ugly15ugly15ugly15ugly15ugly5ugly3ugly7ugly8newcolfromfreecell
  :parameters (?card ?cols ?ncols ?cells ?ncells) :precondition
 ...
 (:action ugly16ugly12ugly20ugly19ugly13ugly17ugly1ugly1ugly1ugly1move
  :parameters (?card ?oldcard ?newcard) :precondition
 ...
 (:action ugly17ugly11ugly18ugly14ugly16ugly12ugly10ugly6ugly4ugly5sendtofree
  :parameters (?card ?oldcard ?cells ?ncells) :precondition
 ...
 (:action ugly18ugly14ugly16ugly12ugly20ugly19ugly3ugly7ugly8ugly10sendtohome
  :parameters (?card ?oldcard ?suit ?vcard ?homecard ?vhomecard) :precondition
 ...
 (:action ugly19ugly13ugly17ugly11ugly18ugly14ugly6ugly4ugly5ugly3sendtohome-b
  :parameters (?card ?suit ?vcard ?homecard ?vhomecard ?cols ?ncols)
  :precondition
 ...
 (:action
  ugly20ugly19ugly13ugly17ugly11ugly18ugly4ugly5ugly3ugly7homefromfreecell
  :parameters (?card ?suit ?vcard ?homecard ?vhomecard ?cells ?ncells)
  :precondition
