...
(define (domain freecell) (:requirements :strips :action-costs)
 (:predicates (cellspace ?n) (successor ?n1 ?n0) (suit ?c ?s) (bottomcol ?c)
  (value ?c ?v) (canstack ?c1 ?c2) (colspace ?n) (clear ?c) (home ?c)
  (on ?c1 ?c2) (incell ?c))
 (:functions (total-cost) - number)
 (:action ugly1ugly1ugly1move :parameters (?card ?oldcard ?newcard)
  :precondition
 ...
 (:action ugly2ugly9ugly2colfromfreecell :parameters
 ...
 (:action ugly3ugly7ugly8newcolfromfreecell :parameters
 ...
 (:action ugly4ugly5ugly3sendtohome-b :parameters
 ...
 (:action ugly5ugly3ugly7homefromfreecell :parameters
 ...
 (:action ugly6ugly4ugly5sendtofree :parameters (?card ?oldcard ?cells ?ncells)
  :precondition
 ...
 (:action ugly7ugly8ugly10sendtohome :parameters
 ...
 (:action ugly8ugly10ugly6sendtofree-b :parameters
  ...
  (and (incell ?card) (colspace ?ncols) (cellspace ?ncells)
       ...
       (not (cellspace ?cells))))
 (:action ugly9ugly2ugly9move-b :parameters (?card ?newcard ?cols ?ncols)
  :precondition
 ...
 (:action ugly10ugly6ugly4sendtonewcol :parameters
