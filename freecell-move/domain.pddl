...
(define (domain freecell) (:requirements :strips :action-costs)
 (:predicates (value ?c ?v) (clear ?c) (bottomcol ?c) (colspace ?n)
  (successor ?n1 ?n0) (incell ?c) (home ?c) (canstack ?c1 ?c2) (cellspace ?n)
  (suit ?c ?s) (on ?c1 ?c2))
 (:functions (total-cost) - number)
 (:action ugly11ugly18ugly14ugly6ugly4ugly5ugly3sendtohome-b :parameters
 ...
 (:action ugly12ugly20ugly19ugly3ugly7ugly8ugly10sendtohome :parameters
 ...
 (:action ugly13ugly17ugly11ugly8ugly10ugly6ugly4sendtonewcol :parameters
 ...
 (:action ugly14ugly16ugly12ugly10ugly6ugly4ugly5sendtofree :parameters
 ...
 (:action ugly15ugly15ugly15ugly5ugly3ugly7ugly8newcolfromfreecell :parameters
 ...
 (:action ugly16ugly12ugly20ugly9ugly2ugly9ugly2colfromfreecell :parameters
 ...
 (:action ugly17ugly11ugly18ugly4ugly5ugly3ugly7homefromfreecell :parameters
 ...
 (:action ugly18ugly14ugly16ugly2ugly9ugly2ugly9move-b :parameters
 ...
 (:action ugly19ugly13ugly17ugly1ugly1ugly1ugly1move :parameters
 ...
 (:action ugly20ugly19ugly13ugly7ugly8ugly10ugly6sendtofree-b :parameters
