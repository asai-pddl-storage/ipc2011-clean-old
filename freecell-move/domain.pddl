...
(define (domain freecell) (:requirements :strips :action-costs)
 (:predicates (value ?c ?v) (home ?c) (incell ?c) (colspace ?n) (suit ?c ?s)
  (on ?c1 ?c2) (successor ?n1 ?n0) (canstack ?c1 ?c2) (bottomcol ?c) (clear ?c)
  (cellspace ?n))
 (:functions (total-cost) - number)
 (:action ugly11ugly18ugly14ugly16ugly12ugly10ugly6ugly4ugly5sendtofree
 ...
 (:action ugly12ugly20ugly19ugly13ugly17ugly1ugly1ugly1ugly1move :parameters
 ...
 (:action ugly13ugly17ugly11ugly18ugly14ugly6ugly4ugly5ugly3sendtohome-b
 ...
 (:action ugly14ugly16ugly12ugly20ugly19ugly3ugly7ugly8ugly10sendtohome
 ...
 (:action ugly15ugly15ugly15ugly15ugly15ugly5ugly3ugly7ugly8newcolfromfreecell
 ...
 (:action ugly16ugly12ugly20ugly19ugly13ugly7ugly8ugly10ugly6sendtofree-b
  ...
  (and (incell ?card) (colspace ?ncols) (cellspace ?ncells)
       ...
       (not (cellspace ?cells))))
 (:action ugly17ugly11ugly18ugly14ugly16ugly2ugly9ugly2ugly9move-b :parameters
 ...
 (:action ugly18ugly14ugly16ugly12ugly20ugly9ugly2ugly9ugly2colfromfreecell
 ...
 (:action ugly19ugly13ugly17ugly11ugly18ugly4ugly5ugly3ugly7homefromfreecell
 ...
 (:action ugly20ugly19ugly13ugly17ugly11ugly8ugly10ugly6ugly4sendtonewcol
