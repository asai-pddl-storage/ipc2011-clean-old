(define (problem barman-47-4-47)
 ...
 (:goal
  (and
     ...
     (contains shot44 cocktail45)
     (contains shot45 cocktail10)
     (contains shot46 cocktail13)
