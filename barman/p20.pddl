(define (problem barman-71-10-78)
 (:domain barman)
 (:objects 
     shaker1 - shaker
     left right - hand
 ...
 (:goal
  (and
     ...
     (contains shot58 cocktail39)
     (contains shot59 cocktail56)
     (contains shot60 cocktail44)
     (contains shot61 cocktail36)
     ...
     (contains shot67 cocktail54)
     (contains shot68 cocktail21)
     (contains shot69 cocktail42)
     (contains shot70 cocktail11)
     (contains shot71 cocktail15)
     (contains shot72 ingredient4)
