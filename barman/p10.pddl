(define (problem barman-58-7-62)
 ...
 (:goal
  (and
     ...
     (contains shot57 cocktail29)
     (contains shot58 cocktail24)
     (contains shot59 ingredient3)
     (contains shot60 ingredient6)
     (contains shot61 ingredient4)
))
