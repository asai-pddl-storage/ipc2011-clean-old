...
(define (domain pipesworld_strips)
 ...
 (:predicates (last ?batch-atom - batch-atom ?pipe - pipe)
  (pop-updating ?pipe - pipe) (first ?batch-atom - batch-atom ?pipe - pipe)
  (occupied ?tank-slot - tank-slot) (push-updating ?pipe - pipe)
  ...
  (normal ?pipe - pipe) (on ?batch-atom - batch-atom ?area - area)
 ...
 (:action ugly37ugly40ugly42ugly41ugly38ugly37ugly4ugly3ugly6ugly4pop-start
  :parameters
 ...
 (:action ugly38ugly37ugly40ugly42ugly41ugly38ugly1ugly2ugly5ugly1push-end
  :parameters
 ...
 (:action
  ugly39ugly39ugly39ugly39ugly39ugly39ugly3ugly6ugly4ugly3pop-unitarypipe
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly40ugly42ugly41ugly38ugly37ugly40ugly6ugly4ugly3ugly6pop-end
  :parameters
 ...
 (:action
  ugly41ugly38ugly37ugly40ugly42ugly41ugly2ugly5ugly1ugly2push-unitarypipe
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
 ...
 (:action ugly42ugly41ugly38ugly37ugly40ugly42ugly5ugly1ugly2ugly5push-start
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
