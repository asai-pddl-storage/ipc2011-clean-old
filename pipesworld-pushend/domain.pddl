...
(define (domain pipesworld_strips)
 ...
 (:predicates (not-occupied ?tank-slot - tank-slot)
  ...
  (tank-slot-product-location ?tank-slot - tank-slot ?product - product ?area -
   area)
  (occupied ?tank-slot - tank-slot) (follow ?next ?previous - batch-atom)
 ...
 (:action ugly37ugly40ugly42ugly41ugly38ugly1ugly2ugly5ugly1push-end
  :parameters
 ...
 (:action ugly38ugly37ugly40ugly42ugly41ugly2ugly5ugly1ugly2push-unitarypipe
  :parameters
 ...
 (:action ugly39ugly39ugly39ugly39ugly39ugly3ugly6ugly4ugly3pop-unitarypipe
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
 ...
 (:action ugly40ugly42ugly41ugly38ugly37ugly4ugly3ugly6ugly4pop-start
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
  ...
  (and (pop-updating ?pipe) (not (normal ?pipe)) (last ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly41ugly38ugly37ugly40ugly42ugly5ugly1ugly2ugly5push-start
  :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
  ...
  (and (push-updating ?pipe) (not (normal ?pipe)) (first ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly42ugly41ugly38ugly37ugly40ugly6ugly4ugly3ugly6pop-end :parameters
