...
(define (domain depot) (:requirements :strips :action-costs)
 (:predicates (surface ?x) (locatable ?x) (hoist ?x) (depot ?x) (clear ?x)
  (lifting ?x ?y) (in ?x ?y) (place ?x) (truck ?x) (distributor ?x) (crate ?x)
  (at ?x ?y) (available ?x) (on ?x ?y) (pallet ?x))
 (:functions (total-cost) - number)
 (:action ugly1lift :parameters (?x ?y ?z ?p) :precondition
