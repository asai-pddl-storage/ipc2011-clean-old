...
(define (domain pegsolitaire-sequential) (:requirements :typing :action-costs)
 (:predicates (move-ended) (in-line ?x ?y ?z - location)
  (occupied ?l - location) (last-visited ?l - location) (free ?l - location))
 (:types location - object) (:functions (total-cost) - number)
 (:action ugly1ugly1ugly1jump-new-move :parameters
 ...
 (:action ugly2ugly3ugly2end-move :parameters (?loc - location) :precondition
  (last-visited ?loc) :effect (and (move-ended) (not (last-visited ?loc))))
 (:action ugly3ugly2ugly3jump-continue-move :parameters
  (?from - location ?over - location ?to - location) :precondition
