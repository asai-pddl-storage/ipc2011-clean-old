...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly10make-product-p4 :parameters () :precondition
 ...
 (:action ugly11ship-order-o5 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14open-new-stack :parameters (?open ?new-open - count)
  :precondition (and (stacks-avail ?open) (next-count ?open ?new-open)) :effect
  (and (not (stacks-avail ?open)) (stacks-avail ?new-open)
       (increase (total-cost) 1)))
 (:action ugly15ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly17ship-order-o6 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18make-product-p2 :parameters () :precondition
 ...
 (:action ugly19ship-order-o7 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly21start-order :parameters (?o - order ?avail ?new-avail - count)
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly23ship-order-o3 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24make-product-p5 :parameters () :precondition
