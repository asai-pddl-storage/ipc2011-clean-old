...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly12ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ugly5ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ugly21start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly6ugly13ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly11ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8ugly9make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o3) (started o11)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly9ugly10make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o7)) :effect (and (not (not-made p4)) (made p4)))
 (:action ugly10ugly6make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o4)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly11ugly18make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o3)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly12ugly22ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13ugly15ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly1make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o5)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly15ugly24make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o6)) :effect (and (not (not-made p5)) (made p5)))
 (:action ugly16ugly17ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly19ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly4make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o1) (started o2) (started o7) (started o8)
       (started o9))
  :effect (and (not (not-made p1)) (made p1)))
 (:action ugly19ugly20ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ugly23ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly22ugly14open-new-stack :parameters (?open ?new-open - count)
  :precondition (and (stacks-avail ?open) (next-count ?open ?new-open)) :effect
  (and (not (stacks-avail ?open)) (stacks-avail ?new-open)
       (increase (total-cost) 1)))
 (:action ugly23ugly16ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24ugly7make-product-p9 :parameters () :precondition
