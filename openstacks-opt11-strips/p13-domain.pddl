...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly44ugly4ugly8open-new-stack :parameters
 ...
 (:action ugly2ugly37ugly7ugly23make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o2)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly3ugly40ugly42ugly11ship-order-o5 :parameters
 ...
 (:action ugly4ugly8ugly1ugly44make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o9)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly5ugly31ugly25ugly13make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o19)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly6ugly2ugly37ugly7make-product-p21 :parameters () :precondition
  (and (not-made p21) (started o1)) :effect
  (and (not (not-made p21)) (made p21)))
 (:action ugly7ugly23ugly9ugly34ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8ugly1ugly44ugly4make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o8)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly9ugly34ugly36ugly3ship-order-o17 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly43ugly24ugly32make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o5)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly11ugly28ugly19ugly33make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o7) (started o9) (started o12) (started o14))
  :effect (and (not (not-made p12)) (made p12)))
 (:action ugly12ugly30ugly16ugly15make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o11) (started o15) (started o18)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly13ugly6ugly2ugly37make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o5) (started o10)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly14ugly39ugly38ugly22make-product-p16 :parameters () :precondition
  (and (not-made p16) (started o9)) :effect
  (and (not (not-made p16)) (made p16)))
 (:action ugly15ugly10ugly43ugly24ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ugly15ugly10ugly43ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly12ugly30ugly16make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o8) (started o21)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly18ugly35ugly5ugly31ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19ugly33ugly14ugly39ship-order-o15 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ugly27ugly20ugly27make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o4) (started o16) (started o20)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly21ugly17ugly12ugly30make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o11)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly22ugly18ugly35ugly5ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ugly9ugly34ugly36make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o1)) :effect (and (not (not-made p1)) (made p1)))
 (:action ugly24ugly32ugly21ugly17make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o17)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly25ugly13ugly6ugly2ship-order-o14 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly26ugly41ugly29ugly26ship-order-o18 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ugly20ugly27ugly20ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ugly19ugly33ugly14ship-order-o16 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29ugly26ugly41ugly29ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30ugly16ugly15ugly10ship-order-o20 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly31ugly25ugly13ugly6start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ugly21ugly17ugly12ship-order-o7 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly33ugly14ugly39ugly38make-product-p20 :parameters () :precondition
  (and (not-made p20) (started o16)) :effect
  (and (not (not-made p20)) (made p20)))
 (:action ugly34ugly36ugly3ugly40ship-order-o19 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ugly5ugly31ugly25make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o12)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly36ugly3ugly40ugly42make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o5) (started o10) (started o15)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly37ugly7ugly23ugly9ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ugly22ugly18ugly35make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o3)) :effect (and (not (not-made p3)) (made p3)))
 (:action ugly39ugly38ugly22ugly18ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly40ugly42ugly11ugly28make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o6) (started o13) (started o16) (started o19))
  :effect (and (not (not-made p17)) (made p17)))
 (:action ugly41ugly29ugly26ugly41ship-order-o6 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42ugly11ugly28ugly19ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly43ugly24ugly32ugly21make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o7)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly44ugly4ugly8ugly1ship-order-o21 :parameters
  (?avail ?new-avail - count) :precondition
