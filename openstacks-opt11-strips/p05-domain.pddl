...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly6ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly11ship-order-o14 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o14)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly13ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly16ship-order-o9 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17make-product-p9 :parameters () :precondition
 ...
 (:action ugly18ship-order-o13 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19make-product-p3 :parameters () :precondition
 ...
 (:action ugly21ship-order-o5 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o13)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly24ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly25make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o10)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly26make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o1)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly27start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly29ship-order-o8 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
