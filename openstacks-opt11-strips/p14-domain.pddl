...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly9ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly14ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly17ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o9) (started o12) (started o13)) :effect
  (and (not (not-made p3)) (made p3)))
 (:action ugly19ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ship-order-o22 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly21ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly23ship-order-o8 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24make-product-p11 :parameters () :precondition
 ...
 (:action ugly26make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o3) (started o13)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly27make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o6) (started o7) (started o8)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly28make-product-p14 :parameters () :precondition
 ...
 (:action ugly31make-product-p9 :parameters () :precondition
 ...
 (:action ugly33ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34make-product-p5 :parameters () :precondition
 ...
 (:action ugly35ship-order-o17 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly37ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly38ship-order-o18 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly39ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly45ship-order-o2 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly46make-product-p18 :parameters () :precondition
