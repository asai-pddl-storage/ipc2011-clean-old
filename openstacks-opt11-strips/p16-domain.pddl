...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly44ugly17ugly9ship-order-o18 :parameters
 ...
 (:action ugly2ugly37ugly12ugly29make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o8) (started o12)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly3ugly40ugly19ugly26make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o16)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly4ugly8ugly47ugly22ship-order-o21 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly5ugly31ugly16ugly11open-new-stack :parameters
 ...
 (:action ugly6ugly2ugly37ugly12ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly23ugly14ugly38make-product-p25 :parameters () :precondition
  (and (not-made p25) (started o19)) :effect
  (and (not (not-made p25)) (made p25)))
 (:action ugly8ugly47ugly22ugly48ship-order-o14 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ugly45ugly20ugly28ship-order-o7 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly35ugly25ugly30ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11ugly1ugly44ugly17make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o3)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly12ugly29ugly10ugly35make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o24)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly13ugly5ugly31ugly16make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o17) (started o21)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly14ugly38ugly27ugly15make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o3) (started o10)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly15ugly3ugly40ugly19make-product-p24 :parameters () :precondition
  (and (not-made p24) (started o5) (started o20) (started o22)) :effect
  (and (not (not-made p24)) (made p24)))
 (:action ugly16ugly11ugly1ugly44make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o15)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly17ugly9ugly45ugly20ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly13ugly5ugly31make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o13) (started o18) (started o23)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly19ugly26ugly7ugly23make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o1) (started o11)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly20ugly28ugly34ugly52make-product-p16 :parameters () :precondition
  (and (not-made p16) (started o5)) :effect
  (and (not (not-made p16)) (made p16)))
 (:action ugly21ugly33ugly4ugly8ship-order-o20 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly48ugly41ugly36ship-order-o16 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ugly14ugly38ugly27make-product-p13 :parameters () :precondition
 ...
 (:action ugly25ugly30ugly32ugly46ship-order-o22 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly26ugly7ugly23ugly14ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ugly15ugly3ugly40make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o19)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly28ugly34ugly52ugly18make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o13)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly29ugly10ugly35ugly25ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30ugly32ugly46ugly49ship-order-o15 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly31ugly16ugly11ugly1ship-order-o17 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ugly46ugly49ugly42make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o3) (started o15)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly33ugly4ugly8ugly47make-product-p20 :parameters () :precondition
  (and (not-made p20) (started o7) (started o16)) :effect
  (and (not (not-made p20)) (made p20)))
 (:action ugly34ugly52ugly18ugly13make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o9)) :effect (and (not (not-made p3)) (made p3)))
 (:action ugly35ugly25ugly30ugly32ship-order-o19 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36ugly43ugly21ugly33make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o2) (started o4)) :effect
  (and (not (not-made p2)) (made p2)))
 (:action ugly37ugly12ugly29ugly10ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ugly27ugly15ugly3ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly39ugly39ugly39ugly39ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly40ugly19ugly26ugly7make-product-p21 :parameters () :precondition
  (and (not-made p21) (started o19) (started o25)) :effect
  (and (not (not-made p21)) (made p21)))
 (:action ugly41ugly36ugly43ugly21ship-order-o6 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42ugly6ugly2ugly37make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o14)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly43ugly21ugly33ugly4make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o5)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly44ugly17ugly9ugly45make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o13) (started o14)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly45ugly20ugly28ugly34ship-order-o25 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o25)) (shipped o25) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly46ugly49ugly42ugly6start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly47ugly22ugly48ugly41ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly48ugly41ugly36ugly43make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o12)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly49ugly42ugly6ugly2ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly50ugly50ugly50ugly50ship-order-o23 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o23)) (shipped o23) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly51ugly51ugly51ugly51ship-order-o24 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o24)) (shipped o24) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly52ugly18ugly13ugly5ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
