...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly12ugly10ship-order-o6 :parameters
 ...
 (:action ugly2ugly5ugly21start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ugly8ugly9ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly6ugly13ugly22ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly11ugly6make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o2) (started o6) (started o7) (started o9)
       (started o11))
  :effect (and (not (not-made p11)) (made p11)))
 (:action ugly8ugly9ugly26ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ugly26ugly25ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly20ugly7make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o5)) :effect (and (not (not-made p9)) (made p9)))
 (:action ugly11ugly6ugly13ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ugly10ugly20make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o11)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly13ugly22ugly18ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly4ugly3make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o5) (started o8) (started o12)) :effect
  (and (not (not-made p6)) (made p6)))
 (:action ugly15ugly14ugly4make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o10)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly16ugly17ugly24open-new-stack :parameters
 ...
 (:action ugly17ugly24ugly1make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o2)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly18ugly15ugly14make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o1)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly19ugly23ugly16ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ugly7ugly11make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o3) (started o4) (started o8)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly21ugly2ugly5ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly18ugly15make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o11)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly23ugly16ugly17ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24ugly1ugly12make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o10)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly25ugly19ugly23ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly26ugly25ugly19ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
