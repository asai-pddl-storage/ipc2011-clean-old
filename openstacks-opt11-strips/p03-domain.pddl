...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly9ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly10ship-order-o6 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o3) (started o4) (started o8)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly12make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o10)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly13ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o1)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly15make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o11)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly16ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly17ship-order-o10 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o11)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly21start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly22ship-order-o4 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24open-new-stack :parameters (?open ?new-open - count)
  :precondition (and (stacks-avail ?open) (next-count ?open ?new-open)) :effect
  (and (not (stacks-avail ?open)) (stacks-avail ?new-open)
       (increase (total-cost) 1)))
 (:action ugly25ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
