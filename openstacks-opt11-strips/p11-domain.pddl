...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly2ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly4ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly6ship-order-o1 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o13)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly12make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o7)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly13ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly17ship-order-o10 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18make-product-p6 :parameters () :precondition
 ...
 (:action ugly22make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o6)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly23ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24make-product-p12 :parameters () :precondition
 ...
 (:action ugly27ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly31make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o6)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly32make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o2) (started o9)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly33make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o6)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly34ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o14)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly36ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly37ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly39make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o10)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly40ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
