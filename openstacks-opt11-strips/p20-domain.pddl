...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o28 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ship-order-o14 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly4ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly5make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o14)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly6ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o3) (started o14)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly8make-product-p22 :parameters () :precondition
  (and (not-made p22) (started o19)) :effect
  (and (not (not-made p22)) (made p22)))
 (:action ugly9ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly11ship-order-o5 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
  (and (waiting ?o) (stacks-avail ?avail) (next-count ?new-avail ?avail))
  :effect
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13make-product-p28 :parameters () :precondition
  (and (not-made p28) (started o24)) :effect
  (and (not (not-made p28)) (made p28)))
 (:action ugly14ship-order-o25 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o25)) (shipped o25) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly15ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o8) (started o28)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly19ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o13)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly21make-product-p26 :parameters () :precondition
  (and (not-made p26) (started o20)) :effect
  (and (not (not-made p26)) (made p26)))
 (:action ugly22make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o16)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly23ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly24ship-order-o8 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly25make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o7)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly26make-product-p29 :parameters () :precondition
  (and (not-made p29) (started o27)) :effect
  (and (not (not-made p29)) (made p29)))
 (:action ugly27make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o5)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly28ship-order-o24 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o24)) (shipped o24) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29make-product-p21 :parameters () :precondition
  (and (not-made p21) (started o23)) :effect
  (and (not (not-made p21)) (made p21)))
 (:action ugly30make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o14)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly31ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ship-order-o29 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly35ship-order-o22 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o17)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly37ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38make-product-p9 :parameters () :precondition
 ...
 (:action ugly40make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o6) (started o15) (started o21)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly41ship-order-o26 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o26)) (shipped o26) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42ship-order-o27 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o27)) (shipped o27) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly43make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o9) (started o11) (started o22)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly44ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly45ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly50ship-order-o20 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly51make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o2) (started o25)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly52make-product-p25 :parameters () :precondition
  (and (not-made p25) (started o17) (started o18)) :effect
  (and (not (not-made p25)) (made p25)))
 (:action ugly53ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly54ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly55ship-order-o23 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly59ship-order-o19 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly60make-product-p27 :parameters () :precondition
