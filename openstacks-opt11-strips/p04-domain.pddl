...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly27ugly15make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o12)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly2ugly13ugly7make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o13)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly3ugly6ugly22make-product-p3 :parameters () :precondition
 ...
 (:action ugly6ugly22ugly5make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o7)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly7ugly14ugly24ship-order-o8 :parameters
 ...
 (:action ugly8ugly12ugly25start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ugly10ugly1ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly1ugly27make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o10)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly11ugly21ugly20ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ugly25ugly2make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o6)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly13ugly7ugly14ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly24ugly23ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly15ugly3ugly6ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ugly8ugly12ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly28ugly17ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly26ugly11ship-order-o6 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19ugly19ugly19ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ugly16ugly8make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o1) (started o9) (started o11)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly21ugly20ugly16make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o12)) :effect
  (and (not (not-made p6)) (made p6)))
 (:action ugly22ugly5ugly4make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o2) (started o3) (started o5)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly23ugly18ugly26make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o4) (started o6)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly24ugly23ugly18ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly25ugly2ugly13make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o4)) :effect (and (not (not-made p5)) (made p5)))
 (:action ugly26ugly11ugly21ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ugly15ugly3make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o8) (started o10) (started o12)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly28ugly17ugly28ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
