...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly44ugly19ugly32make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o11) (started o19)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly2ugly37ugly39ugly43make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o4)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly3ugly40ugly13ugly5ship-order-o6 :parameters
 ...
 (:action ugly4ugly8ugly47ugly41make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o14) (started o16) (started o17)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly5ugly31ugly22ugly36ship-order-o17 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly6ugly2ugly37ugly39ship-order-o18 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly23ugly30ugly7make-product-p21 :parameters () :precondition
  (and (not-made p21) (started o5) (started o7) (started o21) (started o23))
  :effect (and (not (not-made p21)) (made p21)))
 (:action ugly8ugly47ugly41ugly21make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o6)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly9ugly45ugly25ugly14ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly35ugly24ugly33make-product-p16 :parameters () :precondition
  (and (not-made p16) (started o13)) :effect
  (and (not (not-made p16)) (made p16)))
 (:action ugly11ugly1ugly44ugly19ship-order-o7 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ugly29ugly17ugly16make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o8) (started o11)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly13ugly5ugly31ugly22ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly38ugly34ugly28make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o22)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly15ugly3ugly40ugly13make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o1)) :effect (and (not (not-made p3)) (made p3)))
 (:action ugly16ugly11ugly1ugly44make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o1)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly17ugly16ugly11ugly1ship-order-o19 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly46ugly48ugly27make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o12) (started o20)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly19ugly32ugly12ugly29make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o16)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly20ugly6ugly2ugly37ship-order-o14 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly21ugly4ugly8ugly47ship-order-o16 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly36ugly42ugly26make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o2) (started o9) (started o13) (started o16))
  :effect (and (not (not-made p18)) (made p18)))
 (:action ugly23ugly30ugly7ugly23ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24ugly33ugly18ugly46ship-order-o23 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o23)) (shipped o23) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly25ugly14ugly38ugly34ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly26ugly20ugly6ugly2ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ugly10ugly35ugly24ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ugly15ugly3ugly40make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o10)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly29ugly17ugly16ugly11open-new-stack :parameters
 ...
 (:action ugly30ugly7ugly23ugly30make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o3) (started o10) (started o15)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly31ugly22ugly36ugly42ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ugly12ugly29ugly17make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o5)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly33ugly18ugly46ugly48ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ugly28ugly15ugly3ship-order-o15 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ugly24ugly33ugly18ship-order-o21 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36ugly42ugly26ugly20make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o22)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly37ugly39ugly43ugly9ship-order-o20 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ugly34ugly28ugly15make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o18)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly39ugly43ugly9ugly45make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o2)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly40ugly13ugly5ugly31make-product-p20 :parameters () :precondition
  (and (not-made p20) (started o13)) :effect
  (and (not (not-made p20)) (made p20)))
 (:action ugly41ugly21ugly4ugly8ship-order-o22 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42ugly26ugly20ugly6start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly43ugly9ugly45ugly25make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o10) (started o12) (started o19)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly44ugly19ugly32ugly12ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly45ugly25ugly14ugly38ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly46ugly48ugly27ugly10ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly47ugly41ugly21ugly4make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o4)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly48ugly27ugly10ugly35make-product-p22 :parameters () :precondition
