...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o22 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly14ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly17make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o5)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly18ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o22)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly21make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o6)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly22ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly34ship-order-o3 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35make-product-p22 :parameters () :precondition
  (and (not-made p22) (started o13)) :effect
  (and (not (not-made p22)) (made p22)))
 (:action ugly36ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly37ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly39ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly40make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o10)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly41make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o14) (started o16) (started o17)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly42ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly43make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o4)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly44make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o1)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly45make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o2)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly46ship-order-o23 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o23)) (shipped o23) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly47ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly48ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
