...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly2ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly9ship-order-o17 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly14ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly20make-product-p26 :parameters () :precondition
 ...
 (:action ugly26ship-order-o11 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27make-product-p19 :parameters () :precondition
  (and (not-made p19) (started o14) (started o18) (started o21)) :effect
  (and (not (not-made p19)) (made p19)))
 (:action ugly28ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29make-product-p16 :parameters () :precondition
  (and (not-made p16) (started o14) (started o22)) :effect
  (and (not (not-made p16)) (made p16)))
 (:action ugly30ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly31make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o16) (started o20) (started o25)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly32ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly33ship-order-o23 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o23)) (shipped o23) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ship-order-o26 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o26)) (shipped o26) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly41ship-order-o2 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o3) (started o17)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly43make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o2) (started o13)) :effect
  (and (not (not-made p2)) (made p2)))
 (:action ugly44ship-order-o25 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o25)) (shipped o25) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly45ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly46ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly47make-product-p22 :parameters () :precondition
  (and (not-made p22) (started o16) (started o24)) :effect
  (and (not (not-made p22)) (made p22)))
 (:action ugly48make-product-p25 :parameters () :precondition
  (and (not-made p25) (started o7) (started o9)) :effect
  (and (not (not-made p25)) (made p25)))
 (:action ugly49ship-order-o22 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly50ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly51ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly52ship-order-o24 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o24)) (shipped o24) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly53make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o10)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly54ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
