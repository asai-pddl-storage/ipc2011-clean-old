...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly5ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly13ship-order-o8 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly16make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o2)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly17start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
  (and (waiting ?o) (stacks-avail ?avail) (next-count ?new-avail ?avail))
  :effect
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly19make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o3)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly20ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly21ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
