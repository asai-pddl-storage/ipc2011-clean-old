...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly12ugly15ugly10make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o6) (started o7)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly2ugly5ugly21ugly22make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o4)) :effect (and (not (not-made p4)) (made p4)))
 (:action ugly3ugly8ugly17ugly2make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o5) (started o8)) :effect
  (and (not (not-made p3)) (made p3)))
 (:action ugly4ugly3ugly8ugly17start-order :parameters
 ...
 (:action ugly5ugly21ugly22ugly6ship-order-o1 :parameters
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly6ugly13ugly20ugly18ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly11ugly1ugly12ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8ugly17ugly2ugly5ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ugly19ugly9ugly19make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o3)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly10ugly7ugly11ugly1make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o1) (started o2)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly11ugly1ugly12ugly15make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o3)) :effect (and (not (not-made p8)) (made p8)))
 (:action ugly12ugly15ugly10ugly7make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o1) (started o10)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly13ugly20ugly18ugly14ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly16ugly4ugly3make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o1)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly15ugly10ugly7ugly11open-new-stack :parameters
 ...
 (:action ugly16ugly4ugly3ugly8ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly2ugly5ugly21ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly14ugly16ugly4make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o3) (started o9)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly19ugly9ugly19ugly9ship-order-o7 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ugly18ugly14ugly16make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o2)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly21ugly22ugly6ugly13ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly6ugly13ugly20ship-order-o6 :parameters
  (?avail ?new-avail - count) :precondition
