...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o21)) (shipped o21) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly14ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly19ship-order-o10 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly20ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly21make-product-p8 :parameters () :precondition
 ...
 (:action ugly23ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly24make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o5) (started o16)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly25make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o18)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly26ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29make-product-p20 :parameters () :precondition
  (and (not-made p20) (started o17)) :effect
  (and (not (not-made p20)) (made p20)))
 (:action ugly30make-product-p19 :parameters () :precondition
 ...
 (:action ugly33ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34make-product-p13 :parameters () :precondition
 ...
 (:action ugly36ship-order-o23 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o23)) (shipped o23) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly37make-product-p23 :parameters () :precondition
  (and (not-made p23) (started o14)) :effect
  (and (not (not-made p23)) (made p23)))
 (:action ugly38make-product-p24 :parameters () :precondition
 ...
 (:action ugly40ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly41ship-order-o22 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o4) (started o22)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly43ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly44make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o9) (started o11) (started o22)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly45make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o6)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly46ship-order-o24 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly48ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly49make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o7) (started o9) (started o19)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly50ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
