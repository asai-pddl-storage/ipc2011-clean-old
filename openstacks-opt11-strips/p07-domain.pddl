...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1make-product-p3 :parameters () :precondition
 ...
 (:action ugly3ship-order-o16 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly4ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly5make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o14)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly6make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o1)) :effect (and (not (not-made p8)) (made p8)))
 (:action ugly7ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o3)) :effect (and (not (not-made p1)) (made p1)))
 (:action ugly9make-product-p4 :parameters () :precondition
 ...
 (:action ugly10ship-order-o9 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12ship-order-o4 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o10)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly15make-product-p5 :parameters () :precondition
 ...
 (:action ugly17ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18make-product-p12 :parameters () :precondition
 ...
 (:action ugly20make-product-p11 :parameters () :precondition
 ...
 (:action ugly21ship-order-o11 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o2)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly23ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly26ship-order-o1 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly31ship-order-o5 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32make-product-p16 :parameters () :precondition
 ...
 (:action ugly33ship-order-o3 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
