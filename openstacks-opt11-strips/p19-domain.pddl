...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly3ugly40ugly42ship-order-o28 :parameters
 ...
 (:action ugly9ugly45ugly49ship-order-o20 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly12ugly29ugly56make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o10) (started o19)) :effect
  (and (not (not-made p3)) (made p3)))
 (:action ugly13ugly55ugly15ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly15ugly39ugly18ship-order-o16 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ugly41ugly57ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly9ugly45ship-order-o19 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ugly46ugly13ship-order-o25 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly20ugly27ugly3ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly21ugly12ugly29ship-order-o26 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o26)) (shipped o26) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly34ugly48make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o2)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly23ugly38ugly25make-product-p28 :parameters () :precondition
 ...
 (:action ugly26ugly7ugly23ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27ugly3ugly40ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ugly22ugly34ship-order-o18 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29ugly56ugly5ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly32ugly17ugly9ship-order-o15 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly33ugly4ugly8ship-order-o17 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ugly48ugly16ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ugly53ugly51ship-order-o24 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly37ugly28ugly22ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ugly25ugly30ship-order-o6 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly40ugly42ugly58ship-order-o22 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o22)) (shipped o22) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly41ugly57ugly43make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o3)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly42ugly58ugly52make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o26)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly43ugly19ugly14ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly44ugly6ugly2ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly45ugly49ugly50make-product-p9 :parameters () :precondition
 ...
 (:action ugly48ugly16ugly41ship-order-o27 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o27)) (shipped o27) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly49ugly50ugly11open-new-stack :parameters
 ...
 (:action ugly50ugly11ugly1ship-order-o14 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly51ugly54ugly10ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly52ugly20ugly27make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o7) (started o9)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly53ugly51ugly54make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o12) (started o13) (started o16)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly54ugly10ugly35ship-order-o23 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly56ugly5ugly31ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly57ugly43ugly19make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o4) (started o12) (started o14) (started o22)
       (started o24))
  :effect (and (not (not-made p12)) (made p12)))
 (:action ugly58ugly52ugly20make-product-p25 :parameters () :precondition
