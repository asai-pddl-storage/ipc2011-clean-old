...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12make-product-p27 :parameters () :precondition
  (and (not-made p27) (started o26)) :effect
  (and (not (not-made p27)) (made p27)))
 (:action ugly13ship-order-o25 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o25)) (shipped o25) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly15ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly18ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly22ship-order-o4 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly25make-product-p28 :parameters () :precondition
 ...
 (:action ugly27make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o7) (started o9)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly28make-product-p20 :parameters () :precondition
  (and (not-made p20) (started o18)) :effect
  (and (not (not-made p20)) (made p20)))
 (:action ugly29ship-order-o26 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o26)) (shipped o26) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly31ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32make-product-p15 :parameters () :precondition
 ...
 (:action ugly34ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ship-order-o23 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly40ship-order-o12 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly41ship-order-o27 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o27)) (shipped o27) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly42ship-order-o28 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o28)) (shipped o28) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly43make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o3)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly44make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o5)) :effect (and (not (not-made p4)) (made p4)))
 (:action ugly45ship-order-o19 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly46make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o20) (started o22) (started o24)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly47make-product-p24 :parameters () :precondition
  (and (not-made p24) (started o1)) :effect
  (and (not (not-made p24)) (made p24)))
 (:action ugly48make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o2)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly49ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o20)) (shipped o20) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly50make-product-p9 :parameters () :precondition
 ...
 (:action ugly51ship-order-o24 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o24)) (shipped o24) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly52make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o26)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly53ship-order-o21 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly57ship-order-o13 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly58ship-order-o22 :parameters (?avail ?new-avail - count)
  :precondition
