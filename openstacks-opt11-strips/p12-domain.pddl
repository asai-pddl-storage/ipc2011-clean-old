...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly2ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly3make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o2) (started o3)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly4ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly8ship-order-o19 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o19)) (shipped o19) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly10ship-order-o6 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly11ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o3) (started o13)) :effect
  (and (not (not-made p6)) (made p6)))
 (:action ugly14make-product-p11 :parameters () :precondition
 ...
 (:action ugly16ship-order-o11 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly21make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o17)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly22make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o1)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly23make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o18)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly24start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly27ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o7) (started o8) (started o11) (started o15))
  :effect (and (not (not-made p12)) (made p12)))
 (:action ugly29ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o8)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly31make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o5) (started o10)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly32ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly33ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35make-product-p19 :parameters () :precondition
 ...
 (:action ugly37make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o2) (started o12)) :effect
  (and (not (not-made p3)) (made p3)))
 (:action ugly38ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly39ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly40make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o2)) :effect (and (not (not-made p7)) (made p7)))
 (:action ugly41make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o2) (started o8) (started o9) (started o10))
  :effect (and (not (not-made p4)) (made p4)))
 (:action ugly42ship-order-o20 :parameters (?avail ?new-avail - count)
  :precondition
