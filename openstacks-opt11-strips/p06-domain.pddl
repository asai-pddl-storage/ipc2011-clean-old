...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly6ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly11ship-order-o11 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly14make-product-p1 :parameters () :precondition
 ...
 (:action ugly16ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18open-new-stack :parameters (?open ?new-open - count)
 ...
 (:action ugly20make-product-p10 :parameters () :precondition
 ...
 (:action ugly21ship-order-o12 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ship-order-o2 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o7)) :effect (and (not (not-made p3)) (made p3)))
 (:action ugly24ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly25make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o2) (started o15)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly26ship-order-o3 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly27make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o15)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly28ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly30ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly31ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
