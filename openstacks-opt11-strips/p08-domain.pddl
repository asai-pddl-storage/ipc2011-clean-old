...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly3ship-order-o10 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly4ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o2 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly6make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o5)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly7make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o12)) :effect
  (and (not (not-made p9)) (made p9)))
 (:action ugly8ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly9make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o4)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly10make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o5) (started o11)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly11ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly12ship-order-o12 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13open-new-stack :parameters (?open ?new-open - count)
  :precondition (and (stacks-avail ?open) (next-count ?open ?new-open)) :effect
  (and (not (stacks-avail ?open)) (stacks-avail ?new-open)
       (increase (total-cost) 1)))
 (:action ugly14ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly15make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o7)) :effect (and (not (not-made p6)) (made p6)))
 (:action ugly16make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o15)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly17ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly18ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly22make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o1) (started o15)) :effect
  (and (not (not-made p13)) (made p13)))
 (:action ugly23make-product-p10 :parameters () :precondition
 ...
 (:action ugly29ship-order-o8 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly30make-product-p12 :parameters () :precondition
 ...
 (:action ugly31ship-order-o3 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly33ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly34ship-order-o1 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly35ship-order-o4 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36make-product-p8 :parameters () :precondition
