...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ugly36ugly1ugly36open-new-stack :parameters
 ...
 (:action ugly2ugly6ugly31ugly23make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o5)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly3ugly29ugly8ugly9ship-order-o6 :parameters
 ...
 (:action ugly4ugly35ugly37ugly19make-product-p13 :parameters () :precondition
  (and (not-made p13) (started o3) (started o5) (started o11) (started o12))
  :effect (and (not (not-made p13)) (made p13)))
 (:action ugly5ugly21ugly32ugly10make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o12)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly6ugly31ugly23ugly4ship-order-o15 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o15)) (shipped o15) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ugly33ugly12ugly22ship-order-o10 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8ugly9ugly26ugly17make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o1)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly9ugly26ugly17ugly13start-order :parameters
  ...
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10ugly3ugly29ugly8make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o17)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly11ugly34ugly27ugly20make-product-p14 :parameters () :precondition
  (and (not-made p14) (started o15) (started o16)) :effect
  (and (not (not-made p14)) (made p14)))
 (:action ugly12ugly22ugly30ugly5ship-order-o1 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13ugly2ugly6ugly31ship-order-o3 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ugly38ugly14ugly38make-product-p12 :parameters () :precondition
  (and (not-made p12) (started o11)) :effect
  (and (not (not-made p12)) (made p12)))
 (:action ugly15ugly28ugly24ugly11ship-order-o14 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o14)) (shipped o14) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16ugly7ugly33ugly12ship-order-o2 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly17ugly13ugly2ugly6ship-order-o11 :parameters
  (?avail ?new-avail - count) :precondition
 ...
 (:action ugly19ugly15ugly28ugly24make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o6)) :effect (and (not (not-made p9)) (made p9)))
 (:action ugly20ugly16ugly7ugly33make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o14)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly21ugly32ugly10ugly3ship-order-o9 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ugly30ugly5ugly21ship-order-o12 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23ugly4ugly35ugly37make-product-p17 :parameters () :precondition
  (and (not-made p17) (started o3) (started o7) (started o10)) :effect
  (and (not (not-made p17)) (made p17)))
 (:action ugly24ugly11ugly34ugly27make-product-p18 :parameters () :precondition
  (and (not-made p18) (started o18)) :effect
  (and (not (not-made p18)) (made p18)))
 (:action ugly25ugly18ugly25ugly18ship-order-o5 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o5)) (shipped o5) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly26ugly17ugly13ugly2make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o1) (started o8)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly27ugly20ugly16ugly7ship-order-o13 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly28ugly24ugly11ugly34ship-order-o7 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29ugly8ugly9ugly26make-product-p15 :parameters () :precondition
  (and (not-made p15) (started o9)) :effect
  (and (not (not-made p15)) (made p15)))
 (:action ugly30ugly5ugly21ugly32make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o2) (started o14) (started o18)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly31ugly23ugly4ugly35ship-order-o17 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o17)) (shipped o17) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32ugly10ugly3ugly29make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o1) (started o13)) :effect
  (and (not (not-made p6)) (made p6)))
 (:action ugly33ugly12ugly22ugly30make-product-p3 :parameters () :precondition
  (and (not-made p3) (started o4) (started o6)) :effect
  (and (not (not-made p3)) (made p3)))
 (:action ugly34ugly27ugly20ugly16make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o13) (started o17)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly35ugly37ugly19ugly15ship-order-o8 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly36ugly1ugly36ugly1ship-order-o16 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o16)) (shipped o16) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly37ugly19ugly15ugly28ship-order-o4 :parameters
  (?avail ?new-avail - count) :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly38ugly14ugly38ugly14ship-order-o18 :parameters
  (?avail ?new-avail - count) :precondition
