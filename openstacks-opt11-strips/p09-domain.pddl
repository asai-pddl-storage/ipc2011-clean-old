...
(define (domain openstacks-sequencedstrips-nonadl-nonnegated)
 ...
 (:action ugly1ship-order-o16 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly2make-product-p4 :parameters () :precondition
  (and (not-made p4) (started o1) (started o8)) :effect
  (and (not (not-made p4)) (made p4)))
 (:action ugly3ship-order-o9 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o9)) (shipped o9) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly4ship-order-o15 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly5ship-order-o1 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o1)) (shipped o1) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly6ship-order-o11 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o11)) (shipped o11) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly7ship-order-o13 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o13)) (shipped o13) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly8make-product-p7 :parameters () :precondition
  (and (not-made p7) (started o17)) :effect
  (and (not (not-made p7)) (made p7)))
 (:action ugly9ship-order-o6 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o6)) (shipped o6) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly10make-product-p1 :parameters () :precondition
  (and (not-made p1) (started o12)) :effect
  (and (not (not-made p1)) (made p1)))
 (:action ugly11ship-order-o14 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly12ship-order-o2 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o2)) (shipped o2) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly13start-order :parameters (?o - order ?avail ?new-avail - count)
  :precondition
  (and (waiting ?o) (stacks-avail ?avail) (next-count ?new-avail ?avail))
  :effect
  (and (not (waiting ?o)) (started ?o) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly14ship-order-o18 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o18)) (shipped o18) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly15ship-order-o8 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o8)) (shipped o8) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly16make-product-p5 :parameters () :precondition
  (and (not-made p5) (started o13) (started o17)) :effect
  (and (not (not-made p5)) (made p5)))
 (:action ugly17make-product-p11 :parameters () :precondition
  (and (not-made p11) (started o1)) :effect
  (and (not (not-made p11)) (made p11)))
 (:action ugly18ship-order-o5 :parameters (?avail ?new-avail - count)
  :precondition
 ...
 (:action ugly21ship-order-o12 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o12)) (shipped o12) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly22ship-order-o10 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o10)) (shipped o10) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly23make-product-p2 :parameters () :precondition
  (and (not-made p2) (started o5)) :effect (and (not (not-made p2)) (made p2)))
 (:action ugly24make-product-p9 :parameters () :precondition
  (and (not-made p9) (started o6)) :effect (and (not (not-made p9)) (made p9)))
 (:action ugly25make-product-p16 :parameters () :precondition
  (and (not-made p16) (started o11)) :effect
  (and (not (not-made p16)) (made p16)))
 (:action ugly26make-product-p15 :parameters () :precondition
 ...
 (:action ugly28ship-order-o4 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o4)) (shipped o4) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly29make-product-p6 :parameters () :precondition
  (and (not-made p6) (started o1) (started o13)) :effect
  (and (not (not-made p6)) (made p6)))
 (:action ugly30make-product-p3 :parameters () :precondition
 ...
 (:action ugly31ship-order-o3 :parameters (?avail ?new-avail - count)
  ...
  (and (not (started o3)) (shipped o3) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly32make-product-p8 :parameters () :precondition
  (and (not-made p8) (started o2) (started o14) (started o18)) :effect
  (and (not (not-made p8)) (made p8)))
 (:action ugly33make-product-p10 :parameters () :precondition
  (and (not-made p10) (started o14)) :effect
  (and (not (not-made p10)) (made p10)))
 (:action ugly34ship-order-o7 :parameters (?avail ?new-avail - count)
  :precondition
  ...
  (and (not (started o7)) (shipped o7) (not (stacks-avail ?avail))
       (stacks-avail ?new-avail)))
 (:action ugly35ship-order-o17 :parameters (?avail ?new-avail - count)
  :precondition
