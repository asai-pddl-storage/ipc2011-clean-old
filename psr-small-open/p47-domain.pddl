...
(define (domain grounded-strips-psr) (:requirements :strips :action-costs)
 (:predicates (updated-cb2) (do-wait_cb5-condeffs) (do-close_sd12-condeffs)
  (done-1) (not-closed-cb3) (closed-sd3) (closed-sd5) (not-closed-sd7)
  (do-close_sd1-condeffs) (not-updated-cb5) (not-updated-cb1) (not-closed-sd3)
  (closed-cb4) (not-closed-cb2) (closed-sd13) (do-close_sd4-condeffs)
  (do-wait_cb2-condeffs) (not-closed-sd4) (closed-sd2) (updated-cb4)
  (closed-sd7) (not-updated-cb4) (closed-sd4) (not-closed-sd9) (not-closed-sd6)
  (not-closed-sd12) (closed-sd9) (closed-sd6) (updated-cb5) (updated-cb1)
  (not-closed-sd13) (closed-sd12) (closed-sd1) (not-closed-sd1)
  (not-closed-sd14) (not-closed-sd5) (not-closed-sd8) (not-closed-sd10)
  (not-updated-cb2) (do-close_sd5-condeffs) (not-closed-cb5) (done-0)
  (closed-sd11) (do-close_sd3-condeffs) (not-updated-cb3) (closed-cb2)
  (closed-sd10) (do-close_sd6-condeffs) (closed-cb5) (not-closed-sd11)
  (closed-cb1) (updated-cb3) (closed-sd8) (closed-cb3) (do-wait_cb1-condeffs)
  (do-wait_cb3-condeffs) (closed-sd14) (not-closed-cb1) (do-normal)
  (not-closed-sd2) (not-closed-cb4))
 (:functions (total-cost) - number)
 (:action ugly1close_sd12-condeff0-yes :parameters () :precondition
 ...
 (:action ugly3close_sd3-condeff0-yes :parameters () :precondition
 ...
 (:action ugly5close_sd3 :parameters () :precondition
 ...
 (:action ugly7wait_cb3-condeff0-yes :parameters () :precondition
  (and (do-wait_cb3-condeffs) (closed-sd5)) :effect
  (and (done-0) (not-closed-cb3) (not (closed-cb3))))
 (:action ugly8close_sd3-condeff0-no-0 :parameters () :precondition
  (and (do-close_sd3-condeffs) (not-closed-sd4)) :effect (and (done-0)))
 (:action ugly9close_sd12-endof-condeffs :parameters () :precondition
  (and (do-close_sd12-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-close_sd12-condeffs)) (not (done-0))))
 (:action ugly10close_sd4-condeff0-no-1 :parameters () :precondition
 ...
 (:action ugly12wait_cb2-condeff0-no-1 :parameters () :precondition
 ...
 (:action ugly13close_sd5-condeff0-yes :parameters () :precondition
  ...
  (and (done-0) (not-closed-cb3) (not (closed-cb3))))
 (:action ugly14wait_cb4 :parameters () :precondition
  (and (do-normal) (not-updated-cb4)) :effect
  (and (not-closed-cb4) (updated-cb4) (not (closed-cb4))
       (not (not-updated-cb4))))
 (:action ugly15close_sd4-condeff0-yes :parameters () :precondition
  (and (do-close_sd4-condeffs) (closed-sd3) (closed-cb2)) :effect
  (and (done-0) (not-closed-cb2) (not (closed-cb2))))
 (:action ugly16close_sd6-endof-condeffs :parameters () :precondition
  (and (do-close_sd6-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-close_sd6-condeffs)) (not (done-0))))
 (:action ugly17open-sd14 :parameters () :precondition
  (and (do-normal) (closed-sd14) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect
  (and (increase (total-cost) 1) (not-closed-sd14) (not (closed-sd14))))
 (:action ugly18close_cb5 :parameters () :precondition
 ...
 (:action ugly20open-sd11 :parameters () :precondition
 ...
 (:action ugly23close_sd1-condeff0-no-0 :parameters () :precondition
  (and (do-close_sd1-condeffs) (not-closed-cb1)) :effect (and (done-0)))
 (:action ugly24close_cb1 :parameters () :precondition
  (and (do-normal) (not-closed-cb1) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect
  (and (closed-cb1) (not-updated-cb1) (not (not-closed-cb1))
       (not (updated-cb1))))
 (:action ugly25wait_cb5-condeff0-yes :parameters () :precondition
  (and (do-wait_cb5-condeffs) (closed-sd12)) :effect
  (and (done-0) (not-closed-cb5) (not (closed-cb5))))
 (:action ugly26close_sd6-condeff0-no-0 :parameters () :precondition
  (and (do-close_sd6-condeffs) (not-closed-cb3)) :effect (and (done-0)))
 (:action ugly27close_sd13 :parameters () :precondition
  (and (do-normal) (not-closed-sd13) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect (and (closed-sd13) (not (not-closed-sd13))))
 (:action ugly28close_sd2 :parameters () :precondition
  (and (do-normal) (not-closed-sd2) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect (and (closed-sd2) (not (not-closed-sd2))))
 (:action ugly29open-sd13 :parameters () :precondition
  (and (do-normal) (closed-sd13) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect
  (and (increase (total-cost) 1) (not-closed-sd13) (not (closed-sd13))))
 (:action ugly30close_cb3 :parameters () :precondition
  (and (do-normal) (not-closed-cb3) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect
  (and (closed-cb3) (not-updated-cb3) (not (not-closed-cb3))
       (not (updated-cb3))))
 (:action ugly31wait_cb5-condeff0-no-0 :parameters () :precondition
 ...
 (:action ugly33wait_cb3-condeff1-yes :parameters () :precondition
  (and (do-wait_cb3-condeffs) (closed-sd6)) :effect
  (and (done-1) (not-closed-cb3) (not (closed-cb3))))
 (:action ugly34close_sd6-condeff0-yes :parameters () :precondition
  (and (do-close_sd6-condeffs) (closed-cb3)) :effect
  (and (done-0) (not-closed-cb3) (not (closed-cb3))))
 (:action ugly35close_sd5-endof-condeffs :parameters () :precondition
  (and (do-close_sd5-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-close_sd5-condeffs)) (not (done-0))))
 (:action ugly36open-cb1 :parameters () :precondition
 ...
 (:action ugly45wait_cb3-condeff0-no-0 :parameters () :precondition
  (and (do-wait_cb3-condeffs) (not-closed-sd5)) :effect (and (done-0)))
 (:action ugly46wait_cb5-endof-condeffs :parameters () :precondition
  (and (do-wait_cb5-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-wait_cb5-condeffs)) (not (done-0))))
 (:action ugly47close_sd5 :parameters () :precondition
  (and (do-normal) (not-closed-sd5) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect
  (and (not (do-normal)) (do-close_sd5-condeffs) (closed-sd5)
       (not (not-closed-sd5))))
 (:action ugly48wait_cb3-condeff1-no-0 :parameters () :precondition
  (and (do-wait_cb3-condeffs) (not-closed-sd6)) :effect (and (done-1)))
 (:action ugly49wait_cb1-condeff0-no-0 :parameters () :precondition
  (and (do-wait_cb1-condeffs) (not-closed-sd1)) :effect (and (done-0)))
 (:action ugly50close_sd8 :parameters () :precondition
 ...
 (:action ugly58close_cb2 :parameters () :precondition
  ...
  (and (closed-cb2) (not-updated-cb2) (not (not-closed-cb2))
       (not (updated-cb2))))
 (:action ugly59wait_cb1-endof-condeffs :parameters () :precondition
  (and (do-wait_cb1-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-wait_cb1-condeffs)) (not (done-0))))
 (:action ugly60open-sd7 :parameters () :precondition
  (and (do-normal) (closed-sd7) (updated-cb1) (updated-cb2) (updated-cb3)
       (updated-cb4) (updated-cb5))
  :effect (and (increase (total-cost) 1) (not-closed-sd7) (not (closed-sd7))))
 (:action ugly61close_sd12 :parameters () :precondition
