...
(define (domain barman) (:requirements :strips :typing :action-costs)
 (:predicates (holding ?h - hand ?c - container) (shaked ?s - shaker)
  (handempty ?h - hand) (cocktail-part1 ?c - cocktail ?i - ingredient)
  (unshaked ?s - shaker) (empty ?c - container)
  (contains ?c - container ?b - beverage) (shaker-level ?s - shaker ?l - level)
  (used ?c - container ?b - beverage) (ontable ?c - container)
  (shaker-empty-level ?s - shaker ?l - level)
  (cocktail-part2 ?c - cocktail ?i - ingredient)
  (dispenses ?d - dispenser ?i - ingredient) (next ?l1 ?l2 - level)
  (clean ?c - container))
 (:types hand level beverage dispenser container - object ingredient cocktail -
  beverage shot shaker - container)
 (:functions (total-cost) - number)
 (:action ugly37478ugly37479ugly9ugly9ugly9ugly9empty-shaker :parameters
 ...
 (:action ugly37482ugly37483ugly11ugly12ugly3ugly10pour-shot-to-used-shaker
  ...
  (and (not (contains ?s ?i)) (contains ?d ?i) (empty ?s)
       ...
       (increase (total-cost) 1)))
 (:action ugly37483ugly37488ugly3ugly10ugly8ugly4clean-shot :parameters
 ...
 (:action ugly37484ugly37487ugly8ugly4ugly6ugly7shake :parameters
 ...
 (:action ugly37485ugly37481ugly5ugly1ugly2ugly5grasp :parameters
  (?h - hand ?c - container) :precondition (and (ontable ?c) (handempty ?h))
  :effect
  (and (not (ontable ?c)) (not (handempty ?h)) (holding ?h ?c)
       (increase (total-cost) 1)))
 (:action ugly37486ugly37478ugly2ugly5ugly1ugly2empty-shot :parameters
 ...
 (:action ugly37487ugly37485ugly4ugly6ugly7ugly11pour-shaker-to-shot
 ...
 (:action ugly37488ugly37480ugly12ugly3ugly10ugly8refill-shot :parameters
  (?s - shot ?i - ingredient ?h1 ?h2 - hand ?d - dispenser) :precondition
  (and (holding ?h1 ?s) (handempty ?h2) (dispenses ?d ?i) (empty ?s)
       (used ?s ?i))
  :effect (and (not (empty ?s)) (contains ?s ?i) (increase (total-cost) 10)))
 (:action ugly37489ugly37484ugly10ugly8ugly4ugly6pour-shot-to-clean-shaker
  :parameters (?s - shot ?i - ingredient ?d - shaker ?h1 - hand ?l ?l1 - level)
  :precondition
