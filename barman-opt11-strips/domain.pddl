...
(define (domain barman) (:requirements :strips :typing :action-costs)
 (:predicates (shaked ?s - shaker) (used ?c - container ?b - beverage)
  (cocktail-part2 ?c - cocktail ?i - ingredient)
  (cocktail-part1 ?c - cocktail ?i - ingredient)
  (holding ?h - hand ?c - container) (unshaked ?s - shaker)
  (clean ?c - container) (shaker-empty-level ?s - shaker ?l - level)
  (contains ?c - container ?b - beverage)
  (dispenses ?d - dispenser ?i - ingredient) (ontable ?c - container)
  (next ?l1 ?l2 - level) (shaker-level ?s - shaker ?l - level)
  (empty ?c - container) (handempty ?h - hand))
 (:types hand level beverage dispenser container - object ingredient cocktail -
  beverage shot shaker - container)
 (:functions (total-cost) - number)
 (:action ugly37478ugly37479ugly37486ugly1ugly2ugly5ugly1leave :parameters
  (?h - hand ?c - container) :precondition (holding ?h ?c) :effect
  (and (not (holding ?h ?c)) (handempty ?h) (ontable ?c)
       (increase (total-cost) 1)))
 (:action ugly37479ugly37486ugly37478ugly2ugly5ugly1ugly2empty-shot :parameters
 ...
 (:action
  ugly37480ugly37489ugly37484ugly10ugly8ugly4ugly6pour-shot-to-clean-shaker
 ...
 (:action
  ugly37481ugly37482ugly37483ugly11ugly12ugly3ugly10pour-shot-to-used-shaker
  :parameters (?s - shot ?i - ingredient ?d - shaker ?h1 - hand ?l ?l1 - level)
  :precondition
  ...
  (and (not (contains ?s ?i)) (contains ?d ?i) (empty ?s)
       ...
       (increase (total-cost) 1)))
 (:action ugly37482ugly37483ugly37488ugly3ugly10ugly8ugly4clean-shot
 ...
 (:action ugly37483ugly37488ugly37480ugly12ugly3ugly10ugly8refill-shot
 ...
 (:action ugly37484ugly37487ugly37485ugly4ugly6ugly7ugly11pour-shaker-to-shot
 ...
 (:action ugly37485ugly37481ugly37482ugly6ugly7ugly11ugly12fill-shot
  :parameters (?s - shot ?i - ingredient ?h1 ?h2 - hand ?d - dispenser)
  :precondition
  (and (holding ?h1 ?s) (handempty ?h2) (dispenses ?d ?i) (empty ?s)
       (clean ?s))
 ...
 (:action ugly37486ugly37478ugly37479ugly9ugly9ugly9ugly9empty-shaker
