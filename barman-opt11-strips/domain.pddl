...
(define (domain barman) (:requirements :strips :typing :action-costs)
 (:predicates (shaked ?s - shaker) (dispenses ?d - dispenser ?i - ingredient)
  (unshaked ?s - shaker) (shaker-empty-level ?s - shaker ?l - level)
  (clean ?c - container) (empty ?c - container) (handempty ?h - hand)
  (used ?c - container ?b - beverage) (next ?l1 ?l2 - level)
  (shaker-level ?s - shaker ?l - level)
  (cocktail-part2 ?c - cocktail ?i - ingredient) (ontable ?c - container)
  (contains ?c - container ?b - beverage) (holding ?h - hand ?c - container)
  (cocktail-part1 ?c - cocktail ?i - ingredient))
 (:types hand level beverage dispenser container - object ingredient cocktail -
  beverage shot shaker - container)
 (:functions (total-cost) - number)
 (:action ugly1leave :parameters (?h - hand ?c - container) :precondition
  (holding ?h ?c) :effect
  (and (not (holding ?h ?c)) (handempty ?h) (ontable ?c)
       (increase (total-cost) 1)))
 (:action ugly2empty-shot :parameters (?h - hand ?p - shot ?b - beverage)
  :precondition (and (holding ?h ?p) (contains ?p ?b)) :effect
  (and (not (contains ?p ?b)) (empty ?p) (increase (total-cost) 1)))
 (:action ugly3clean-shaker :parameters (?h1 ?h2 - hand ?s - shaker)
  :precondition (and (holding ?h1 ?s) (handempty ?h2) (empty ?s)) :effect
  (and (clean ?s) (increase (total-cost) 1)))
 (:action ugly4clean-shot :parameters (?s - shot ?b - beverage ?h1 ?h2 - hand)
  :precondition (and (holding ?h1 ?s) (handempty ?h2) (empty ?s) (used ?s ?b))
  :effect (and (not (used ?s ?b)) (clean ?s) (increase (total-cost) 1)))
 (:action ugly5grasp :parameters (?h - hand ?c - container) :precondition
  (and (ontable ?c) (handempty ?h)) :effect
  (and (not (ontable ?c)) (not (handempty ?h)) (holding ?h ?c)
       (increase (total-cost) 1)))
 (:action ugly6pour-shot-to-clean-shaker :parameters
 ...
 (:action ugly8refill-shot :parameters
 ...
 (:action ugly9empty-shaker :parameters
 ...
 (:action ugly10pour-shot-to-used-shaker :parameters
  (?s - shot ?i - ingredient ?d - shaker ?h1 - hand ?l ?l1 - level)
  :precondition
  ...
  (and (not (contains ?s ?i)) (contains ?d ?i) (empty ?s)
       ...
       (increase (total-cost) 1)))
 (:action ugly11pour-shaker-to-shot :parameters
 ...
 (:action ugly12fill-shot :parameters
  (?s - shot ?i - ingredient ?h1 ?h2 - hand ?d - dispenser) :precondition
  (and (holding ?h1 ?s) (handempty ?h2) (dispenses ?d ?i) (empty ?s)
       (clean ?s))
  :effect
