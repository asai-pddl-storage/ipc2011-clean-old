...
(define (domain barman) (:requirements :strips :typing :action-costs)
 (:predicates (empty ?c - container) (unshaked ?s - shaker)
  (contains ?c - container ?b - beverage)
  (cocktail-part1 ?c - cocktail ?i - ingredient) (next ?l1 ?l2 - level)
  (cocktail-part2 ?c - cocktail ?i - ingredient) (shaked ?s - shaker)
  (ontable ?c - container) (holding ?h - hand ?c - container)
  (shaker-level ?s - shaker ?l - level)
  (dispenses ?d - dispenser ?i - ingredient) (clean ?c - container)
  (shaker-empty-level ?s - shaker ?l - level) (handempty ?h - hand)
  (used ?c - container ?b - beverage))
 (:types hand level beverage dispenser container - object ingredient cocktail -
  beverage shot shaker - container)
 (:functions (total-cost) - number)
 (:action ugly1ugly2ugly5ugly1leave :parameters (?h - hand ?c - container)
  :precondition (holding ?h ?c) :effect
  (and (not (holding ?h ?c)) (handempty ?h) (ontable ?c)
       (increase (total-cost) 1)))
 (:action ugly2ugly5ugly1ugly2empty-shot :parameters
 ...
 (:action ugly3ugly10ugly8ugly4clean-shot :parameters
 ...
 (:action ugly4ugly6ugly7ugly11pour-shaker-to-shot :parameters
 ...
 (:action ugly5ugly1ugly2ugly5grasp :parameters (?h - hand ?c - container)
  :precondition (and (ontable ?c) (handempty ?h)) :effect
  (and (not (ontable ?c)) (not (handempty ?h)) (holding ?h ?c)
       (increase (total-cost) 1)))
 (:action ugly6ugly7ugly11ugly12fill-shot :parameters
 ...
 (:action ugly9ugly9ugly9ugly9empty-shaker :parameters
 ...
 (:action ugly10ugly8ugly4ugly6pour-shot-to-clean-shaker :parameters
 ...
 (:action ugly11ugly12ugly3ugly10pour-shot-to-used-shaker :parameters
  (?s - shot ?i - ingredient ?d - shaker ?h1 - hand ?l ?l1 - level)
  :precondition
  ...
  (and (not (contains ?s ?i)) (contains ?d ?i) (empty ?s)
       ...
       (increase (total-cost) 1)))
 (:action ugly12ugly3ugly10ugly8refill-shot :parameters
  (?s - shot ?i - ingredient ?h1 ?h2 - hand ?d - dispenser) :precondition
  (and (holding ?h1 ?s) (handempty ?h2) (dispenses ?d ?i) (empty ?s)
       (used ?s ?i))
