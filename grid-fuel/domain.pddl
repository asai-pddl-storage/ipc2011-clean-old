...
(define (domain grid) (:requirements :strips :action-costs)
 (:predicates (locked ?x) (key ?k) (open ?x) (holding ?k) (key-shape ?k ?s)
  (shape ?s) (at-robot ?x) (lock-shape ?x ?s) (place ?p) (at ?r ?x) (arm-empty)
  (conn ?x ?y))
 (:functions (total-cost) - number)
 (:action
  ugly11073ugly11073ugly11073ugly11073ugly11073ugly1ugly5ugly4ugly2pickup
 ...
 (:action
  ugly11074ugly11076ugly11077ugly11075ugly11074ugly4ugly2ugly3ugly1putdown
  :parameters (?curpos ?key) :precondition
  (and (place ?curpos) (key ?key) (at-robot ?curpos) (holding ?key)) :effect
  (and (arm-empty) (at ?key ?curpos) (not (holding ?key))))
 (:action
  ugly11075ugly11074ugly11076ugly11077ugly11075ugly2ugly3ugly1ugly5pickup-and-loose
 ...
 (:action
  ugly11076ugly11077ugly11075ugly11074ugly11076ugly5ugly4ugly2ugly3unlock
 ...
 (:action ugly11077ugly11075ugly11074ugly11076ugly11077ugly3ugly1ugly5ugly4move
