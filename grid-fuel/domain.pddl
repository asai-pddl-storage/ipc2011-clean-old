...
(define (domain grid) (:requirements :strips :action-costs)
 (:predicates (open ?x) (place ?p) (conn ?x ?y) (holding ?k) (key ?k)
  (key-shape ?k ?s) (locked ?x) (at ?r ?x) (lock-shape ?x ?s) (arm-empty)
  (shape ?s) (at-robot ?x))
 (:functions (total-cost) - number)
 (:action ugly11073ugly11073ugly1ugly5ugly4ugly2pickup :parameters
 ...
 (:action ugly11074ugly11076ugly5ugly4ugly2ugly3unlock :parameters
 ...
 (:action ugly11075ugly11074ugly4ugly2ugly3ugly1putdown :parameters
  (?curpos ?key) :precondition
  (and (place ?curpos) (key ?key) (at-robot ?curpos) (holding ?key)) :effect
  (and (arm-empty) (at ?key ?curpos) (not (holding ?key))))
 (:action ugly11076ugly11077ugly3ugly1ugly5ugly4move :parameters
 ...
 (:action ugly11077ugly11075ugly2ugly3ugly1ugly5pickup-and-loose :parameters
