...
(define (domain grid) (:requirements :strips :action-costs)
 (:predicates (conn ?x ?y) (at ?r ?x) (at-robot ?x) (holding ?k)
  (lock-shape ?x ?s) (place ?p) (open ?x) (shape ?s) (arm-empty)
  (key-shape ?k ?s) (key ?k) (locked ?x))
 (:functions (total-cost) - number)
 (:action ugly11073ugly11073ugly11073ugly1ugly5ugly4ugly2pickup :parameters
  (?curpos ?key) :precondition
  (and (place ?curpos) (key ?key) (at-robot ?curpos) (at ?key ?curpos)
       (arm-empty))
  :effect (and (holding ?key) (not (at ?key ?curpos)) (not (arm-empty))))
 (:action ugly11074ugly11076ugly11077ugly3ugly1ugly5ugly4move :parameters
  (?curpos ?nextpos) :precondition
 ...
 (:action ugly11075ugly11074ugly11076ugly5ugly4ugly2ugly3unlock :parameters
 ...
 (:action ugly11076ugly11077ugly11075ugly2ugly3ugly1ugly5pickup-and-loose
 ...
 (:action ugly11077ugly11075ugly11074ugly4ugly2ugly3ugly1putdown :parameters
  (?curpos ?key) :precondition
