...
(define (domain gripper-strips) (:requirements :strips :action-costs)
 (:predicates (free ?g) (at ?b ?r) (gripper ?g) (room ?r) (at-robby ?r)
  (carry ?o ?g) (ball ?b))
 (:functions (total-cost) - number)
 (:action ugly21ugly21ugly21ugly1ugly3ugly2ugly1drop :parameters
  (?obj ?room ?gripper) :precondition
  (and (ball ?obj) (room ?room) (gripper ?gripper) (carry ?obj ?gripper)
       (at-robby ?room))
  :effect (and (at ?obj ?room) (free ?gripper) (not (carry ?obj ?gripper))))
 (:action ugly22ugly23ugly22ugly3ugly2ugly1ugly3pick :parameters
  (?obj ?room ?gripper) :precondition
 ...
 (:action ugly23ugly22ugly23ugly2ugly1ugly3ugly2move :parameters (?from ?to)
