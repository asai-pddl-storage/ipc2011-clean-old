...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 ...
 (:action ugly1ugly2ugly5ugly1push-end :parameters
 ...
 (:action ugly2ugly5ugly1ugly2push-unitarypipe :parameters
 ...
 (:action ugly3ugly6ugly4ugly3pop-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
   tank-slot)
 ...
 (:action ugly4ugly3ugly6ugly4pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
  ...
  (and (pop-updating ?pipe) (not (normal ?pipe)) (last ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly5ugly1ugly2ugly5push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
  ...
  (and (push-updating ?pipe) (not (normal ?pipe)) (first ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly6ugly4ugly3ugly6pop-end :parameters
