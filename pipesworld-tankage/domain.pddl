...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (first ?batch-atom - batch-atom ?pipe - pipe)
  ...
  (connect ?from ?to - area ?pipe - pipe) (push-updating ?pipe - pipe)
 ...
 (:action ugly2ugly5push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
 ...
 (:action ugly3ugly6pop-end :parameters
 ...
 (:action ugly4ugly3pop-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
   tank-slot)
 ...
 (:action ugly5ugly1push-end :parameters
 ...
 (:action ugly6ugly4pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
