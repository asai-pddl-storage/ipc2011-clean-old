...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (follow ?next ?previous - batch-atom) (not-unitary ?pipe - pipe)
  ...
  (connect ?from ?to - area ?pipe - pipe) (pop-updating ?pipe - pipe)
  (occupied ?tank-slot - tank-slot) (normal ?pipe - pipe)
  (unitary ?pipe - pipe) (first ?batch-atom - batch-atom ?pipe - pipe)
 ...
 (:action ugly1ugly2ugly5push-start :parameters
 ...
 (:action ugly2ugly5ugly1push-end :parameters
 ...
 (:action ugly3ugly6ugly4pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
  ...
  (and (pop-updating ?pipe) (not (normal ?pipe)) (last ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly4ugly3ugly6pop-end :parameters
 ...
 (:action ugly5ugly1ugly2push-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
 ...
 (:action ugly6ugly4ugly3pop-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
   tank-slot)
