...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (first ?batch-atom - batch-atom ?pipe - pipe)
  ...
  (occupied ?tank-slot - tank-slot) (pop-updating ?pipe - pipe)
  (unitary ?pipe - pipe) (push-updating ?pipe - pipe)
  (tank-slot-product-location ?tank-slot - tank-slot ?product - product ?area -
   area)
  (is-product ?batch-atom - batch-atom ?product - product)
  (not-unitary ?pipe - pipe) (not-occupied ?tank-slot - tank-slot)
 ...
 (:action ugly1435150ugly4ugly3ugly6ugly4pop-start :parameters
 ...
 (:action ugly1435151ugly3ugly6ugly4ugly3pop-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly1435152ugly1ugly2ugly5ugly1push-end :parameters
 ...
 (:action ugly1435153ugly5ugly1ugly2ugly5push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
  ...
  (and (push-updating ?pipe) (not (normal ?pipe)) (first ?batch-atom-in ?pipe)
       ...
       (not-occupied ?tank-slot)))
 (:action ugly1435154ugly2ugly5ugly1ugly2push-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product ?from-tank-slot - tank-slot ?to-tank-slot -
   tank-slot)
 ...
 (:action ugly1435155ugly6ugly4ugly3ugly6pop-end :parameters
