...
(define (domain parking) (:requirements :strips :typing :action-costs)
 (:predicates (at-curb-num ?car - car ?curb - curb)
  (behind-car ?car ?front-car - car) (curb-clear ?curb - curb)
  (at-curb ?car - car) (car-clear ?car - car))
 (:types car curb) (:functions (total-cost) - number)
 (:action ugly1ugly1move-curb-to-curb :parameters
 ...
 (:action ugly2ugly3move-car-to-car :parameters
  ...
  (and (not (car-clear ?cardest)) (car-clear ?carsrc)
       ...
       (increase (total-cost) 1)))
 (:action ugly3ugly4move-curb-to-car :parameters
 ...
 (:action ugly4ugly2move-car-to-curb :parameters
