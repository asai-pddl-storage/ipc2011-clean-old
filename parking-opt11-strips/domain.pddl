...
(define (domain parking) (:requirements :strips :typing :action-costs)
 ...
 (:action ugly2ugly3ugly4move-curb-to-car :parameters
 ...
 (:action ugly3ugly4ugly2move-car-to-curb :parameters
 ...
 (:action ugly4ugly2ugly3move-car-to-car :parameters
