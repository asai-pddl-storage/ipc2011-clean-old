...
(define (domain parking) (:requirements :strips :typing :action-costs)
 (:predicates (curb-clear ?curb - curb) (car-clear ?car - car)
  (at-curb ?car - car) (behind-car ?car ?front-car - car)
  (at-curb-num ?car - car ?curb - curb))
 (:types car curb) (:functions (total-cost) - number)
 (:action ugly1move-curb-to-curb :parameters
 ...
 (:action ugly2move-car-to-curb :parameters
 ...
 (:action ugly3move-car-to-car :parameters
  ...
  (and (not (car-clear ?cardest)) (car-clear ?carsrc)
       ...
       (increase (total-cost) 1)))
 (:action ugly4move-curb-to-car :parameters
