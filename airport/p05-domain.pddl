...
(define (domain airport_fixed_structure) (:requirements :typing)
 ...
 (:action
  ugly79ugly59ugly46pushback_seg_c5_c_a02_0_100_seg_c5_c6_0_50_south_north_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action
  ugly84ugly79ugly59pushback_seg_a02_0_100_seg_c5_c_a02_0_100_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-pushing ?a) (facing ?a south)
