...
(define (domain airport_fixed_structure) (:requirements :typing)
 ...
 (:action
  ugly94ugly306ugly898pushback_seg_p154_0_75_seg_w1_154b_0_45_south_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action
  ugly282ugly703ugly647pushback_seg_w1_154b_0_45_seg_w1_154c_0_34_south_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-pushing ?a) (facing ?a south)
 ...
 (:action ugly949ugly379ugly868startup_seg_n_a4a7a_0_115_south_medium
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_n_a4b_0_60 ?a)
       (not (not_blocked seg_n_a4b_0_60 ?a))))
 (:action
  ugly950ugly57ugly807pushback_seg_w1_154c_0_34_seg_w1_c3a_0_34_north_south_medium
  :parameters (?a - airplane) :precondition
