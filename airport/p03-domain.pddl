...
(define (domain airport_fixed_structure) (:requirements :typing)
 ...
 (:constants north south - direction light medium heavy - airplanetype
  ...
  airplane)
 (:action ugly1ugly37pushback_seg_ppdoor_0_40_seg_tww1_0_200_south_north_medium
 ...
 (:action ugly2ugly27startup_seg_tww3_0_50_south_medium :parameters
 ...
 (:action ugly3ugly36move_seg_rwe_0_50_seg_rw_0_400_south_south_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (occupied seg_rwe_0_50)) (not_occupied seg_rwe_0_50)
       ...
       (not (blocked seg_twe4_0_50 ?a)) (not_blocked seg_twe4_0_50 ?a)))
 (:action ugly4ugly21move_seg_tww1_0_200_seg_ppdoor_0_40_north_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly5ugly23park_seg_pp_0_60_north :parameters (?a - airplane)
  :precondition
  (and (at-segment ?a seg_pp_0_60) (facing ?a north) (is-moving ?a)) :effect
  (and (is-parked ?a seg_pp_0_60)))
 (:action ugly6ugly30move_seg_twe4_0_50_seg_rwe_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly7ugly32startup_seg_tww4_0_50_north_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly8ugly3startup_seg_twe4_0_50_north_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly9ugly1startup_seg_twe4_0_50_south_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe4_0_50)
 ...
 (:action ugly10ugly5startup_seg_pp_0_60_south_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly11ugly28move_seg_twe3_0_50_seg_twe4_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly12ugly38startup_seg_pp_0_60_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_pp_0_60)) :effect
  (and (not (is-pushing ?a)) (is-moving ?a)))
 (:action ugly13ugly2startup_seg_tww1_0_200_south_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly14ugly4park_seg_pp_0_60_south :parameters (?a - airplane)
  :precondition
 ...
 (:action ugly15ugly24move_seg_rw_0_400_seg_rww_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly16ugly29startup_seg_twe2_0_50_south_medium :parameters
  (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe1_0_200 ?a)
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action ugly17ugly11startup_seg_twe1_0_200_north_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly18ugly26move_seg_ppdoor_0_40_seg_pp_0_60_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly19ugly31move_seg_rww_0_50_seg_tww4_0_50_south_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly20ugly35takeoff_seg_rww_0_50_north :parameters (?a - airplane)
  :precondition
 ...
 (:action ugly21ugly14move_seg_twe1_0_200_seg_twe2_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
  ...
  (and (not (occupied seg_twe1_0_200)) (not_occupied seg_twe1_0_200)
       ...
       (not (blocked seg_ppdoor_0_40 ?a)) (not_blocked seg_ppdoor_0_40 ?a)
       (not (blocked seg_tww1_0_200 ?a)) (not_blocked seg_tww1_0_200 ?a)))
 (:action ugly22ugly13move_seg_ppdoor_0_40_seg_tww1_0_200_north_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
       (at-segment ?a seg_ppdoor_0_40) (not_occupied seg_tww1_0_200)
       (not_blocked seg_tww1_0_200 airplane_cfbeg)
  ...
  (and (not (occupied seg_ppdoor_0_40)) (not_occupied seg_ppdoor_0_40)
       ...
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action ugly23ugly20startup_seg_tww4_0_50_south_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww4_0_50)
 ...
 (:action ugly24ugly9move_seg_pp_0_60_seg_ppdoor_0_40_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
  ...
  (and (not (occupied seg_pp_0_60)) (not_occupied seg_pp_0_60)
       ...
       (not (not_occupied seg_ppdoor_0_40)) (blocked seg_ppdoor_0_40 ?a)
       (not (not_blocked seg_ppdoor_0_40 ?a)) (at-segment ?a seg_ppdoor_0_40)))
 (:action ugly25ugly19startup_seg_tww2_0_50_south_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly26ugly15startup_seg_ppdoor_0_40_north_medium :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly27ugly33startup_seg_twe2_0_50_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe2_0_50)
       (not_occupied seg_twe3_0_50))
  :effect
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe3_0_50 ?a)
       (not (not_blocked seg_twe3_0_50 ?a))))
 (:action ugly28ugly6startup_seg_tww2_0_50_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww2_0_50)
       (not_occupied seg_tww3_0_50))
  :effect
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww3_0_50 ?a)
       (not (not_blocked seg_tww3_0_50 ?a))))
 (:action ugly29ugly41pushback_seg_pp_0_60_seg_ppdoor_0_40_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-pushing ?a) (facing ?a south)
       (at-segment ?a seg_pp_0_60) (not_occupied seg_ppdoor_0_40)
       (not_blocked seg_ppdoor_0_40 airplane_cfbeg)
  ...
  (and (not (occupied seg_pp_0_60)) (not_occupied seg_pp_0_60)
       ...
       (not (not_occupied seg_ppdoor_0_40)) (blocked seg_ppdoor_0_40 ?a)
       (not (not_blocked seg_ppdoor_0_40 ?a)) (at-segment ?a seg_ppdoor_0_40)))
 (:action ugly30ugly7startup_seg_tww3_0_50_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww3_0_50)
 ...
 (:action ugly31ugly10move_seg_twe2_0_50_seg_twe3_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
  ...
  (and (not (occupied seg_twe2_0_50)) (not_occupied seg_twe2_0_50)
       ...
       (not (blocked seg_twe1_0_200 ?a)) (not_blocked seg_twe1_0_200 ?a)))
 (:action ugly32ugly34startup_seg_ppdoor_0_40_south_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_ppdoor_0_40)
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww1_0_200 ?a)
       ...
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action ugly33ugly40move_seg_tww3_0_50_seg_tww2_0_50_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly34ugly25takeoff_seg_rwe_0_50_south :parameters (?a - airplane)
  :precondition
 ...
 (:action ugly35ugly18startup_seg_tww1_0_200_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww1_0_200)
       (not_occupied seg_tww2_0_50))
  :effect
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww2_0_50 ?a)
       (not (not_blocked seg_tww2_0_50 ?a))))
 (:action ugly36ugly8move_seg_tww1_0_200_seg_twe1_0_200_north_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly37ugly17move_seg_tww4_0_50_seg_tww3_0_50_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly38ugly22move_seg_tww2_0_50_seg_tww1_0_200_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly39ugly39startup_seg_twe3_0_50_south_medium :parameters
  (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe2_0_50 ?a)
       (not (not_blocked seg_twe2_0_50 ?a))))
 (:action ugly40ugly12startup_seg_twe3_0_50_north_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe3_0_50)
 ...
 (:action ugly41ugly16startup_seg_twe1_0_200_south_medium :parameters
  (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe1_0_200)
