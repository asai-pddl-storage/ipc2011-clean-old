...
(define (domain airport_fixed_structure) (:requirements :typing)
 ...
 (:constants north south - direction light medium heavy - airplanetype
  ...
  airplane)
 (:action ugly81ugly27ugly33ugly40ugly12startup_seg_twe3_0_50_north_medium
 ...
 (:action ugly82ugly23ugly20ugly35ugly18startup_seg_tww1_0_200_north_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly83ugly31ugly10ugly5ugly23park_seg_pp_0_60_north :parameters
  (?a - airplane) :precondition
  (and (at-segment ?a seg_pp_0_60) (facing ?a north) (is-moving ?a)) :effect
  (and (is-parked ?a seg_pp_0_60)))
 (:action
  ugly84ugly37ugly17ugly11ugly28move_seg_twe3_0_50_seg_twe4_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly85ugly15ugly24ugly9ugly1startup_seg_twe4_0_50_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly86ugly35ugly18ugly26ugly15startup_seg_ppdoor_0_40_north_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action
  ugly87ugly12ugly38ugly22ugly13move_seg_ppdoor_0_40_seg_tww1_0_200_north_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly88ugly39ugly39ugly39ugly39startup_seg_twe3_0_50_south_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe3_0_50)
 ...
 (:action ugly89ugly32ugly34ugly25ugly19startup_seg_tww2_0_50_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action
  ugly90ugly25ugly19ugly31ugly10move_seg_twe2_0_50_seg_twe3_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action
  ugly91ugly21ugly14ugly4ugly21move_seg_tww1_0_200_seg_ppdoor_0_40_north_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action
  ugly92ugly34ugly25ugly19ugly31move_seg_rww_0_50_seg_tww4_0_50_south_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action
  ugly93ugly11ugly28ugly6ugly30move_seg_twe4_0_50_seg_rwe_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly94ugly33ugly40ugly12ugly38startup_seg_pp_0_60_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_pp_0_60)) :effect
  (and (not (is-pushing ?a)) (is-moving ?a)))
 (:action
  ugly95ugly40ugly12ugly38ugly22move_seg_tww2_0_50_seg_tww1_0_200_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action
  ugly96ugly18ugly26ugly15ugly24move_seg_rw_0_400_seg_rww_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly97ugly7ugly32ugly34ugly25takeoff_seg_rwe_0_50_south :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly98ugly17ugly11ugly28ugly6startup_seg_tww2_0_50_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww2_0_50)
 ...
 (:action ugly99ugly19ugly31ugly10ugly5startup_seg_pp_0_60_south_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action
  ugly100ugly24ugly9ugly1ugly37pushback_seg_ppdoor_0_40_seg_tww1_0_200_south_north_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (occupied seg_ppdoor_0_40)) (not_occupied seg_ppdoor_0_40)
       ...
       (not (not_blocked seg_tww1_0_200 ?a)) (at-segment ?a seg_tww1_0_200)
       (not (facing ?a south)) (facing ?a north)))
 (:action ugly101ugly22ugly13ugly2ugly27startup_seg_tww3_0_50_south_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww2_0_50 ?a)
       (not (not_blocked seg_tww2_0_50 ?a))))
 (:action ugly102ugly10ugly5ugly23ugly20startup_seg_tww4_0_50_south_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww3_0_50 ?a)
       (not (not_blocked seg_tww3_0_50 ?a))))
 (:action
  ugly103ugly8ugly3ugly36ugly8move_seg_tww1_0_200_seg_twe1_0_200_north_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action
  ugly104ugly26ugly15ugly24ugly9move_seg_pp_0_60_seg_ppdoor_0_40_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
  ...
  (and (not (occupied seg_pp_0_60)) (not_occupied seg_pp_0_60)
       ...
       (not (not_blocked seg_ppdoor_0_40 ?a)) (at-segment ?a seg_ppdoor_0_40)))
 (:action
  ugly105ugly41ugly16ugly29ugly41pushback_seg_pp_0_60_seg_ppdoor_0_40_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-pushing ?a) (facing ?a south)
       (at-segment ?a seg_pp_0_60) (not_occupied seg_ppdoor_0_40)
       (not_blocked seg_ppdoor_0_40 airplane_cfbeg)
  ...
  (and (not (occupied seg_pp_0_60)) (not_occupied seg_pp_0_60)
       ...
       (not (not_blocked seg_ppdoor_0_40 ?a)) (at-segment ?a seg_ppdoor_0_40)))
 (:action
  ugly106ugly36ugly8ugly3ugly36move_seg_rwe_0_50_seg_rw_0_400_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
  ...
  (and (not (occupied seg_rwe_0_50)) (not_occupied seg_rwe_0_50)
       ...
       (not (blocked seg_twe4_0_50 ?a)) (not_blocked seg_twe4_0_50 ?a)))
 (:action
  ugly107ugly14ugly4ugly21ugly14move_seg_twe1_0_200_seg_twe2_0_50_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
 ...
 (:action ugly108ugly29ugly41ugly16ugly29startup_seg_twe2_0_50_south_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe1_0_200 ?a)
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action ugly109ugly5ugly23ugly20ugly35takeoff_seg_rww_0_50_north :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly110ugly30ugly7ugly32ugly34startup_seg_ppdoor_0_40_south_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_ppdoor_0_40)
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_tww1_0_200 ?a)
       ...
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action ugly111ugly6ugly30ugly7ugly32startup_seg_tww4_0_50_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww4_0_50)
 ...
 (:action ugly112ugly13ugly2ugly27ugly33startup_seg_twe2_0_50_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe2_0_50)
       (not_occupied seg_twe3_0_50))
  :effect
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe3_0_50 ?a)
       (not (not_blocked seg_twe3_0_50 ?a))))
 (:action ugly113ugly3ugly36ugly8ugly3startup_seg_twe4_0_50_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe4_0_50)
 ...
 (:action ugly114ugly28ugly6ugly30ugly7startup_seg_tww3_0_50_north_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww3_0_50)
 ...
 (:action
  ugly115ugly20ugly35ugly18ugly26move_seg_ppdoor_0_40_seg_pp_0_60_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a south)
  ...
  (and (not (occupied seg_ppdoor_0_40)) (not_occupied seg_ppdoor_0_40)
       ...
       (not (blocked seg_twe1_0_200 ?a)) (not_blocked seg_twe1_0_200 ?a)))
 (:action
  ugly116ugly2ugly27ugly33ugly40move_seg_tww3_0_50_seg_tww2_0_50_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly117ugly4ugly21ugly14ugly4park_seg_pp_0_60_south :parameters
  (?a - airplane) :precondition
 ...
 (:action ugly118ugly1ugly37ugly17ugly11startup_seg_twe1_0_200_north_medium
  :parameters (?a - airplane) :precondition
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_twe2_0_50 ?a)
       (not (not_blocked seg_twe2_0_50 ?a))))
 (:action ugly119ugly38ugly22ugly13ugly2startup_seg_tww1_0_200_south_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_tww1_0_200)
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_ppdoor_0_40 ?a)
       ...
       (not (not_blocked seg_twe1_0_200 ?a))))
 (:action
  ugly120ugly9ugly1ugly37ugly17move_seg_tww4_0_50_seg_tww3_0_50_north_north_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-moving ?a) (facing ?a north)
 ...
 (:action ugly121ugly16ugly29ugly41ugly16startup_seg_twe1_0_200_south_medium
  :parameters (?a - airplane) :precondition
  (and (is-pushing ?a) (at-segment ?a seg_twe1_0_200)
