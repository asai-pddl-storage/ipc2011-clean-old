...
(define (domain storage-propositional) (:requirements :typing :action-costs)
 ...
 (:action
  ugly3496ugly3499ugly3496ugly3499ugly3496ugly3499ugly1ugly3ugly4ugly1move
 ...
 (:action
  ugly3497ugly3500ugly3498ugly3497ugly3500ugly3498ugly2ugly5ugly2ugly5drop
  ...
  (and (not (lifting ?h ?c)) (available ?h) (not (clear ?a1)) (on ?c ?a1)
       (in ?c ?p)))
 (:action
  ugly3498ugly3497ugly3500ugly3498ugly3497ugly3500ugly3ugly4ugly1ugly3go-out
 ...
 (:action
  ugly3499ugly3496ugly3499ugly3496ugly3499ugly3496ugly4ugly1ugly3ugly4lift
  :parameters (?h - hoist ?c - crate ?a1 - storearea ?a2 - area ?p - place)
  :precondition
 ...
 (:action
  ugly3500ugly3498ugly3497ugly3500ugly3498ugly3497ugly5ugly2ugly5ugly2go-in
