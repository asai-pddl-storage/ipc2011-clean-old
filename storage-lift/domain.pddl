...
(define (domain storage-propositional) (:requirements :typing :action-costs)
 (:predicates (available ?h - hoist) (connected ?a1 ?a2 - area)
  (on ?c - crate ?s - storearea) (in ?x - (either storearea crate) ?p - place)
  (compatible ?c1 ?c2 - crate) (clear ?s - storearea) (at ?h - hoist ?a - area)
  (lifting ?h - hoist ?c - crate))
 (:types hoist surface place area - object container depot - place storearea
  transitarea - area area crate - surface)
 (:functions (total-cost) - number)
 (:action ugly3496ugly3499ugly3496ugly4ugly1ugly3ugly4lift :parameters
 ...
 (:action ugly3497ugly3500ugly3498ugly2ugly5ugly2ugly5drop :parameters
  (?h - hoist ?c - crate ?a1 - storearea ?a2 - area ?p - place) :precondition
  (and (connected ?a1 ?a2) (at ?h ?a2) (lifting ?h ?c) (clear ?a1) (in ?a1 ?p))
  :effect
  (and (not (lifting ?h ?c)) (available ?h) (not (clear ?a1)) (on ?c ?a1)
       (in ?c ?p)))
 (:action ugly3498ugly3497ugly3500ugly3ugly4ugly1ugly3go-out :parameters
 ...
 (:action ugly3499ugly3496ugly3499ugly1ugly3ugly4ugly1move :parameters
 ...
 (:action ugly3500ugly3498ugly3497ugly5ugly2ugly5ugly2go-in :parameters
