...
(define (domain grounded-strips-psr) (:requirements :strips)
 (:predicates (closed-sd6) (closed-cb3) (closed-sd4) (not-closed-sd2)
  (not-updated-cb1) (do-wait_cb2-condeffs) (not-closed-sd3) (closed-cb1)
  (not-closed-cb3) (closed-sd9) (not-closed-sd4) (done-0) (closed-sd5)
  (updated-cb1) (not-updated-cb3) (not-closed-sd1) (not-closed-sd12)
  (do-close_sd5-condeffs) (do-normal) (not-closed-sd7) (not-closed-sd8)
  (closed-sd2) (not-closed-sd6) (not-closed-sd14) (closed-cb2) (updated-cb2)
  (not-closed-sd10) (closed-sd12) (not-closed-sd13) (closed-sd13) (closed-sd14)
  (not-closed-cb1) (not-updated-cb2) (not-closed-sd5) (do-close_sd6-condeffs)
  (closed-sd10) (closed-sd11) (not-closed-sd11) (closed-sd3) (not-closed-sd9)
  (closed-sd7) (closed-sd1) (updated-cb3) (closed-sd8) (not-closed-cb2))
 ...
 (:action ugly4close_sd5 :parameters () :precondition
 ...
 (:action ugly6close_sd5-condeff0-no-0 :parameters () :precondition
 ...
 (:action ugly9close_sd5-condeff0-no-1 :parameters () :precondition
  (and (do-close_sd5-condeffs) (not-closed-cb2)) :effect (and (done-0)))
 (:action ugly10close_sd6-condeff0-no-1 :parameters () :precondition
 ...
 (:action ugly13close_sd6-condeff0-yes :parameters () :precondition
 ...
 (:action ugly20wait_cb2-condeff0-yes :parameters () :precondition
  ...
  (and (done-0) (not-closed-cb2) (not (closed-cb2))))
 (:action ugly21close_sd6-endof-condeffs :parameters () :precondition
 ...
 (:action ugly22close_cb2 :parameters () :precondition
  ...
  (and (closed-cb2) (not-updated-cb2) (not (not-closed-cb2))
       (not (updated-cb2))))
 (:action ugly23close_sd2 :parameters () :precondition
 ...
 (:action ugly30close_sd12 :parameters () :precondition
 ...
 (:action ugly33close_sd3 :parameters () :precondition
 ...
 (:action ugly37close_sd5-endof-condeffs :parameters () :precondition
 ...
 (:action ugly41close_sd5-condeff0-yes :parameters () :precondition
 ...
 (:action ugly48close_cb3 :parameters () :precondition
  ...
  (and (closed-cb3) (not-updated-cb3) (not (not-closed-cb3))
       (not (updated-cb3))))
 (:action ugly49close_sd6-condeff0-no-0 :parameters () :precondition
