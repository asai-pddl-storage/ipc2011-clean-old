...
(define (domain grounded-strips-psr) (:requirements :strips)
 (:predicates (not-updated-cb2) (closed-sd1) (closed-sd6) (not-closed-sd4)
  (not-closed-sd3) (not-updated-cb1) (done-0) (do-close_sd2-condeffs)
  (closed-sd5) (done-1) (do-normal) (closed-cb2) (not-closed-sd2) (closed-sd4)
  (updated-cb1) (closed-sd3) (not-closed-cb2) (not-closed-cb1) (updated-cb2)
  (closed-sd2) (not-closed-sd5) (not-closed-sd6) (do-close_sd4-condeffs)
  (do-wait_cb1-condeffs) (do-close_sd1-condeffs) (closed-cb1) (not-closed-sd1))
 (:action ugly1ugly8close_sd4-condeff0-no-0 :parameters () :precondition
  (and (do-close_sd4-condeffs) (not-closed-sd1)) :effect (and (done-0)))
 (:action ugly2ugly10open-sd4 :parameters () :precondition
