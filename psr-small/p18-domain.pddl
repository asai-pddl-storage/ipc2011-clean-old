...
(define (domain grounded-strips-psr) (:requirements :strips)
 (:predicates (do-wait_cb2-condeffs) (closed-sd11) (not-closed-sd12)
  (closed-sd14) (closed-sd2) (closed-cb2) (not-closed-cb1) (not-updated-cb2)
  (not-closed-sd16) (closed-sd13) (not-closed-sd3) (do-close_sd10-condeffs)
  (not-closed-sd6) (closed-cb1) (not-closed-sd14) (not-closed-sd2) (closed-sd9)
  (done-0) (updated-cb1) (not-closed-sd15) (not-closed-cb2)
  (do-close_sd11-condeffs) (closed-sd7) (closed-sd3) (not-closed-sd4)
  (not-closed-sd9) (closed-sd1) (closed-sd12) (closed-sd5) (closed-sd15)
  (not-closed-sd13) (not-closed-sd1) (not-closed-sd8) (not-updated-cb1)
  (not-closed-sd11) (not-closed-sd5) (do-normal) (closed-sd10)
  (not-closed-sd10) (not-closed-sd7) (closed-sd4) (do-close_sd13-condeffs)
  (closed-sd6) (closed-sd8) (closed-sd16) (updated-cb2) (done-1))
 (:action ugly1ugly37ugly20close_sd10-condeff0-yes :parameters () :precondition
  (and (do-close_sd10-condeffs) (closed-cb2)) :effect
  (and (done-0) (not-closed-cb2) (not (closed-cb2))))
 (:action ugly2ugly38ugly22close_sd9 :parameters () :precondition
  (and (do-normal) (not-closed-sd9) (updated-cb1) (updated-cb2)) :effect
  (and (closed-sd9) (not (not-closed-sd9))))
 (:action ugly3ugly12ugly6open-sd12 :parameters () :precondition
  (and (do-normal) (closed-sd12) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd12) (not (closed-sd12))))
 (:action ugly4ugly29ugly48close_sd1 :parameters () :precondition
  (and (do-normal) (not-closed-sd1) (updated-cb1) (updated-cb2)) :effect
  (and (closed-sd1) (not (not-closed-sd1))))
 (:action ugly5ugly14ugly52open-sd8 :parameters () :precondition
  (and (do-normal) (closed-sd8) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd8) (not (closed-sd8))))
 (:action ugly6ugly32ugly39close_sd4 :parameters () :precondition
  (and (do-normal) (not-closed-sd4) (updated-cb1) (updated-cb2)) :effect
  (and (closed-sd4) (not (not-closed-sd4))))
 (:action ugly7ugly40ugly31open-sd1 :parameters () :precondition
  (and (do-normal) (closed-sd1) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd1) (not (closed-sd1))))
 (:action ugly8ugly15ugly18close_cb1 :parameters () :precondition
  (and (do-normal) (not-closed-cb1) (updated-cb1) (updated-cb2)) :effect
  (and (closed-cb1) (not-updated-cb1) (not (not-closed-cb1))
       (not (updated-cb1))))
 (:action ugly9ugly55ugly45close_sd13 :parameters () :precondition
  (and (do-normal) (not-closed-sd13) (updated-cb1) (updated-cb2)) :effect
  (and (not (do-normal)) (do-close_sd13-condeffs) (closed-sd13)
       (not (not-closed-sd13))))
 (:action ugly10ugly11ugly19open-sd11 :parameters () :precondition
  (and (do-normal) (closed-sd11) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd11) (not (closed-sd11))))
 (:action ugly11ugly19ugly33wait_cb2-condeff0-yes :parameters () :precondition
  (and (do-wait_cb2-condeffs) (closed-sd10)) :effect
  (and (done-0) (not-closed-cb2) (not (closed-cb2))))
 (:action ugly12ugly6ugly32open-sd5 :parameters () :precondition
  (and (do-normal) (closed-sd5) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd5) (not (closed-sd5))))
 (:action ugly13ugly53ugly50close_cb2 :parameters () :precondition
  (and (do-normal) (not-closed-cb2) (updated-cb1) (updated-cb2)) :effect
  (and (closed-cb2) (not-updated-cb2) (not (not-closed-cb2))
       (not (updated-cb2))))
 (:action ugly14ugly52ugly36close_sd3 :parameters () :precondition
