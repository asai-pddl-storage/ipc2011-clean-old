...
(define (domain grounded-strips-psr) (:requirements :strips)
 (:predicates (closed-sd3) (not-closed-sd4) (not-closed-sd9)
  (do-close_sd8-condeffs) (closed-sd7) (done-0) (closed-cb1) (not-closed-sd10)
  (not-closed-sd2) (not-closed-sd8) (not-closed-sd3) (not-closed-sd1)
  (updated-cb2) (closed-sd4) (not-closed-cb1) (not-closed-sd6) (closed-sd1)
  (not-closed-cb2) (do-wait_cb2-condeffs) (closed-sd2) (closed-sd9)
  (closed-sd11) (do-normal) (not-closed-sd7) (closed-sd5) (closed-cb2)
  (do-close_sd7-condeffs) (not-closed-sd5) (not-closed-sd11) (updated-cb1)
  (not-updated-cb1) (closed-sd10) (closed-sd8) (not-updated-cb2) (closed-sd6))
 (:action ugly1ugly12open-cb2 :parameters () :precondition
  (and (do-normal) (closed-cb2) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-cb2) (not (closed-cb2))))
 (:action ugly2ugly20close_sd11 :parameters () :precondition
  (and (do-normal) (not-closed-sd11) (updated-cb1) (updated-cb2)) :effect
  (and (closed-sd11) (not (not-closed-sd11))))
 (:action ugly3ugly28wait_cb2-endof-condeffs :parameters () :precondition
  (and (do-wait_cb2-condeffs) (done-0)) :effect
  (and (do-normal) (not (do-wait_cb2-condeffs)) (not (done-0))))
 (:action ugly4ugly6close_sd3 :parameters () :precondition
  (and (do-normal) (not-closed-sd3) (updated-cb1) (updated-cb2)) :effect
  (and (closed-sd3) (not (not-closed-sd3))))
 (:action ugly5ugly7open-cb1 :parameters () :precondition
  (and (do-normal) (closed-cb1) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-cb1) (not (closed-cb1))))
 (:action ugly6ugly15open-sd8 :parameters () :precondition
  (and (do-normal) (closed-sd8) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd8) (not (closed-sd8))))
 (:action ugly7ugly32close_sd7-condeff0-yes :parameters () :precondition
  (and (do-close_sd7-condeffs) (closed-sd8) (closed-cb2)) :effect
  (and (done-0) (not-closed-cb2) (not (closed-cb2))))
 (:action ugly8ugly17open-sd6 :parameters () :precondition
  (and (do-normal) (closed-sd6) (updated-cb1) (updated-cb2)) :effect
  (and (not-closed-sd6) (not (closed-sd6))))
 (:action ugly9ugly35close_sd7 :parameters () :precondition
