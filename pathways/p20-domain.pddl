...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal21) (goal25) (num-subs ?l - level) (available ?x - molecule)
  (goal23) (goal9) (goal2) (goal5) (synthesis-reaction ?x1 ?x2 - molecule)
  (goal18) (goal10) (goal8) (goal6) (possible ?x - molecule) (goal26)
  (next ?l1 ?l2 - level) (goal27) (goal1)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal19)
  (goal22) (chosen ?s - simple) (goal7) (goal24) (goal14) (goal4) (goal16)
  (goal12) (goal15) (goal11) (goal13) (goal3) (goal20)
 ...
 (:action ugly3dummy-action-18 :parameters () :precondition
  (or (available p27p1-cdk2p1-cyce) (available cdk2p1p2-cyca-e2f13p1)) :effect
  (and (goal18)))
 (:action ugly4choose :parameters (?x - simple ?l1 ?l2 - level) :precondition
 ...
 (:action ugly17associate-with-catalyze :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (catalyzed-association-reaction ?x1 ?x2 ?x3) (available ?x1)
       (available ?x2))
  :effect (and (not (available ?x1)) (available ?x3)))
 (:action ugly18dummy-action-16 :parameters () :precondition
  (or (available cdk1p2p3-cks1) (available skp2-skp1p1)) :effect
  (and (goal16)))
 (:action ugly19initialize :parameters (?x - simple) :precondition
 ...
 (:action ugly30dummy-action-3 :parameters () :precondition
  ...
  (and (goal3)))
 (:action ugly31dummy-action-2 :parameters () :precondition
  (or (available skp2p1-skp1) (available p21-cdk2p1p2-cyca)) :effect
  (and (goal2)))
 (:action ugly32dummy-action-13 :parameters () :precondition
