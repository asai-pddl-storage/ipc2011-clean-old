...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal21) (goal25) (num-subs ?l - level) (goal29) (goal32) (goal2)
  ...
  (goal17) (goal27) (possible ?x - molecule) (goal5) (goal22)
  (next ?l1 ?l2 - level) (goal30) (goal18) (chosen ?s - simple) (goal34)
  (goal24) (goal3) (goal9)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal11) (goal12)
  (goal28) (goal26) (synthesis-reaction ?x1 ?x2 - molecule) (goal7) (goal14)
  (goal13) (goal16) (goal20) (goal4) (goal1) (goal19) (goal6) (goal8) (goal23)
  (goal33) (available ?x - molecule) (goal15) (goal10))
 ...
 (:action ugly11dummy-action-20 :parameters () :precondition
  ...
  (and (goal20)))
 (:action ugly12associate-with-catalyze :parameters
 ...
 (:action ugly19dummy-action-26 :parameters () :precondition
  ...
  (and (goal26)))
 (:action ugly20initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly21synthesize :parameters (?x1 ?x2 - molecule) :precondition
 ...
 (:action ugly29dummy-action-22 :parameters () :precondition
  ...
  (and (goal22)))
 (:action ugly30dummy-action-6 :parameters () :precondition
  (or (available p57-cdk46-cycdp1) (available raf1-cdc25ap1)) :effect
  (and (goal6)))
 (:action ugly31dummy-action-21 :parameters () :precondition
 ...
 (:action ugly32dummy-action-27 :parameters () :precondition
  ...
  (and (goal27)))
 (:action ugly33dummy-action-19 :parameters () :precondition
 ...
 (:action ugly36dummy-action-23 :parameters () :precondition
  ...
  (and (goal23)))
 (:action ugly37choose :parameters (?x - simple ?l1 ?l2 - level) :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly38dummy-action-9 :parameters () :precondition
  (or (available p27p1-cdk2p1-cycep1) (available cdk46p2)) :effect
  (and (goal9)))
 (:action ugly39dummy-action-13 :parameters () :precondition
