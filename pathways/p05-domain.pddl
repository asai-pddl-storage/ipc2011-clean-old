...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal5) (num-subs ?l - level) (goal4) (goal1)
  (chosen ?s - simple) (possible ?x - molecule)
  (synthesis-reaction ?x1 ?x2 - molecule) (next ?l1 ?l2 - level) (goal3)
  (goal2) (goal6)
 ...
 (:action ugly1dummy-action-6 :parameters () :precondition
 ...
 (:action ugly4dummy-action-2 :parameters () :precondition
  (or (available sp1-p107) (available p21-cdk2p1-cycep1)) :effect
  (and (goal2)))
 (:action ugly5initialize :parameters (?x - simple) :precondition
 ...
 (:action ugly8dummy-action-4 :parameters () :precondition
  ...
  (and (goal4)))
 (:action ugly9dummy-action-1 :parameters () :precondition
 ...
 (:action ugly11dummy-action-5 :parameters () :precondition
