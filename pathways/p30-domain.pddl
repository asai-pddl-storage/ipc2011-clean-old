...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal9)
  ...
  (possible ?x - molecule) (goal18) (goal25) (goal30) (goal17) (goal34)
  (available ?x - molecule) (goal32) (goal39) (goal15) (goal12) (goal19)
  (goal3) (synthesis-reaction ?x1 ?x2 - molecule) (goal6) (goal26) (goal31)
  (goal10) (goal16) (goal8) (chosen ?s - simple) (goal5) (goal2) (goal33)
  (goal37) (goal23) (goal29) (num-subs ?l - level) (goal11) (goal21) (goal13)
  (goal35) (goal36) (goal27) (goal38) (goal1) (goal14) (next ?l1 ?l2 - level)
  (goal7) (goal22) (goal24) (goal20) (goal40))
 ...
 (:action ugly1ugly37dummy-action-12 :parameters () :precondition
 ...
 (:action ugly4ugly29dummy-action-31 :parameters () :precondition
  ...
  (and (goal31)))
 (:action ugly5ugly14dummy-action-1 :parameters () :precondition
 ...
 (:action ugly6ugly32dummy-action-30 :parameters () :precondition
  ...
  (and (goal30)))
 (:action ugly7ugly40dummy-action-21 :parameters () :precondition
  (or (available p130-e2f4-dp12-ge2) (available p27p1-cdk2-cycep1)) :effect
  (and (goal21)))
 (:action ugly8ugly15dummy-action-19 :parameters () :precondition
 ...
 (:action ugly9ugly10dummy-action-13 :parameters () :precondition
  ...
  (and (goal13)))
 (:action ugly10ugly18dummy-action-38 :parameters () :precondition
 ...
 (:action ugly12ugly8dummy-action-10 :parameters () :precondition
  ...
  (and (goal10)))
 (:action ugly13ugly25dummy-action-36 :parameters () :precondition
  (or (available p27p1-cdk2p1p2-cycep1) (available p27p1-cdk46p1p2-cycdp1))
  :effect (and (goal36)))
 (:action ugly14ugly6dummy-action-27 :parameters () :precondition
  (or (available cdk2p2-cyce) (available raf1-prbp1-e2f4-dp12-ge2)) :effect
  (and (goal27)))
 (:action ugly15ugly24synthesize :parameters (?x1 ?x2 - molecule) :precondition
  (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly16ugly30dummy-action-18 :parameters () :precondition
  (or (available cdk2p2-cyca-e2f13p1) (available p27p1-cdk2p1p2-cyce)) :effect
  (and (goal18)))
 (:action ugly17ugly13dummy-action-20 :parameters () :precondition
  (or (available cdk2-cyca-e2f13p1) (available p53-dp12p1)) :effect
  (and (goal20)))
 (:action ugly18ugly43dummy-action-40 :parameters () :precondition
  (or (available p27p1-cdk46-cycd) (available p21-cdk46-cycdp1)) :effect
  (and (goal40)))
 (:action ugly19ugly16dummy-action-25 :parameters () :precondition
  (or (available p27p1-cdk2p1-cyca) (available pcna-p21-cdk2p2-cyca)) :effect
  (and (goal25)))
 (:action ugly20ugly19dummy-action-11 :parameters () :precondition
  (or (available cdk2p2-cyca-e2f13) (available p21-cdk46p2-cycd)) :effect
  (and (goal11)))
 (:action ugly21ugly7dummy-action-35 :parameters () :precondition
  (or (available sp1-e2f13p1) (available p27-cdk46p2-cycd)) :effect
  (and (goal35)))
 (:action ugly22ugly44dummy-action-22 :parameters () :precondition
  (or (available pcna-p21-cdk46-cycdp1) (available p57-cdk46-cycdp1)) :effect
  (and (goal22)))
 (:action ugly23ugly20dummy-action-14 :parameters () :precondition
  (or (available raf1-cdc25a) (available ercc1)) :effect (and (goal14)))
 (:action ugly24ugly5dummy-action-9 :parameters () :precondition
  (or (available p57-cdk2p2-cyce) (available e2f13p1)) :effect (and (goal9)))
 (:action ugly25ugly41dummy-action-29 :parameters () :precondition
  (or (available pcna-p21-cdk2-cycep1) (available p130-e2f5-dp12-ge2)) :effect
  (and (goal29)))
 (:action ugly26ugly9dummy-action-5 :parameters () :precondition
 ...
 (:action ugly28ugly21dummy-action-2 :parameters () :precondition
  (or (available p27p1-cdk2-cyca) (available p57p1-cdk46p2-cycd)) :effect
  (and (goal2)))
 (:action ugly29ugly36dummy-action-17 :parameters () :precondition
  (or (available hdac1-p107-e2f4-dp12-ge2) (available p27p1-cdk2p1-cycep1))
  :effect (and (goal17)))
 (:action ugly30ugly23dummy-action-15 :parameters () :precondition
 ...
 (:action ugly32ugly35dummy-action-6 :parameters () :precondition
  (or (available pcna-p21-cdk46p2-cycd) (available p27p1-cdk2p2-cycep1))
  :effect (and (goal6)))
 (:action ugly33ugly33dummy-action-28 :parameters () :precondition
  (or (available p21-cdk46p2-cycdp1) (available p27p1-cdk2p1-cyce)) :effect
  (and (goal28)))
 (:action ugly34ugly28dummy-action-16 :parameters () :precondition
  (or (available cebp-prbp1-gp) (available p21-cdk46-cycd)) :effect
  (and (goal16)))
 (:action ugly35ugly11dummy-action-26 :parameters () :precondition
  (or (available p27-cdk46-cycdp1) (available pcna-p21-cdk2-cyce)) :effect
  (and (goal26)))
 (:action ugly36ugly22dummy-action-39 :parameters () :precondition
  (or (available pcna-p21-cdk46-cycd) (available p27p1-cdk46p2-cycdp1)) :effect
  (and (goal39)))
 (:action ugly37ugly17dummy-action-8 :parameters () :precondition
 ...
 (:action ugly39ugly39dummy-action-34 :parameters () :precondition
  ...
  (and (goal34)))
 (:action ugly40ugly26dummy-action-4 :parameters () :precondition
 ...
 (:action ugly42ugly42dummy-action-37 :parameters () :precondition
  ...
  (and (goal37)))
 (:action ugly43ugly45associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
  (and (association-reaction ?x1 ?x2 ?x3) (available ?x1) (available ?x2))
  :effect (and (not (available ?x1)) (not (available ?x2)) (available ?x3)))
 (:action ugly44ugly27choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly45ugly3dummy-action-7 :parameters () :precondition
