...
(define (domain pathways-propositional) (:requirements :typing :adl)
 ...
 (:action ugly9dummy-action-1 :parameters () :precondition
  ...
  (and (goal1)))
 (:action ugly10dummy-action-5 :parameters () :precondition
 ...
 (:action ugly12dummy-action-2 :parameters () :precondition
  ...
  (and (goal2)))
 (:action ugly13associate-with-catalyze :parameters
 ...
 (:action ugly14dummy-action-15 :parameters () :precondition
  ...
  (and (goal15)))
 (:action ugly15associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
 ...
 (:action ugly17dummy-action-4 :parameters () :precondition
  ...
  (and (goal4)))
 (:action ugly18dummy-action-8 :parameters () :precondition
  (or (available skp2-cdk2-cyca) (available p57-cdk46p1-cycd)) :effect
  (and (goal8)))
 (:action ugly19dummy-action-10 :parameters () :precondition
  (or (available pcna-p21-cdk2-cyca) (available p19arf)) :effect
  (and (goal10)))
 (:action ugly20dummy-action-7 :parameters () :precondition
