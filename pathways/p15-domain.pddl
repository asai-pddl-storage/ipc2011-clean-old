...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal11) (available ?x - molecule) (goal4) (num-subs ?l - level)
  (goal9) (goal12) (goal18) (goal14) (goal5) (goal19) (goal17) (goal8)
  (next ?l1 ?l2 - level) (goal6)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex)
  (chosen ?s - simple) (synthesis-reaction ?x1 ?x2 - molecule)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex)
  (possible ?x - molecule) (goal7) (goal1) (goal2) (goal13) (goal16) (goal15)
  (goal3) (goal10))
 ...
 (:action ugly1ugly15associate-with-catalyze :parameters
 ...
 (:action ugly3ugly12dummy-action-13 :parameters () :precondition
  (or (available raf1-prb-e2f4-dp12-ge2) (available dmp1-cycdp1)) :effect
  (and (goal13)))
 (:action ugly4ugly17dummy-action-16 :parameters () :precondition
  (or (available raf1-prbp1-e2f13p1-dp12p1-ge2) (available p21-cdk2-cycep1))
  :effect (and (goal16)))
 (:action ugly5ugly16associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
  (and (association-reaction ?x1 ?x2 ?x3) (available ?x1) (available ?x2))
  :effect (and (not (available ?x1)) (not (available ?x2)) (available ?x3)))
 (:action ugly6ugly14dummy-action-15 :parameters () :precondition
 ...
 (:action ugly7ugly19synthesize :parameters (?x1 ?x2 - molecule) :precondition
  ...
  (and (available ?x2)))
 (:action ugly8ugly23dummy-action-1 :parameters () :precondition
 ...
 (:action ugly11ugly8dummy-action-18 :parameters () :precondition
  ...
  (and (goal18)))
 (:action ugly12ugly18dummy-action-5 :parameters () :precondition
  (or (available p57p1-cdk46-cycdp1) (available p21-cdk46-cycdp1)) :effect
  (and (goal5)))
 (:action ugly13ugly24dummy-action-8 :parameters () :precondition
  (or (available raf1-prb-e2f13p1-dp12p1-ge2) (available cycep1)) :effect
  (and (goal8)))
 (:action ugly14ugly20dummy-action-2 :parameters () :precondition
  (or (available raf1-p130-e2f4p1-dp12-ge2) (available cdk46-cycd)) :effect
  (and (goal2)))
 (:action ugly15ugly4dummy-action-12 :parameters () :precondition
  (or (available p21-cdk2p1-cyca) (available pcna-p21-cdk2p1-cyca)) :effect
  (and (goal12)))
 (:action ugly16ugly3dummy-action-7 :parameters () :precondition
  (or (available raf1-cdc25a) (available cdk2p1-cyca-e2f13)) :effect
  (and (goal7)))
 (:action ugly17ugly21dummy-action-6 :parameters () :precondition
  (or (available cdc25ap1) (available raf1-cdc25ap1)) :effect (and (goal6)))
 (:action ugly18ugly10choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
 ...
 (:action ugly19ugly5dummy-action-11 :parameters () :precondition
  ...
  (and (goal11)))
 (:action ugly20ugly7dummy-action-14 :parameters () :precondition
  (or (available skp2-cdk2-cyca) (available skp2-skp1-cdk2p1-cyca)) :effect
  (and (goal14)))
 (:action ugly21ugly11dummy-action-3 :parameters () :precondition
  (or (available pcna-p21-cdk46-cycdp1) (available cdk46)) :effect
  (and (goal3)))
 (:action ugly22ugly22dummy-action-17 :parameters () :precondition
  (or (available pcna-p21-cdk46p1-cycd) (available pcna-p21-cdk46p1-cycdp1))
  :effect (and (goal17)))
 (:action ugly23ugly6dummy-action-9 :parameters () :precondition
  (or (available p57p1-cdk46-cycd) (available cdc25a)) :effect (and (goal9)))
 (:action ugly24ugly13dummy-action-19 :parameters () :precondition
