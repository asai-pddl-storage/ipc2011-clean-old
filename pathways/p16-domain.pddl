...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal19) (chosen ?s - simple) (goal18) (goal9)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex)
  (possible ?x - molecule)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal20)
  (num-subs ?l - level) (goal15) (goal4) (goal12) (goal10) (goal3) (goal7)
  (next ?l1 ?l2 - level) (goal13) (goal8) (goal14) (goal1) (goal5) (goal6)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal2) (goal17)
  (available ?x - molecule) (goal11) (goal16))
