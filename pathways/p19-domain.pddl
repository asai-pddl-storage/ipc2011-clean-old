...
(define (domain pathways-propositional) (:requirements :typing :adl)
 (:predicates (goal21) (goal25) (num-subs ?l - level) (available ?x - molecule)
  ...
  (next ?l1 ?l2 - level) (goal22) (goal24) (goal4)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal7)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal1)
  (goal13) (goal17) (goal15) (goal11) (goal14) (goal3) (goal12)
  (chosen ?s - simple) (goal19) (goal20) (goal16))
 ...
 (:action ugly15dummy-action-5 :parameters () :precondition
  ...
  (and (goal5)))
 (:action ugly16dummy-action-9 :parameters () :precondition
  (or (available cdk2p1-cyca-e2f13p1) (available p27-cdk46-cycd)) :effect
  (and (goal9)))
 (:action ugly17initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly18dummy-action-14 :parameters () :precondition
 ...
 (:action ugly27dummy-action-6 :parameters () :precondition
  ...
  (and (goal6)))
 (:action ugly28dummy-action-25 :parameters () :precondition
  (or (available cdk2-cyca-e2f13p1) (available cdk2-cyce)) :effect
  (and (goal25)))
 (:action ugly29dummy-action-2 :parameters () :precondition
  (or (available hdac1-p130-e2f5-dp12p1) (available cdk2-cyca)) :effect
  (and (goal2)))
 (:action ugly30dummy-action-26 :parameters () :precondition
  (or (available cdk46-cycd) (available skp2p1)) :effect (and (goal26)))
 (:action ugly31dummy-action-12 :parameters () :precondition
