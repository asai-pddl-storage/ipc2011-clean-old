...
(define (domain sokoban-sequential) (:requirements :typing :action-costs)
 ...
 (:action ugly1450389ugly2ugly1ugly3ugly2move :parameters
 ...
 (:action ugly1450390ugly1ugly3ugly2ugly1push-to-goal :parameters
 ...
 (:action ugly1450391ugly3ugly2ugly1ugly3push-to-nongoal :parameters
  (?p - player ?s - stone ?ppos ?from ?to - location ?dir - direction)
  :precondition
  (and (at ?p ?ppos) (at ?s ?from) (clear ?to) (move-dir ?ppos ?from ?dir)
