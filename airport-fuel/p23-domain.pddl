...
(define (domain airport_fixed_structure) (:requirements :typing :action-costs)
 ...
 (:action
  ugly118ugly282ugly703ugly647pushback_seg_w1_154b_0_45_seg_w1_154c_0_34_south_north_medium
  :parameters (?a - airplane) :precondition
 ...
 (:action ugly408ugly320ugly785ugly567startup_seg_n_a7a6d_0_75_south_medium
  ...
  (and (not (is-pushing ?a)) (is-moving ?a) (blocked seg_n_a7a6c_0_75 ?a)
       (not (not_blocked seg_n_a7a6c_0_75 ?a))))
 (:action
  ugly409ugly94ugly306ugly898pushback_seg_p154_0_75_seg_w1_154b_0_45_south_south_medium
  :parameters (?a - airplane) :precondition
  (and (has-type ?a medium) (is-pushing ?a) (facing ?a south)
 ...
 (:action
  ...
  (and (increase (total-cost) 1) (not (occupied seg_w1_141c_0_34))
       ...
       (not (not_blocked seg_w1_141b_0_45 ?a))))
 (:action
  ugly715ugly950ugly57ugly807pushback_seg_w1_154c_0_34_seg_w1_c3a_0_34_north_south_medium
  :parameters (?a - airplane) :precondition
