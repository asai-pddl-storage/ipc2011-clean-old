...
(define (domain tidybot) (:requirements :strips :typing :equality)
 (:predicates (object-done ?o - object)
  (object-goal ?o - object ?x - xc ?y - yc) (holding ?r - robot ?o - object)
  (object-pos ?o - object ?x - xc ?y - yc) (zerox-rel ?x - xrel)
  (parked ?r - robot) (gripper-rel ?r - robot ?x - xrel ?y - yrel)
  (sum-y ?y - yc ?yr - yrel ?ysum - yc) (sum-x ?x - xc ?xr - xrel ?xsum - xc)
  (leftof-rel ?x1 - xrel ?x2 - xrel) (base-pos ?r - robot ?x - xc ?y - yc)
  (not-pushed ?c - cart) (gripper-empty ?r - robot)
  (on-cart ?o - object ?c - cart) (above-rel ?y1 - yrel ?y2 - yrel)
  (zeroy-rel ?y - yrel) (pushing ?r - robot ?c - cart)
  (above ?y1 - yc ?y2 - yc) (base-obstacle ?x - xc ?y - yc)
  (surface ?x - xc ?y - yc) (gripper-obstacle ?x - xc ?y - yc)
  (not-pushing ?r - robot) (leftof ?x1 - xc ?x2 - xc)
  (cart-pos ?c - cart ?x - xc ?y - yc))
 (:types robot cart object xc yc xrel yrel)
 (:action ugly1ugly29ugly10grasp-cart-below :parameters
 ...
 (:action ugly2ugly15ugly12put-up :parameters
 ...
 (:action ugly3ugly20ugly22put-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
 ...
 (:action ugly6ugly13ugly6gripper-up :parameters
 ...
 (:action ugly7ugly16ugly1put-on-cart :parameters
  (?r - robot ?x - xc ?y - yc ?gxrel - xrel ?gyrel - yrel ?o - object ?c - cart
   ?cx - xc ?cy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?x ?y) (gripper-rel ?r ?gxrel ?gyrel)
 ...
 (:action ugly8ugly21ugly17gripper-left :parameters
 ...
 (:action ugly9ugly3ugly20get-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
 ...
 (:action ugly10ugly18ugly7grasp-cart-right :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cx - xc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?cx ?y) (leftof ?x ?cx) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly11ugly23ugly9base-left :parameters
 ...
 (:action ugly12ugly27ugly2grasp-cart-left :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cx - xc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?cx ?y) (leftof ?cx ?x) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly13ugly6ugly13base-down :parameters
 ...
 (:action ugly14ugly5ugly19put-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?ox ?gyabs)
       (gripper-obstacle ?ox ?gyabs) (gripper-empty ?r)))
 (:action ugly15ugly12ugly27park :parameters (?r - robot) :precondition
  (and (not (parked ?r)) (not-pushing ?r)) :effect (parked ?r))
 (:action ugly16ugly1ugly29base-cart-down :parameters
 ...
 (:action ugly17ugly11ugly23base-cart-up :parameters
  (?r - robot ?c - cart ?x - xc ?y1 - yc ?y2 - yc ?cx - xc ?cy1 - yc ?cy2 - yc)
  :precondition
  ...
  (and (not (base-pos ?r ?x ?y1)) (base-pos ?r ?x ?y2)
       ...
       (not (base-obstacle ?x ?y1)) (base-obstacle ?x ?y2)
       (not (base-obstacle ?cx ?cy2)) (base-obstacle ?cx ?cy2)))
 (:action ugly18ugly7ugly16unpark :parameters (?r - robot ?x - xrel ?y - yrel)
  :precondition
  (and (parked ?r) (gripper-rel ?r ?x ?y) (zerox-rel ?x) (zeroy-rel ?y))
  :effect (not (parked ?r)))
 (:action ugly19ugly25ugly24base-cart-right :parameters
 ...
 (:action ugly20ugly22ugly26put-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?gxabs ?oy)
       (gripper-obstacle ?gxabs ?oy) (gripper-empty ?r)))
 (:action ugly21ugly17ugly11get-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?gxabs ?oy)) (not (gripper-obstacle ?gxabs ?oy))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly22ugly26ugly28gripper-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?cgyrel - yrel
   ?dgyrel - yrel ?cgyabs - yc ?dgyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?cgyrel)
  ...
  (and (not (gripper-rel ?r ?gxrel ?cgyrel)) (gripper-rel ?r ?gxrel ?dgyrel)
       (not (gripper-obstacle ?gxabs ?cgyabs))
       (gripper-obstacle ?gxabs ?dgyabs)))
 (:action ugly23ugly9ugly3get-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?ox ?gyabs)) (not (gripper-obstacle ?ox ?gyabs))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly24ugly8ugly21grasp-cart-above :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cy - yc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?x ?cy) (above ?cy ?y) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly25ugly24ugly8get-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?ox ?gyabs)) (not (gripper-obstacle ?ox ?gyabs))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly26ugly28ugly14base-up :parameters
  (?r - robot ?x - xc ?cy - yc ?dy - yc) :precondition
  ...
  (and (not (base-pos ?r ?x ?cy)) (base-pos ?r ?x ?dy)
       (not (base-obstacle ?x ?cy)) (base-obstacle ?x ?dy)))
 (:action ugly27ugly2ugly15gripper-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?cgxrel - xrel ?dgxrel - xrel ?cgxabs -
   xc ?dgxabs - xc ?gyrel - yrel ?gyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?cgxrel ?gyrel)
  ...
  (and (not (gripper-rel ?r ?cgxrel ?gyrel)) (gripper-rel ?r ?dgxrel ?gyrel)
       (not (gripper-obstacle ?cgxabs ?gyabs))
       (gripper-obstacle ?dgxabs ?gyabs)))
 (:action ugly28ugly14ugly5ungrasp-cart :parameters (?r - robot ?c - cart)
  :precondition (and (pushing ?r ?c)) :effect
  (and (not (pushing ?r ?c)) (not-pushing ?r) (not-pushed ?c)))
 (:action ugly29ugly10ugly18base-cart-left :parameters
  (?r - robot ?c - cart ?x1 - xc ?x2 - xc ?y - yc ?cx1 - xc ?cx2 - xc ?cy - yc)
  :precondition
  ...
  (and (not (base-pos ?r ?x1 ?y)) (base-pos ?r ?x2 ?y)
       ...
       (not (base-obstacle ?x1 ?y)) (base-obstacle ?x2 ?y)
       (not (base-obstacle ?cx1 ?cy)) (base-obstacle ?cx2 ?cy)))
 (:action ugly30ugly4ugly30base-right :parameters
  (?r - robot ?cx - xc ?dx - xc ?y - yc) :precondition
