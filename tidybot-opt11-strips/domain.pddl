...
(define (domain tidybot) (:requirements :strips :typing :equality)
 (:predicates (surface ?x - xc ?y - yc) (parked ?r - robot)
  (gripper-empty ?r - robot) (above ?y1 - yc ?y2 - yc)
  (leftof-rel ?x1 - xrel ?x2 - xrel) (base-obstacle ?x - xc ?y - yc)
  (object-pos ?o - object ?x - xc ?y - yc) (holding ?r - robot ?o - object)
  (zerox-rel ?x - xrel) (gripper-rel ?r - robot ?x - xrel ?y - yrel)
  (leftof ?x1 - xc ?x2 - xc) (sum-x ?x - xc ?xr - xrel ?xsum - xc)
  (not-pushed ?c - cart) (not-pushing ?r - robot) (object-done ?o - object)
  (on-cart ?o - object ?c - cart) (gripper-obstacle ?x - xc ?y - yc)
  (above-rel ?y1 - yrel ?y2 - yrel) (sum-y ?y - yc ?yr - yrel ?ysum - yc)
  (base-pos ?r - robot ?x - xc ?y - yc) (pushing ?r - robot ?c - cart)
  (cart-pos ?c - cart ?x - xc ?y - yc) (zeroy-rel ?y - yrel)
  (object-goal ?o - object ?x - xc ?y - yc))
 (:types robot cart object xc yc xrel yrel)
 (:action ugly1450397ugly5ugly19ugly25ugly24base-cart-right :parameters
 ...
 (:action ugly1450398ugly19ugly25ugly24ugly8get-right :parameters
 ...
 (:action ugly1450399ugly3ugly20ugly22ugly26put-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
 ...
 (:action ugly1450400ugly24ugly8ugly21ugly17gripper-left :parameters
 ...
 (:action ugly1450401ugly14ugly5ugly19ugly25get-from-cart :parameters
 ...
 (:action ugly1450402ugly11ugly23ugly9ugly3get-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?ox ?gyabs)) (not (gripper-obstacle ?ox ?gyabs))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly1450403ugly26ugly28ugly14ugly5ungrasp-cart :parameters
  (?r - robot ?c - cart) :precondition (and (pushing ?r ?c)) :effect
  (and (not (pushing ?r ?c)) (not-pushing ?r) (not-pushed ?c)))
 (:action ugly1450404ugly10ugly18ugly7ugly16unpark :parameters
  (?r - robot ?x - xrel ?y - yrel) :precondition
  (and (parked ?r) (gripper-rel ?r ?x ?y) (zerox-rel ?x) (zeroy-rel ?y))
  :effect (not (parked ?r)))
 (:action ugly1450405ugly7ugly16ugly1ugly29base-cart-down :parameters
 ...
 (:action ugly1450406ugly20ugly22ugly26ugly28gripper-down :parameters
 ...
 (:action ugly1450407ugly29ugly10ugly18ugly7grasp-cart-right :parameters
 ...
 (:action ugly1450408ugly13ugly6ugly13ugly6gripper-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?cgyrel - yrel
   ?dgyrel - yrel ?cgyabs - yc ?dgyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?cgyrel)
  ...
  (and (not (gripper-rel ?r ?gxrel ?cgyrel)) (gripper-rel ?r ?gxrel ?dgyrel)
       (not (gripper-obstacle ?gxabs ?cgyabs))
       (gripper-obstacle ?gxabs ?dgyabs)))
 (:action ugly1450409ugly22ugly26ugly28ugly14base-up :parameters
 ...
 (:action ugly1450410ugly8ugly21ugly17ugly11get-down :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?gxabs ?oy)) (not (gripper-obstacle ?gxabs ?oy))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly1450411ugly1ugly29ugly10ugly18base-cart-left :parameters
  (?r - robot ?c - cart ?x1 - xc ?x2 - xc ?y - yc ?cx1 - xc ?cx2 - xc ?cy - yc)
  :precondition
  ...
  (and (not (base-pos ?r ?x1 ?y)) (base-pos ?r ?x2 ?y)
       ...
       (not (base-obstacle ?x1 ?y)) (base-obstacle ?x2 ?y)
       (not (base-obstacle ?cx1 ?cy)) (base-obstacle ?cx2 ?cy)))
 (:action ugly1450412ugly16ugly1ugly29ugly10grasp-cart-below :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cy - yc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?x ?cy) (above ?y ?cy) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly1450413ugly4ugly30ugly4ugly30base-right :parameters
 ...
 (:action ugly1450414ugly17ugly11ugly23ugly9base-left :parameters
  (?r - robot ?cx - xc ?dx - xc ?y - yc) :precondition
  ...
  (and (not (base-pos ?r ?cx ?y)) (base-pos ?r ?dx ?y)
       (not (base-obstacle ?cx ?y)) (base-obstacle ?dx ?y)))
 (:action ugly1450415ugly9ugly3ugly20ugly22put-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
 ...
 (:action ugly1450416ugly12ugly27ugly2ugly15gripper-right :parameters
  (?r - robot ?basex - xc ?basey - yc ?cgxrel - xrel ?dgxrel - xrel ?cgxabs -
   xc ?dgxabs - xc ?gyrel - yrel ?gyabs - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?cgxrel ?gyrel)
  ...
  (and (not (gripper-rel ?r ?cgxrel ?gyrel)) (gripper-rel ?r ?dgxrel ?gyrel)
       (not (gripper-obstacle ?cgxabs ?gyabs))
       (gripper-obstacle ?dgxabs ?gyabs)))
 (:action ugly1450417ugly27ugly2ugly15ugly12put-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?gxabs ?oy)
       (gripper-obstacle ?gxabs ?oy) (gripper-empty ?r)))
 (:action ugly1450418ugly28ugly14ugly5ugly19put-left :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?ox - xc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (holding ?r ?o)) (object-pos ?o ?ox ?gyabs)
       (gripper-obstacle ?ox ?gyabs) (gripper-empty ?r)))
 (:action ugly1450419ugly30ugly4ugly30ugly4finish-object :parameters
  (?o - object ?x - xc ?y - yc) :precondition
  (and (not (object-done ?o)) (object-pos ?o ?x ?y) (object-goal ?o ?x ?y))
  :effect (and (object-done ?o)))
 (:action ugly1450420ugly21ugly17ugly11ugly23base-cart-up :parameters
  (?r - robot ?c - cart ?x - xc ?y1 - yc ?y2 - yc ?cx - xc ?cy1 - yc ?cy2 - yc)
  :precondition
  ...
  (and (not (base-pos ?r ?x ?y1)) (base-pos ?r ?x ?y2)
       ...
       (not (base-obstacle ?x ?y1)) (base-obstacle ?x ?y2)
       (not (base-obstacle ?cx ?cy2)) (base-obstacle ?cx ?cy2)))
 (:action ugly1450421ugly6ugly13ugly6ugly13base-down :parameters
  (?r - robot ?x - xc ?cy - yc ?dy - yc) :precondition
  ...
  (and (not (base-pos ?r ?x ?cy)) (base-pos ?r ?x ?dy)
       (not (base-obstacle ?x ?cy)) (base-obstacle ?x ?dy)))
 (:action ugly1450422ugly2ugly15ugly12ugly27park :parameters (?r - robot)
  :precondition (and (not (parked ?r)) (not-pushing ?r)) :effect (parked ?r))
 (:action ugly1450423ugly15ugly12ugly27ugly2grasp-cart-left :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cx - xc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?cx ?y) (leftof ?cx ?x) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly1450424ugly23ugly9ugly3ugly20get-up :parameters
  (?r - robot ?basex - xc ?basey - yc ?gxrel - xrel ?gxabs - xc ?gyrel - yrel
   ?gyabs - yc ?o - object ?oy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?basex ?basey) (gripper-rel ?r ?gxrel ?gyrel)
  ...
  (and (not (object-pos ?o ?gxabs ?oy)) (not (gripper-obstacle ?gxabs ?oy))
       (not (gripper-empty ?r)) (holding ?r ?o)))
 (:action ugly1450425ugly25ugly24ugly8ugly21grasp-cart-above :parameters
  (?r - robot ?c - cart ?x - xc ?y - yc ?cy - yc) :precondition
  (and (not (parked ?r)) (not-pushed ?c) (base-pos ?r ?x ?y)
       (cart-pos ?c ?x ?cy) (above ?cy ?y) (not-pushing ?r))
  :effect (and (pushing ?r ?c) (not (not-pushing ?r)) (not (not-pushed ?c))))
 (:action ugly1450426ugly18ugly7ugly16ugly1put-on-cart :parameters
  (?r - robot ?x - xc ?y - yc ?gxrel - xrel ?gyrel - yrel ?o - object ?c - cart
   ?cx - xc ?cy - yc)
  :precondition
  (and (parked ?r) (base-pos ?r ?x ?y) (gripper-rel ?r ?gxrel ?gyrel)
