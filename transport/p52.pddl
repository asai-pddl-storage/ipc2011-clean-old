; Transport city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-48packages-2013seed

(define (problem transport-city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-48packages-2013seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:goal (and
  ...
  (at package-38 city-loc-50)
  (at package-39 city-loc-10)
