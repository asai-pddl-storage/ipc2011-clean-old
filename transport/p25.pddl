; Transport city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-30packages-2013seed

(define (problem transport-city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-30packages-2013seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:goal (and
  ...
  (at package-27 city-loc-59)
  (at package-28 city-loc-25)
  (at package-29 city-loc-40)
  (at package-30 city-loc-29)
 ))
