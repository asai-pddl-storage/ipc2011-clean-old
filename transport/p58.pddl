; Transport city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-52packages-2013seed

(define (problem transport-city-sequential-66nodes-1000size-4degree-100mindistance-4trucks-52packages-2013seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (at truck-2 city-loc-63)
  (capacity truck-2 capacity-4)
  (at truck-3 city-loc-33)
 ...
 (:goal (and
  ...
  (at package-2 city-loc-65)
  (at package-3 city-loc-57)
  (at package-4 city-loc-25)
  (at package-5 city-loc-59)
