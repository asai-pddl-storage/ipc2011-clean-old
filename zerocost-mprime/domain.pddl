...
(define (domain mystery-prime-strips)
 ...
 (:predicates (planet ?x) (craves ?v ?n) (harmony ?v ?s) (attacks ?i ?j)
  (orbits ?i ?j) (locale ?n ?a) (food ?x) (eats ?n1 ?n2) (pleasure ?x)
  (pain ?x) (province ?x) (fears ?c ?v))
 (:action
  ugly11913ugly11915ugly11916ugly11913ugly11915ugly4ugly4ugly4ugly4drink
  ...
  (and (not (locale ?n1 ?l11)) (locale ?n1 ?l12) (not (locale ?n2 ?l21))
       (locale ?n2 ?l22)))
 (:action
  ugly11914ugly11914ugly11914ugly11914ugly11914ugly2ugly3ugly2ugly3feast
  ...
  (and (not (craves ?v ?n1)) (craves ?v ?n2) (not (locale ?n1 ?l2))
       (locale ?n1 ?l1)))
 (:action
  ugly11915ugly11916ugly11913ugly11915ugly11916ugly1ugly1ugly1ugly1overcome
  ...
  (and (not (craves ?c ?n)) (fears ?c ?v) (not (harmony ?v ?s2))
       (harmony ?v ?s1)))
 (:action
  ugly11916ugly11913ugly11915ugly11916ugly11913ugly3ugly2ugly3ugly2succumb
  :parameters (?c ?v ?n ?s1 ?s2) :precondition
