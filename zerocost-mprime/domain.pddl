...
(define (domain mystery-prime-strips)
 ...
 (:predicates (province ?x) (planet ?x) (fears ?c ?v) (pleasure ?x) (pain ?x)
  (attacks ?i ?j) (harmony ?v ?s) (food ?x) (craves ?v ?n) (eats ?n1 ?n2)
  (locale ?n ?a) (orbits ?i ?j))
 (:action ugly11913ugly11915ugly11916ugly1ugly1ugly1ugly1overcome :parameters
  ...
  (and (not (craves ?c ?n)) (fears ?c ?v) (not (harmony ?v ?s2))
       (harmony ?v ?s1)))
 (:action ugly11914ugly11914ugly11914ugly2ugly3ugly2ugly3feast :parameters
  ...
  (and (not (craves ?v ?n1)) (craves ?v ?n2) (not (locale ?n1 ?l2))
       (locale ?n1 ?l1)))
 (:action ugly11915ugly11916ugly11913ugly3ugly2ugly3ugly2succumb :parameters
  (?c ?v ?n ?s1 ?s2) :precondition
  ...
  (and (not (fears ?c ?v)) (craves ?c ?n) (not (harmony ?v ?s1))
       (harmony ?v ?s2)))
 (:action ugly11916ugly11913ugly11915ugly4ugly4ugly4ugly4drink :parameters
