...
(define (domain mystery-prime-strips)
 ...
 (:predicates (fears ?c ?v) (harmony ?v ?s) (planet ?x) (eats ?n1 ?n2)
  (locale ?n ?a) (pain ?x) (craves ?v ?n) (pleasure ?x) (food ?x)
  (attacks ?i ?j) (orbits ?i ?j) (province ?x))
 (:action ugly11913ugly11915ugly11916ugly11913ugly3ugly2ugly3ugly2succumb
  ...
  (and (not (fears ?c ?v)) (craves ?c ?n) (not (harmony ?v ?s1))
       (harmony ?v ?s2)))
 (:action ugly11914ugly11914ugly11914ugly11914ugly2ugly3ugly2ugly3feast
  ...
  (and (not (craves ?v ?n1)) (craves ?v ?n2) (not (locale ?n1 ?l2))
       (locale ?n1 ?l1)))
 (:action ugly11915ugly11916ugly11913ugly11915ugly4ugly4ugly4ugly4drink
  ...
  (and (not (locale ?n1 ?l11)) (locale ?n1 ?l12) (not (locale ?n2 ?l21))
       (locale ?n2 ?l22)))
 (:action ugly11916ugly11913ugly11915ugly11916ugly1ugly1ugly1ugly1overcome
  :parameters (?c ?v ?n ?s1 ?s2) :precondition
