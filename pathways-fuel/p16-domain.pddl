...
(define (domain pathways-propositional)
 ...
 (:predicates (num-subs ?l - level) (goal5) (goal4) (goal8) (goal1) (goal10)
  (goal13) (goal19) (association-reaction ?x1 ?x2 - molecule ?x3 - complex)
  (goal6) (synthesis-reaction ?x1 ?x2 - molecule) (goal18) (chosen ?s - simple)
  (goal15) (goal7) (goal9) (next ?l1 ?l2 - level) (possible ?x - molecule)
  (goal16) (available ?x - molecule)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal2)
  (goal3) (goal14) (goal17) (goal12) (goal20) (goal11))
