...
(define (domain pathways-propositional)
 ...
 (:predicates (goal21) (goal16) (goal9)
  ...
  (goal11) (goal4) (goal7) (goal2) (goal20) (goal12) (goal10) (goal8) (goal18)
  (next ?l1 ?l2 - level) (chosen ?s - simple) (goal1) (goal24) (goal5) (goal15)
  (goal22) (goal13) (possible ?x - molecule) (available ?x - molecule) (goal19)
 ...
 (:action ugly1dummy-action-2 :parameters () :precondition
 ...
 (:action ugly10dummy-action-12 :parameters () :precondition
  (or (available p27-cdk2-cycep1) (available p27p1-cdk2p2-cyce)) :effect
  (and (goal12)))
 (:action ugly11dummy-action-8 :parameters () :precondition
  (or (available p21-cdk2-cycep1) (available cdk2p2-cyca-e2f13p1)) :effect
  (and (goal8)))
 (:action ugly12dummy-action-23 :parameters () :precondition
  (or (available sp1-e2f13p1) (available p27p1-cdk2p1p2-cyca)) :effect
  (and (goal23)))
 (:action ugly13dummy-action-24 :parameters () :precondition
 ...
 (:action ugly14associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  ...
  (and (increase (total-cost) 1) (not (available ?x1)) (not (available ?x2))
       (available ?x3)))
 (:action ugly15dummy-action-3 :parameters () :precondition
  (or (available p27p1-cdk2p1-cyca) (available p57-cdk2p1p2-cyca)) :effect
  (and (goal3)))
 (:action ugly16dummy-action-15 :parameters () :precondition
  (or (available p68p1p2) (available p27p1-cdk2p1-cyce)) :effect
  (and (goal15)))
 (:action ugly17dummy-action-21 :parameters () :precondition
  (or (available p68p1) (available p57p1-cdk46p1-cycdp1)) :effect
  (and (goal21)))
 (:action ugly18dummy-action-4 :parameters () :precondition
 ...
 (:action ugly20dummy-action-16 :parameters () :precondition
 ...
 (:action ugly23dummy-action-6 :parameters () :precondition
  ...
  (and (goal6)))
 (:action ugly24dummy-action-17 :parameters () :precondition
 ...
 (:action ugly28dummy-action-9 :parameters () :precondition
  (or (available p21-cdk46p1-cycdp1) (available p27p1-cdk46p1p2-cycd)) :effect
  (and (goal9)))
 (:action ugly29dummy-action-18 :parameters () :precondition
