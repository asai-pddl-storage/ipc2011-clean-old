...
(define (domain pathways-propositional)
 ...
 (:predicates (goal7) (goal12) (goal6) (goal13) (goal22) (goal17) (goal4)
  (possible ?x - molecule) (goal5) (goal8)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal2) (available ?x - molecule)
  (goal23) (goal21) (goal18) (goal14) (num-subs ?l - level) (goal20) (goal24)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal27)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal10) (goal9)
  (next ?l1 ?l2 - level) (goal3) (goal16) (goal26) (goal25) (goal11) (goal1)
  (goal19) (goal15) (chosen ?s - simple))
 ...
 (:action ugly1ugly15ugly24dummy-action-22 :parameters () :precondition
  (or (available p57p1-cdk46p1p2-cycdp1) (available p27p1-cdk46p1p2-cycd))
  :effect (and (goal22)))
 (:action ugly2ugly20ugly28dummy-action-7 :parameters () :precondition
  (or (available wee1p1) (available p27p1-cdk2-cyca)) :effect (and (goal7)))
 (:action ugly3ugly23ugly29dummy-action-26 :parameters () :precondition
  (or (available cdk1p3-cyca) (available p21-cdk2p1-cyce)) :effect
  (and (goal26)))
 (:action ugly4ugly1ugly15dummy-action-19 :parameters () :precondition
  (or (available cdk2p1p2-cyca-e2f13) (available p21-cdk2-cycep1)) :effect
  (and (goal19)))
 (:action ugly5ugly3ugly23dummy-action-24 :parameters () :precondition
  (or (available p27p1-cdk46p1-cycd) (available p27-cdk2p1-cycep1)) :effect
  (and (goal24)))
 (:action ugly6ugly13ugly17associate-with-catalyze :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (catalyzed-association-reaction ?x1 ?x2 ?x3) (available ?x1)
       (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (available ?x3)))
 (:action ugly7ugly32ugly18dummy-action-16 :parameters () :precondition
  (or (available cdk1p2p3-cks1) (available skp2-skp1p1)) :effect
  (and (goal16)))
 (:action ugly8ugly10ugly26dummy-action-17 :parameters () :precondition
  (or (available p27p1-cdk2p2-cycep1) (available p27p1-cdk2-cycep1)) :effect
  (and (goal17)))
 (:action ugly9ugly25ugly19initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly10ugly26ugly22dummy-action-25 :parameters () :precondition
  (or (available cdk1p3-cycb) (available p27p1-cdk2p1-cycep1)) :effect
  (and (goal25)))
 (:action ugly11ugly6ugly13dummy-action-12 :parameters () :precondition
  (or (available cdk2p1-cyca-e2f13p1) (available mdm2-prbp1)) :effect
  (and (goal12)))
 (:action ugly12ugly16ugly11dummy-action-1 :parameters () :precondition
  (or (available p27p1-cdk46p1-cycdp1) (available skp2-skp1p1-cdk2-cyca))
  :effect (and (goal1)))
 (:action ugly13ugly17ugly4choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
 ...
 (:action ugly14ugly5ugly3dummy-action-18 :parameters () :precondition
  ...
  (and (goal18)))
 (:action ugly15ugly24ugly27dummy-action-9 :parameters () :precondition
  (or (available prbp1-e2f13p1-dp12p1-ge2) (available p53p1-dp12p1)) :effect
  (and (goal9)))
 (:action ugly16ugly11ugly6dummy-action-8 :parameters () :precondition
  (or (available sp1-e2f13p1) (available cyca)) :effect (and (goal8)))
 (:action ugly17ugly4ugly1dummy-action-10 :parameters () :precondition
  (or (available cdk2-cyca-e2f13p1) (available p27p1-cdk2p1-cyca)) :effect
  (and (goal10)))
 (:action ugly18ugly21ugly9dummy-action-20 :parameters () :precondition
  (or (available prbp1-ap2-ge-c) (available p27p1-cdk2p2-cyce)) :effect
  (and (goal20)))
 (:action ugly19ugly2ugly20dummy-action-23 :parameters () :precondition
  (or (available p27p1-cdk2p1p2-cycep1) (available p27p1-cdk46p1p2-cycdp1))
  :effect (and (goal23)))
 (:action ugly20ugly28ugly12dummy-action-11 :parameters () :precondition
  (or (available p27-cdk2p2-cyca) (available p27-cdk46p1-cycdp1)) :effect
  (and (goal11)))
 (:action ugly21ugly9ugly25dummy-action-14 :parameters () :precondition
  (or (available p27p1-cdk2p2-cyca) (available cdk1p3-cks1)) :effect
  (and (goal14)))
 (:action ugly22ugly30ugly8dummy-action-5 :parameters () :precondition
  (or (available cdk2p2-cyca-e2f13p1) (available p27p1-cdk2p1p2-cyce)) :effect
  (and (goal5)))
 (:action ugly23ugly29ugly31dummy-action-2 :parameters () :precondition
  (or (available skp2p1-skp1) (available p21-cdk2p1p2-cyca)) :effect
  (and (goal2)))
 (:action ugly24ugly27ugly14synthesize :parameters (?x1 ?x2 - molecule)
  :precondition (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly25ugly19ugly2dummy-action-15 :parameters () :precondition
  (or (available cyce) (available skp2-cdk2p1p2-cyca)) :effect (and (goal15)))
 (:action ugly26ugly22ugly30dummy-action-3 :parameters () :precondition
  (or (available cdk46p1-cycdp1) (available skp2-skp1p1-cdk2p1-cyca)) :effect
  (and (goal3)))
 (:action ugly27ugly14ugly5associate :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (association-reaction ?x1 ?x2 ?x3) (available ?x1) (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (not (available ?x2))
       (available ?x3)))
 (:action ugly28ugly12ugly16dummy-action-6 :parameters () :precondition
  (or (available p27p1-cdk2-cyce) (available sp1-p107)) :effect (and (goal6)))
 (:action ugly29ugly31ugly7dummy-action-27 :parameters () :precondition
  (or (available p16-cdk7p1) (available p21-cdk2p2-cyca)) :effect
  (and (goal27)))
 (:action ugly30ugly8ugly10dummy-action-21 :parameters () :precondition
  (or (available cdk1p3-gadd45) (available skp2-skp1-cdk2-cyca)) :effect
  (and (goal21)))
 (:action ugly31ugly7ugly32dummy-action-13 :parameters () :precondition
  (or (available p27p1-cdk2p1p2-cyca) (available skp2-cdk2p2-cyca)) :effect
  (and (goal13)))
 (:action ugly32ugly18ugly21dummy-action-4 :parameters () :precondition
