...
(define (domain pathways-propositional)
 ...
 (:predicates (goal19) (goal17) (goal4) (num-subs ?l - level)
  (chosen ?s - simple) (goal7) (goal16)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal12) (goal20)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal21) (goal22) (goal2) (goal25)
  (possible ?x - molecule) (goal26) (goal24) (goal11) (goal3) (goal1)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal23)
  (goal28) (goal15) (goal18) (goal5) (goal9) (goal10) (goal6) (goal14)
  (next ?l1 ?l2 - level) (goal27) (goal8) (available ?x - molecule) (goal13))
 ...
 (:action ugly2ugly20dummy-action-23 :parameters () :precondition
  ...
  (and (goal23)))
 (:action ugly3ugly33dummy-action-12 :parameters () :precondition
 ...
 (:action ugly4ugly11dummy-action-10 :parameters () :precondition
  ...
  (and (goal10)))
 (:action ugly5ugly30dummy-action-14 :parameters () :precondition
 ...
 (:action ugly6ugly8dummy-action-19 :parameters () :precondition
  ...
  (and (goal19)))
 (:action ugly7ugly23dummy-action-5 :parameters () :precondition
  (or (available cdk46p1p2) (available prbp1p2-jun-c-fos-gercc1)) :effect
  (and (goal5)))
 (:action ugly8ugly24associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
 ...
 (:action ugly17ugly18dummy-action-21 :parameters () :precondition
  ...
  (and (goal21)))
 (:action ugly18ugly26choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
 ...
 (:action ugly19ugly7dummy-action-18 :parameters () :precondition
  ...
  (and (goal18)))
 (:action ugly20ugly28dummy-action-27 :parameters () :precondition
  (or (available ercc1) (available p21-cdk46p1-cycdp1)) :effect (and (goal27)))
 (:action ugly21ugly27dummy-action-11 :parameters () :precondition
 ...
 (:action ugly22ugly25dummy-action-1 :parameters () :precondition
  ...
  (and (goal1)))
 (:action ugly23ugly10dummy-action-9 :parameters () :precondition
  (or (available p21-cdk46-cycdp1) (available p57-cdk46p2-cycdp1)) :effect
  (and (goal9)))
 (:action ugly24ugly3dummy-action-28 :parameters () :precondition
  (or (available dp12p1) (available p57-cdk2-cycep1)) :effect (and (goal28)))
 (:action ugly25ugly6dummy-action-3 :parameters () :precondition
  (or (available p16-cdk46) (available pcna-p21-cdk46p2-cycdp1)) :effect
  (and (goal3)))
 (:action ugly26ugly1dummy-action-7 :parameters () :precondition
  (or (available pcna-p21-cdk46-cycdp1) (available p57p1-cdk46p2-cycdp1))
  :effect (and (goal7)))
 (:action ugly27ugly16synthesize :parameters (?x1 ?x2 - molecule) :precondition
  (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly28ugly32initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly29ugly31dummy-action-24 :parameters () :precondition
  (or (available pcna-p21-cdk2p2-cyca) (available prbp1p2-ap2)) :effect
  (and (goal24)))
 (:action ugly30ugly19dummy-action-2 :parameters () :precondition
  (or (available cdk46-cycd) (available cdk46p2-cycdp1)) :effect (and (goal2)))
 (:action ugly31ugly29dummy-action-26 :parameters () :precondition
  (or (available raf1-prbp1-e2f13-dp12) (available p57-cdk2p2-cyca)) :effect
  (and (goal26)))
 (:action ugly32ugly2dummy-action-15 :parameters () :precondition
  (or (available raf1-cdc25ap1) (available prbp1-e2f13p1-dp12-ge2)) :effect
  (and (goal15)))
 (:action ugly33ugly17dummy-action-13 :parameters () :precondition
