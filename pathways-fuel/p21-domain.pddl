...
(define (domain pathways-propositional)
 ...
 (:predicates (goal21) (goal25) (num-subs ?l - level)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal23) (goal14) (goal6) (goal4)
  (goal26) (goal28) (possible ?x - molecule)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal24) (goal16)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal3)
  (goal1) (goal5) (goal18) (goal8) (goal9) (goal7) (available ?x - molecule)
  (goal2) (goal27) (goal11) (goal10) (goal13) (goal19) (next ?l1 ?l2 - level)
  (chosen ?s - simple) (goal22) (goal17) (goal12) (goal15) (goal20))
 ...
 (:action ugly2dummy-action-15 :parameters () :precondition
  ...
  (and (goal15)))
 (:action ugly3dummy-action-28 :parameters () :precondition
 ...
 (:action ugly18dummy-action-21 :parameters () :precondition
  ...
  (and (goal21)))
 (:action ugly19dummy-action-2 :parameters () :precondition
  (or (available cdk46-cycd) (available cdk46p2-cycdp1)) :effect (and (goal2)))
 (:action ugly20dummy-action-23 :parameters () :precondition
  (or (available prbp1-jun-c-fos) (available p21-cdk2p1p2-cyca)) :effect
  (and (goal23)))
 (:action ugly21dummy-action-22 :parameters () :precondition
  (or (available pcna-p21-cdk2p1-cyca) (available pcna-p21-cdk2p1p2-cyca))
  :effect (and (goal22)))
 (:action ugly22dummy-action-20 :parameters () :precondition
 ...
 (:action ugly23dummy-action-5 :parameters () :precondition
  ...
  (and (goal5)))
 (:action ugly24associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
 ...
 (:action ugly25dummy-action-1 :parameters () :precondition
  ...
  (and (goal1)))
 (:action ugly26choose :parameters (?x - simple ?l1 ?l2 - level) :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly27dummy-action-11 :parameters () :precondition
  (or (available pcna-p21-cdk46-cycd) (available p21-cdk46p2-cycdp1)) :effect
  (and (goal11)))
 (:action ugly28dummy-action-27 :parameters () :precondition
  (or (available ercc1) (available p21-cdk46p1-cycdp1)) :effect (and (goal27)))
 (:action ugly29dummy-action-26 :parameters () :precondition
  (or (available raf1-prbp1-e2f13-dp12) (available p57-cdk2p2-cyca)) :effect
  (and (goal26)))
 (:action ugly30dummy-action-14 :parameters () :precondition
  (or (available p21-cdk46-cycd) (available prbp1p2-jun-c-fos)) :effect
  (and (goal14)))
 (:action ugly31dummy-action-24 :parameters () :precondition
  (or (available pcna-p21-cdk2p2-cyca) (available prbp1p2-ap2)) :effect
  (and (goal24)))
 (:action ugly32initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly33dummy-action-12 :parameters () :precondition
