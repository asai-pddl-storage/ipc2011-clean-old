...
(define (domain pathways-propositional)
 ...
 (:predicates (goal21) (goal25) (num-subs ?l - level) (goal29) (goal1) (goal24)
  (goal15) (goal7) (goal5) (goal27) (possible ?x - molecule)
  (available ?x - molecule) (goal22)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal17)
  (goal26) (goal4) (goal2) (goal6) (goal19) (goal9) (goal10) (goal8)
  (chosen ?s - simple) (goal3) (goal28) (goal12) (goal11) (goal14) (goal20)
  (synthesis-reaction ?x1 ?x2 - molecule) (next ?l1 ?l2 - level) (goal23)
  (goal18) (goal13) (goal16)
 ...
 (:action ugly23dummy-action-29 :parameters () :precondition
  ...
  (and (goal29)))
 (:action ugly24dummy-action-12 :parameters () :precondition
 ...
 (:action ugly26dummy-action-5 :parameters () :precondition
  ...
  (and (goal5)))
 (:action ugly27initialize :parameters (?x - simple) :precondition
 ...
 (:action ugly28dummy-action-26 :parameters () :precondition
  ...
  :effect (and (goal26)))
 (:action ugly29associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
  (and (association-reaction ?x1 ?x2 ?x3) (available ?x1) (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (not (available ?x2))
       (available ?x3)))
 (:action ugly30dummy-action-27 :parameters () :precondition
 ...
 (:action ugly31dummy-action-1 :parameters () :precondition
  ...
  (and (goal1)))
 (:action ugly32dummy-action-11 :parameters () :precondition
  (or (available cdc25ap1) (available cdk1-gadd45)) :effect (and (goal11)))
 (:action ugly33dummy-action-24 :parameters () :precondition
  (or (available raf1-prbp1-e2f13-dp12p1-ge2) (available cdk2p1-cyca-e2f13))
  :effect (and (goal24)))
 (:action ugly34choose :parameters (?x - simple ?l1 ?l2 - level) :precondition
