...
(define (domain pathways-propositional)
 ...
 (:predicates (goal10) (synthesis-reaction ?x1 ?x2 - molecule) (goal17)
  (goal21) (goal22) (goal15) (goal26) (goal3) (goal20) (goal9)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal5) (goal11)
  (goal23) (possible ?x - molecule) (goal28) (goal1) (goal13) (goal25) (goal19)
  (available ?x - molecule) (goal27) (goal18) (next ?l1 ?l2 - level) (goal29)
  (chosen ?s - simple) (goal12)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal2)
  (goal6) (goal7) (goal8) (num-subs ?l - level) (goal16) (goal4) (goal24)
  (goal14))
 ...
 (:action ugly2ugly20ugly28dummy-action-26 :parameters () :precondition
  (or (available p107-e2f4-dp12p1-ge2) (available raf1-prbp1-e2f4-dp12-ge2))
  :effect (and (goal26)))
 (:action ugly3ugly33ugly29associate :parameters
 ...
 (:action ugly4ugly11ugly15dummy-action-8 :parameters () :precondition
  ...
  (and (goal8)))
 (:action ugly5ugly30ugly32dummy-action-11 :parameters () :precondition
  (or (available cdc25ap1) (available cdk1-gadd45)) :effect (and (goal11)))
 (:action ugly6ugly8ugly24dummy-action-12 :parameters () :precondition
  (or (available c-myc-max-gcdc25a) (available ecadherin)) :effect
  (and (goal12)))
 (:action ugly7ugly23ugly34choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly8ugly24ugly17dummy-action-13 :parameters () :precondition
 ...
 (:action ugly11ugly15ugly13dummy-action-17 :parameters () :precondition
  ...
  (and (goal17)))
 (:action ugly12ugly21ugly27initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly13ugly22ugly25dummy-action-14 :parameters () :precondition
 ...
 (:action ugly16ugly5ugly30dummy-action-27 :parameters () :precondition
  (or (available p21-cdk2p1-cyce) (available p107-e2f4-dp12)) :effect
  (and (goal27)))
 (:action ugly17ugly18ugly26dummy-action-5 :parameters () :precondition
  (or (available p107-e2f4-dp12p1) (available prb-e2f13p1-dp12-ge2)) :effect
  (and (goal5)))
 (:action ugly18ugly26ugly10dummy-action-9 :parameters () :precondition
  (or (available cdk2-cyca) (available pcna-p21-cdk2-cyce)) :effect
  (and (goal9)))
 (:action ugly19ugly7ugly23dummy-action-29 :parameters () :precondition
  (or (available c-myc-ap2) (available raf1-prbp1-e2f13-dp12-ge2)) :effect
  (and (goal29)))
 (:action ugly20ugly28ugly31dummy-action-1 :parameters () :precondition
  (or (available cdk2-cycep1) (available skp2-cdk2-cyca)) :effect
  (and (goal1)))
 (:action ugly21ugly27ugly2dummy-action-15 :parameters () :precondition
  (or (available skp2-skp1-cdk2p1-cyca)
      (available raf1-prbp1-e2f13p1-dp12-ge2))
  :effect (and (goal15)))
 (:action ugly22ugly25ugly19dummy-action-2 :parameters () :precondition
  (or (available p21-cdk2-cycep1) (available skp2-skp1-cdk2-cyca)) :effect
  (and (goal2)))
 (:action ugly23ugly34ugly1dummy-action-7 :parameters () :precondition
  (or (available p21-cdk2-cyca) (available p57-cdk2-cycep1)) :effect
  (and (goal7)))
 (:action ugly24ugly17ugly18dummy-action-21 :parameters () :precondition
  (or (available p57-cdk2p1-cycep1) (available prb-e2f4-dp12-ge2)) :effect
  (and (goal21)))
 (:action ugly25ugly19ugly7dummy-action-18 :parameters () :precondition
  (or (available raf1-prb-e2f13p1-dp12-ge2) (available c-myc-max)) :effect
  (and (goal18)))
 (:action ugly26ugly10ugly14dummy-action-4 :parameters () :precondition
  (or (available cdk2-cyca-e2f13) (available p57-cdk2-cyce)) :effect
  (and (goal4)))
 (:action ugly27ugly2ugly20dummy-action-23 :parameters () :precondition
  (or (available cdk2p1-cycep1) (available prbp1-e2f13-dp12-ge2)) :effect
  (and (goal23)))
 (:action ugly28ugly31ugly6dummy-action-3 :parameters () :precondition
  (or (available raf1-cdc25ap1) (available pcna-p21-cdk2-cyca)) :effect
  (and (goal3)))
 (:action ugly29ugly3ugly33dummy-action-24 :parameters () :precondition
  (or (available raf1-prbp1-e2f13-dp12p1-ge2) (available cdk2p1-cyca-e2f13))
  :effect (and (goal24)))
 (:action ugly30ugly32ugly16synthesize :parameters (?x1 ?x2 - molecule)
  :precondition (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly31ugly6ugly8dummy-action-19 :parameters () :precondition
  (or (available cdk1p1-cks1) (available pcna-p21-cdk2p1-cyce)) :effect
  (and (goal19)))
 (:action ugly32ugly16ugly5dummy-action-25 :parameters () :precondition
  (or (available prbp1-e2f13-dp12p1-ge2) (available raf1-prb-e2f4-dp12-ge2))
  :effect (and (goal25)))
 (:action ugly33ugly29ugly3dummy-action-28 :parameters () :precondition
  (or (available prbp1-e2f13-dp12p1) (available cdk1p1-gadd45)) :effect
  (and (goal28)))
 (:action ugly34ugly1ugly12dummy-action-16 :parameters () :precondition
