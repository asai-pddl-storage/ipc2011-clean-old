...
(define (domain pathways-propositional)
 ...
 (:predicates (goal5) (association-reaction ?x1 ?x2 - molecule ?x3 - complex)
  (goal31) (goal16) (goal26) (goal9) (goal25) (goal33) (goal13)
  (available ?x - molecule) (goal24) (goal29) (num-subs ?l - level) (goal7)
  (goal1) (goal10) (goal32) (chosen ?s - simple) (possible ?x - molecule)
  (catalyzed-association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal6)
  (goal19) (goal15) (next ?l1 ?l2 - level) (goal30) (goal4) (goal27) (goal2)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal22) (goal28) (goal17) (goal21)
  (goal14) (goal20) (goal8) (goal12) (goal3) (goal18) (goal23) (goal11))
 ...
 (:action ugly1ugly26dummy-action-32 :parameters () :precondition
  (or (available hdac1-p107-e2f4-dp12-ge2) (available cdk1p1p2-gadd45)) :effect
  (and (goal32)))
 (:action ugly2ugly4dummy-action-8 :parameters () :precondition
  (or (available cdk46p2-cycdp1) (available e2f4-dp12-ge2)) :effect
  (and (goal8)))
 (:action ugly3ugly5dummy-action-25 :parameters () :precondition
 ...
 (:action ugly5ugly30dummy-action-3 :parameters () :precondition
 ...
 (:action ugly6ugly15dummy-action-18 :parameters () :precondition
  ...
  :effect (and (goal18)))
 (:action ugly7ugly33dummy-action-2 :parameters () :precondition
 ...
 (:action ugly10ugly29dummy-action-22 :parameters () :precondition
  ...
  (and (goal22)))
 (:action ugly11ugly25dummy-action-9 :parameters () :precondition
  (or (available cdk46p2-cycd) (available pcna-p21-cdk46p2-cycdp1)) :effect
  (and (goal9)))
 (:action ugly12ugly2associate-with-catalyze :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (catalyzed-association-reaction ?x1 ?x2 ?x3) (available ?x1)
       (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (available ?x3)))
 (:action ugly13ugly21associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  :precondition
 ...
 (:action ugly14ugly34dummy-action-30 :parameters () :precondition
  ...
  (and (goal30)))
 (:action ugly15ugly23dummy-action-12 :parameters () :precondition
 ...
 (:action ugly16ugly22dummy-action-31 :parameters () :precondition
  ...
  (and (goal31)))
 (:action ugly17ugly20dummy-action-33 :parameters () :precondition
 ...
 (:action ugly18ugly10dummy-action-24 :parameters () :precondition
  ...
  (and (goal24)))
 (:action ugly19ugly31dummy-action-1 :parameters () :precondition
  (or (available p16-cdk46) (available raf1-cdc25ap1)) :effect (and (goal1)))
 (:action ugly20ugly38dummy-action-13 :parameters () :precondition
  (or (available mdm2-e2f13p1-dp12p1) (available pcna-p21-cdk46p2-cycd))
  :effect (and (goal13)))
 (:action ugly21ugly3synthesize :parameters (?x1 ?x2 - molecule) :precondition
 ...
 (:action ugly22ugly36dummy-action-23 :parameters () :precondition
  ...
  (and (goal23)))
 (:action ugly23ugly17dummy-action-15 :parameters () :precondition
  (or (available p57p1-cdk46p2-cycdp1) (available cdk1p2)) :effect
  (and (goal15)))
 (:action ugly24ugly32dummy-action-19 :parameters () :precondition
  (or (available cebp-prbp1p2) (available cdk1p3-cycb)) :effect (and (goal19)))
 (:action ugly25ugly14dummy-action-29 :parameters () :precondition
  (or (available sp1-e2f13p1) (available skp2p1-skp1p1)) :effect
  (and (goal29)))
 (:action ugly26ugly37dummy-action-6 :parameters () :precondition
  (or (available prbp1p2-ap2) (available p57p1-cdk46p2-cycd)) :effect
  (and (goal6)))
 (:action ugly27ugly1dummy-action-21 :parameters () :precondition
  (or (available cdk2p1p2-cyca-e2f13p1) (available skp2-skp1p1-cdk2p1-cyca))
  :effect (and (goal21)))
 (:action ugly28ugly19dummy-action-26 :parameters () :precondition
  (or (available cdk2p2-cyca-e2f13p1) (available p68p1p2)) :effect
  (and (goal26)))
 (:action ugly29ugly27choose :parameters (?x - simple ?l1 ?l2 - level)
  :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly30ugly8dummy-action-4 :parameters () :precondition
  (or (available p57-cdk46-cycd) (available cdk46-cycd)) :effect (and (goal4)))
 (:action ugly31ugly6dummy-action-10 :parameters () :precondition
  (or (available p57-cdk46p2-cycdp1) (available p21-cdk46p2-cycd)) :effect
  (and (goal10)))
 (:action ugly32ugly24dummy-action-27 :parameters () :precondition
  (or (available cdk2-cyca-e2f13p1) (available raf1-p130-e2f4-dp12-ge2))
  :effect (and (goal27)))
 (:action ugly33ugly7dummy-action-28 :parameters () :precondition
 ...
 (:action ugly34ugly35dummy-action-7 :parameters () :precondition
  ...
  (and (goal7)))
 (:action ugly35ugly12initialize :parameters (?x - simple) :precondition
  (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly36ugly28dummy-action-14 :parameters () :precondition
  (or (available p57-cdk46-cycdp1) (available p21-cdk46p2-cycdp1)) :effect
  (and (goal14)))
 (:action ugly37ugly11dummy-action-20 :parameters () :precondition
  (or (available cdk1p3-cks1) (available p53-dp12p1)) :effect (and (goal20)))
 (:action ugly38ugly18dummy-action-5 :parameters () :precondition
