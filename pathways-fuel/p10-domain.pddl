...
(define (domain pathways-propositional)
 ...
 (:predicates (chosen ?s - simple) (next ?l1 ?l2 - level) (goal4) (goal1)
  (goal13) (goal3) (goal5) (goal6) (goal8) (goal12)
  (association-reaction ?x1 ?x2 - molecule ?x3 - complex) (goal11) (goal2)
  (synthesis-reaction ?x1 ?x2 - molecule) (goal14) (goal7) (goal9)
  (possible ?x - molecule) (num-subs ?l - level) (goal10)
 ...
 (:action ugly11207ugly15ugly5ugly1ugly14associate :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (association-reaction ?x1 ?x2 ?x3) (available ?x1) (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (not (available ?x2))
       (available ?x3)))
 (:action ugly11208ugly7ugly18ugly13ugly7dummy-action-13 :parameters ()
  :precondition (or (available p57-cdk2-cycep1) (available cdc25ap1)) :effect
  (and (goal13)))
 (:action ugly11209ugly18ugly13ugly7ugly18dummy-action-8 :parameters ()
  :precondition (or (available hdac1-p130-e2f5-dp12) (available cdk46-cycd))
  :effect (and (goal8)))
 (:action ugly11210ugly1ugly14ugly3ugly17dummy-action-7 :parameters ()
  :precondition (or (available p27-cdk2-cycep1) (available cdk2-cyca-e2f13))
  :effect (and (goal7)))
 (:action ugly11211ugly19ugly9ugly6ugly2dummy-action-14 :parameters ()
  :precondition (or (available p57-cdk2-cyca) (available cdk2p1-cyca-e2f13))
  :effect (and (goal14)))
 (:action ugly11212ugly17ugly12ugly4ugly11dummy-action-3 :parameters ()
  :precondition (or (available p57-cdk46-cycd) (available p57-cdk46-cycdp1))
  :effect (and (goal3)))
 (:action ugly11213ugly4ugly11ugly8ugly16dummy-action-10 :parameters ()
  :precondition (or (available cdk2-cyce) (available raf1-cdc25ap1)) :effect
  (and (goal10)))
 (:action ugly11214ugly16ugly15ugly5ugly1dummy-action-9 :parameters ()
  :precondition (or (available cdk2-cycep1) (available cdk46)) :effect
  (and (goal9)))
 (:action ugly11215ugly11ugly8ugly16ugly15synthesize :parameters
  (?x1 ?x2 - molecule) :precondition
  (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly11216ugly14ugly3ugly17ugly12associate-with-catalyze :parameters
  (?x1 ?x2 - molecule ?x3 - complex) :precondition
  (and (catalyzed-association-reaction ?x1 ?x2 ?x3) (available ?x1)
       (available ?x2))
  :effect
  (and (increase (total-cost) 1) (not (available ?x1)) (available ?x3)))
 (:action ugly11217ugly10ugly10ugly10ugly10dummy-action-5 :parameters ()
  :precondition (or (available p57-cdk2-cyce) (available p27-cdk46-cycdp1))
  :effect (and (goal5)))
 (:action ugly11218ugly8ugly16ugly15ugly5choose :parameters
  (?x - simple ?l1 ?l2 - level) :precondition
  (and (possible ?x) (not (chosen ?x)) (num-subs ?l2) (next ?l1 ?l2)) :effect
  (and (chosen ?x) (not (num-subs ?l2)) (num-subs ?l1)))
 (:action ugly11219ugly5ugly1ugly14ugly3dummy-action-12 :parameters ()
  :precondition (or (available raf1-cdc25a) (available skp2-cdk2-cyca)) :effect
  (and (goal12)))
 (:action ugly11220ugly2ugly19ugly9ugly6initialize :parameters (?x - simple)
  :precondition (and (chosen ?x)) :effect (and (available ?x)))
 (:action ugly11221ugly9ugly6ugly2ugly19dummy-action-4 :parameters ()
  :precondition (or (available hdac1-p107-e2f4-dp12-ge2) (available c-myc))
  :effect (and (goal4)))
 (:action ugly11222ugly3ugly17ugly12ugly4dummy-action-6 :parameters ()
  :precondition (or (available p27-cdk2-cyce) (available p27-cdk2-cyca))
  :effect (and (goal6)))
 (:action ugly11223ugly13ugly7ugly18ugly13dummy-action-2 :parameters ()
  :precondition (or (available p27-cdk46-cycd) (available cyca)) :effect
  (and (goal2)))
 (:action ugly11224ugly6ugly2ugly19ugly9dummy-action-1 :parameters ()
  :precondition
  (or (available p57p1-cdk46-cycd) (available p57p1-cdk46-cycdp1)) :effect
  (and (goal1)))
 (:action ugly11225ugly12ugly4ugly11ugly8dummy-action-11 :parameters ()
