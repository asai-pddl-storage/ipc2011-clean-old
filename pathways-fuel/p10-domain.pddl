...
(define (domain pathways-propositional)
 ...
 (:action ugly14associate :parameters (?x1 ?x2 - molecule ?x3 - complex)
  ...
  (and (increase (total-cost) 1) (not (available ?x1)) (not (available ?x2))
       (available ?x3)))
 (:action ugly15synthesize :parameters (?x1 ?x2 - molecule) :precondition
  (and (synthesis-reaction ?x1 ?x2) (available ?x1)) :effect
  (and (available ?x2)))
 (:action ugly16dummy-action-10 :parameters () :precondition
 ...
 (:action ugly18dummy-action-8 :parameters () :precondition
  ...
  (and (goal8)))
 (:action ugly19dummy-action-4 :parameters () :precondition
