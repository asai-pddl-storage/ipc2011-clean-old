...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (normal ?pipe - pipe) (not-unitary ?pipe - pipe)
  (pop-updating ?pipe - pipe) (connect ?from ?to - area ?pipe - pipe)
  (is-product ?batch-atom - batch-atom ?product - product)
  (unitary ?pipe - pipe) (last ?batch-atom - batch-atom ?pipe - pipe)
 ...
 (:action ugly1ugly5pop-unitarypipe :parameters
 ...
 (:action ugly2ugly3push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly3ugly1push-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product)
  :precondition
 ...
 (:action ugly4ugly2pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?last-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-last-batch - product)
  :precondition
 ...
 (:action ugly5ugly6pop-end :parameters
 ...
 (:action ugly6ugly4push-end :parameters
