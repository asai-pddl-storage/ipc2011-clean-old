...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (on ?batch-atom - batch-atom ?area - area)
  (push-updating ?pipe - pipe) (last ?batch-atom - batch-atom ?pipe - pipe)
  (follow ?next ?previous - batch-atom) (connect ?from ?to - area ?pipe - pipe)
  (first ?batch-atom - batch-atom ?pipe - pipe) (pop-updating ?pipe - pipe)
  (normal ?pipe - pipe)
  (is-product ?batch-atom - batch-atom ?product - product)
  (may-interface ?product-a ?product-b - product) (unitary ?pipe - pipe)
  (not-unitary ?pipe - pipe))
 (:types pipe area product batch-atom)
 (:constants lco gasoleo rat-a oca1 oc1b - product)
 (:action ugly1435144ugly1ugly5ugly6ugly4push-end :parameters
 ...
 (:action ugly1435145ugly2ugly3ugly1ugly5pop-unitarypipe :parameters
 ...
 (:action ugly1435146ugly4ugly2ugly3ugly1push-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly1435147ugly6ugly4ugly2ugly3push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product)
  :precondition
 ...
 (:action ugly1435148ugly3ugly1ugly5ugly6pop-end :parameters
 ...
 (:action ugly1435149ugly5ugly6ugly4ugly2pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?last-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-last-batch - product)
  :precondition
