...
(define (domain pipesworld_strips) (:requirements :strips :typing)
 (:predicates (is-product ?batch-atom - batch-atom ?product - product)
  ...
  (may-interface ?product-a ?product-b - product) (normal ?pipe - pipe)
 ...
 (:action ugly1push-unitarypipe :parameters
 ...
 (:action ugly2pop-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
 ...
 (:action ugly3push-start :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?first-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-first-batch - product)
  :precondition
 ...
 (:action ugly4push-end :parameters
 ...
 (:action ugly5pop-unitarypipe :parameters
  (?pipe - pipe ?batch-atom-in - batch-atom ?from-area - area ?to-area - area
   ?last-batch-atom - batch-atom ?product-batch-atom-in - product
   ?product-last-batch - product)
  :precondition
